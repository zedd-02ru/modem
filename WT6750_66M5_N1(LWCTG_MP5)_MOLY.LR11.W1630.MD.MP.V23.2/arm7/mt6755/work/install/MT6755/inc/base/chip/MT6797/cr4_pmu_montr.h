 ...
 * 
 * 07 26 2012 ted.chou
 * [MOLY00001203] [System Service][PMU] CR4 PMU API typo fix
 * Typo fix.
 *
 * 06 13 2012 ted.chou
 * [MAUI_03200402] [System Service][Cache] Switch region query API fix
 * .
 *
 * 05 14 2012 ted.chou
 ...
 * 05 07 2012 ted.chou
 * [MAUI_03112654] [System Service][MT6280] Check-in SS related modification for MT6280 E1 DVT
 * CR4 Performance Monitor APIs Check-in.
 *
 *------------------------------------------------------------------------------
...
extern kal_bool CR4PMU_Initialize_Query(void);
