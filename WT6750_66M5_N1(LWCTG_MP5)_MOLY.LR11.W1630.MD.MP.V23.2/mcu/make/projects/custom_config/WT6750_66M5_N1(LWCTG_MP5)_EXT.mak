...
# Generated at 2017-05-10 16:14:43
...
MM_RF_MODULE = MT6750_MMRF_CUSTOM
  # Description:
...
2G_ALTERNATIVE_RX_PATH_SUPPORT = FALSE
  # Description:
  #   Depend on this option to support 2G alternative RX path
  # Option Values:
...
UL64QAM_SUPPORT = FALSE
  # Description:
  #   Need to change from TRUE to FALSE for following mak files : 
  #   
  #   TEST6755_PHONE(LWCTG)
  #   TEST6755_PHONE(LWCTG_CUSTOM)
  #   TEST6755_PHONE(LWCTG_USER)
  #   TEST6755_SP(LWCTG)
  #   TEST6755_SP(LWCTG_CUSTOM)
  #   TEST6755_SP(LWCTG_USER)
  #   TESTCASE6755_PHONE(LWCTG)
  #   TESTCASE6755_PHONE(LWCTG_CUSTOM)
  #   TESTCASE6755_PHONE(LWCTG_USER)
  # Option Values:
...
#[MTK internal used]# ------------------------------ 
ORIGINAL_VERNO = MOLY.LR11.W1630.MD.MP.V23.2
HW_VER = WT6750_66M5_N1_HW
...
CHANNEL_LOCK = FALSE
  # Description:
  #   Please activate channel lock feature to Olympus. At least MT6757_SP(LWCTG).mak should be updated. Please see example below or from MT6755_SP(LWCTG_MP3_NOKIA).mak.
  #   
  #   CHANNEL_LOCK = TRUE           
  #   Description:
...
ORIGINAL_PROJECT_NAME = WT6750_66M5_N1
  # Description:
...
COM_DEFS_FOR_MT6750_2G_MT6176_CUSTOM  = MT6176_2G_RF MT6750_2G_MT6176_CUSTOM
COM_DEFS_FOR_MT6750_UMTS_FDD_MT6176_CUSTOM  = MT6176_RF MT6176_UMTS_FDD MT6750_UMTS_FDD_MT6176_CUSTOM
COM_DEFS_FOR_MT6750_MT6176_UMTS_TDD_CUSTOM  = MT6176_RF MT6176_UMTS_TDD MT6750_MT6176_UMTS_TDD_CUSTOM
COM_DEFS_FOR_MT6750_LTE_MT6176_CUSTOM  = MT6176_RF MT6176_LTE_RF MT6750_LTE_MT6176_CUSTOM
