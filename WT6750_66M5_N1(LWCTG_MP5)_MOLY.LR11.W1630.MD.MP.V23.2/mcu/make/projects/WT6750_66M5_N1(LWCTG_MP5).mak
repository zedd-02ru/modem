...
LTE_RF_MODULE = MT6750_LTE_MT6176_CUSTOM
  # Description:
...
RF_MODULE = MT6750_2G_MT6176_CUSTOM
  # Description:
...
UMTS_RF_MODULE = MT6750_UMTS_FDD_MT6176_CUSTOM
  # Description:
...
UMTS_TDD128_RF_MODULE = MT6750_MT6176_UMTS_TDD_CUSTOM
  # Description:
  #   Modem Capability
  # Option Values:
  #   NA: the RF module used in this project
...
BUILD = BUILD_NO
VERNO = MOLY.LR11.W1630.MD.MP.V23.2
# ------------------------------ System configurations
BOARD_VER = MT6750_SP_MP
  # Description:
...
PROJECT_MAKEFILE_EXT = WT6750_66M5_N1(LWCTG_MP5)_EXT
include make/projects/custom_config/$(strip $(PROJECT_MAKEFILE_EXT)).mak