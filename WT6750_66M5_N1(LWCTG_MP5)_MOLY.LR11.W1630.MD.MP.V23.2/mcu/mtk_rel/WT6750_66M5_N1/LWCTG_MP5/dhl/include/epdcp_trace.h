...
#include "L1Trc.h"
	...
	#define EPDCP_LOG_MAX_UL_BKT(v1) do {\
		if(EPDCP_Trace_Filter[0]==1 && (EPDCP_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xF509 | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v1));\
	} while(0)
#else
	...
	#define EPDCP_LOG_INJ_CHG_DLFC_DLVR_ENTER_THRSH(v1) do {\
		if(EPDCP_Trace_Filter[0]==1 && (EPDCP_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_1_word(0xF709 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define EPDCP_LOG_DUMMY_SIGNED(v1, v2, v3, v4) do {\
		if(EPDCP_Trace_Filter[0]==1 && (EPDCP_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0xF909 | ((short)(v1) << 16), (long)(v2), (long)(v3), (long)(v4));\
	} while(0)
#else
	...
	#define EPDCP_LOG_DUMMY(v1, v2, v3, v4) do {\
		if(EPDCP_Trace_Filter[0]==1 && (EPDCP_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0xFA09 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EPDCP_LOG_DUMMY_HEX(v1, v2, v3, v4) do {\
		if(EPDCP_Trace_Filter[0]==1 && (EPDCP_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0xFB09 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
