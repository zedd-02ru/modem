...
#define OSTD_SM_STATUS4_NOFLTR(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13) TRC_SEND_13_DATA(TRC_MERGE_2S(0x051D, (unsigned short)(v1)), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v7), (unsigned long)(v8), (unsigned long)(v9), (unsigned long)(v10), (unsigned long)(v11), (unsigned long)(v12), (unsigned long)(v13))
	...
	#define OSTD_TRC_INF_SLEEP_TRG() do {\
		if(PCORE_OSTD_1_Trace_Filter[0]==1 && (PCORE_OSTD_1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x061D, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define OSTD_TRC_INF_SLEEP_TRG()
#endif
#define OSTD_TRC_INF_SLEEP_TRG_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x061D, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define OSTD_TRC_INF_SLEEP_TIMER_CB(v1, v2) do {\
		if(PCORE_OSTD_1_Trace_Filter[0]==1 && (PCORE_OSTD_1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x071D, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define OSTD_TRC_INF_SLEEP_TIMER_CB(v1, v2)
#endif
#define OSTD_TRC_INF_SLEEP_TIMER_CB_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x071D, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER)
	#define OSTD_TRC_INF_SLEEP_DEBUG(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13) do {\
		if(PCORE_OSTD_1_Trace_Filter[0]==1 && (PCORE_OSTD_1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_14_DATA(TRC_MERGE_1S2C(0x081D, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v7), (unsigned long)(v8), (unsigned long)(v9), (unsigned long)(v10), (unsigned long)(v11), (unsigned long)(v12), (unsigned long)(v13));\
	} while(0)
#else
	#define OSTD_TRC_INF_SLEEP_DEBUG(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13)
#endif
#define OSTD_TRC_INF_SLEEP_DEBUG_NOFLTR(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13) TRC_SEND_14_DATA(TRC_MERGE_1S2C(0x081D, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v7), (unsigned long)(v8), (unsigned long)(v9), (unsigned long)(v10), (unsigned long)(v11), (unsigned long)(v12), (unsigned long)(v13))

#if defined(L1_CATCHER)
	#define OSTD_PATCH_STATUS(v1, v2, v3, v4, v5) do {\
		if(PCORE_OSTD_1_Trace_Filter[0]==1 && (PCORE_OSTD_1_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x091D, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_1S2C((unsigned short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v5));\
	} while(0)
#else
	#define OSTD_PATCH_STATUS(v1, v2, v3, v4, v5)
#endif
#define OSTD_PATCH_STATUS_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_2S(0x091D, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_1S2C((unsigned short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v5))

#if defined(L1_CATCHER)
	#define OSTD_TRC_DEBUGH3(v1, v2, v3) do {\
		if(PCORE_OSTD_1_Trace_Filter[0]==1 && (PCORE_OSTD_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x0A1D, (unsigned short)(v1)), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	#define OSTD_TRC_DEBUGH3(v1, v2, v3)
#endif
#define OSTD_TRC_DEBUGH3_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0A1D, (unsigned short)(v1)), (unsigned long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER)
	#define OSTD_TRC_DEBUGH4(v1, v2, v3, v4) do {\
		if(PCORE_OSTD_1_Trace_Filter[0]==1 && (PCORE_OSTD_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x0B1D, (unsigned short)(v1)), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	#define OSTD_TRC_DEBUGH4(v1, v2, v3, v4)
#endif
#define OSTD_TRC_DEBUGH4_NOFLTR(v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0B1D, (unsigned short)(v1)), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))
