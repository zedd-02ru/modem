...
#define EL1D_TRC_RF_TAS_INFO_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_6_DATA(TRC_MERGE_1S2C(0x4137, (unsigned char)(v3), TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6))
	...
	#define EL1D_TRC_RF_CTRL_RX_LPM_DEBUG(v1, v2, v3, v4, v5, v6) do {\
		if(EL1D_RF0_Trace_Filter[0]==1 && (EL1D_RF0_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_6_DATA(TRC_MERGE_2S(0x4237, (unsigned short)(v1)), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6));\
	} while(0)
#else
	#define EL1D_TRC_RF_CTRL_RX_LPM_DEBUG(v1, v2, v3, v4, v5, v6)
#endif
#define EL1D_TRC_RF_CTRL_RX_LPM_DEBUG_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_6_DATA(TRC_MERGE_2S(0x4237, (unsigned short)(v1)), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6))

#if defined(L1_CATCHER)
	#define EL1D_TRC_SINGLE_ANT_INFO(v1, v2, v3) do {\
		if(EL1D_RF0_Trace_Filter[0]==1 && (EL1D_RF0_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4337, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	#define EL1D_TRC_SINGLE_ANT_INFO(v1, v2, v3)
#endif
#define EL1D_TRC_SINGLE_ANT_INFO_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4337, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EL1D_TRC_TX_HRM_SUPPORT_INDICATOR(v1, v2, v3) do {\
		if(EL1D_RF0_Trace_Filter[0]==1 && (EL1D_RF0_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4437, (unsigned char)(v1), (unsigned char)(v2)), (unsigned long)(v3));\
	} while(0)
#else
	#define EL1D_TRC_TX_HRM_SUPPORT_INDICATOR(v1, v2, v3)
#endif
#define EL1D_TRC_TX_HRM_SUPPORT_INDICATOR_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4437, (unsigned char)(v1), (unsigned char)(v2)), (unsigned long)(v3))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EL1D_TRC_TX_HRM_SUPPORT(v1, v2, v3) do {\
		if(EL1D_RF0_Trace_Filter[0]==1 && (EL1D_RF0_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4537, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1D_TRC_TX_HRM_SUPPORT(v1, v2, v3)
#endif
#define EL1D_TRC_TX_HRM_SUPPORT_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4537, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EL1D_TRC_RF_CTRL_TX_HRM_STATE_CHECK(v1, v2) do {\
		if(EL1D_RF0_Trace_Filter[0]==1 && (EL1D_RF0_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4637, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define EL1D_TRC_RF_CTRL_TX_HRM_STATE_CHECK(v1, v2)
#endif
#define EL1D_TRC_RF_CTRL_TX_HRM_STATE_CHECK_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4637, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EL1D_TRC_RF_CAL_RX_IRR_COMP_INFO(v1, v2, v3, v4, v5, v6, v7) do {\
		if(EL1D_RF0_Trace_Filter[0]==1 && (EL1D_RF0_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4737, (unsigned char)(v2), (unsigned char)(v3)), TRC_MERGE_4C((unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6), (unsigned char)(v7)), (long)(v1));\
	} while(0)
#else
	#define EL1D_TRC_RF_CAL_RX_IRR_COMP_INFO(v1, v2, v3, v4, v5, v6, v7)
#endif
#define EL1D_TRC_RF_CAL_RX_IRR_COMP_INFO_NOFLTR(v1, v2, v3, v4, v5, v6, v7) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4737, (unsigned char)(v2), (unsigned char)(v3)), TRC_MERGE_4C((unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6), (unsigned char)(v7)), (long)(v1))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EL1D_TRC_RF_DB_BAND_2_IND(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10) do {\
		if(EL1D_RF0_Trace_Filter[0]==1 && (EL1D_RF0_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4837, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)), TRC_MERGE_4C((unsigned char)(v7), (unsigned char)(v8), (unsigned char)(v9), (unsigned char)(v10)));\
	} while(0)
#else
	#define EL1D_TRC_RF_DB_BAND_2_IND(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10)
#endif
#define EL1D_TRC_RF_DB_BAND_2_IND_NOFLTR(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4837, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)), TRC_MERGE_4C((unsigned char)(v7), (unsigned char)(v8), (unsigned char)(v9), (unsigned char)(v10)))

#if defined(L1_CATCHER)
	#define EL1D_TRC_RF_DB_BAND_SUPPORT_MASK(v1, v2) do {\
		if(EL1D_RF0_Trace_Filter[0]==1 && (EL1D_RF0_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4937, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2));\
	} while(0)
#else
	#define EL1D_TRC_RF_DB_BAND_SUPPORT_MASK(v1, v2)
#endif
#define EL1D_TRC_RF_DB_BAND_SUPPORT_MASK_NOFLTR(v1, v2) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4937, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EL1D_TRC_RXLIF_NCO_INFO(v1, v2, v3) do {\
		if(EL1D_RF0_Trace_Filter[0]==1 && (EL1D_RF0_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x4A37, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (long)(v2), (long)(v3));\
	} while(0)
#else
	#define EL1D_TRC_RXLIF_NCO_INFO(v1, v2, v3)
#endif
#define EL1D_TRC_RXLIF_NCO_INFO_NOFLTR(v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x4A37, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (long)(v2), (long)(v3))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EL1D_TRC_RF_TX_BYPASS_PATH(v1, v2) do {\
		if(EL1D_RF0_Trace_Filter[0]==1 && (EL1D_RF0_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4B37, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define EL1D_TRC_RF_TX_BYPASS_PATH(v1, v2)
#endif
#define EL1D_TRC_RF_TX_BYPASS_PATH_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4B37, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EL1D_TRC_RF_AMPR_SPECIAL_HANDLE_BITMAP(v1) do {\
		if(EL1D_RF0_Trace_Filter[0]==1 && (EL1D_RF0_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4C37, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1));\
	} while(0)
#else
	#define EL1D_TRC_RF_AMPR_SPECIAL_HANDLE_BITMAP(v1)
#endif
#define EL1D_TRC_RF_AMPR_SPECIAL_HANDLE_BITMAP_NOFLTR(v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4C37, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))

#if defined(L1_CATCHER)
	#define EL1D_TRC_RF_ELNA_INFO(v1, v2) do {\
		if(EL1D_RF0_Trace_Filter[0]==1 && (EL1D_RF0_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x4D37, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1D_TRC_RF_ELNA_INFO(v1, v2)
#endif
#define EL1D_TRC_RF_ELNA_INFO_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x4D37, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1D_TRC_RF_ELNA_NCCA_INFO(v1) do {\
		if(EL1D_RF0_Trace_Filter[0]==1 && (EL1D_RF0_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x4E37, (unsigned short)(v1)));\
	} while(0)
#else
	#define EL1D_TRC_RF_ELNA_NCCA_INFO(v1)
#endif
#define EL1D_TRC_RF_ELNA_NCCA_INFO_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x4E37, (unsigned short)(v1)))
