...
#define EL1TX_LOG_CR_ACK_TIME_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2706, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
	...
	#define EL1TX_LOG_CTRL_SGNL(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2806, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_CTRL_SGNL(v1, v2, v3)
#endif
#define EL1TX_LOG_CTRL_SGNL_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2806, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_ACK_REP_CNT(v1) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2906, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_ACK_REP_CNT(v1)
#endif
#define EL1TX_LOG_ACK_REP_CNT_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2906, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_CRNTI(v1) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x2A06, (unsigned short)(v1)));\
	} while(0)
#else
	#define EL1TX_LOG_CRNTI(v1)
#endif
#define EL1TX_LOG_CRNTI_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x2A06, (unsigned short)(v1)))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TCRARNTI(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x2B06, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_TCRARNTI(v1, v2)
#endif
#define EL1TX_LOG_TCRARNTI_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2B06, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_DRX_PUCCH_INFO(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x2C06, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_DRX_PUCCH_INFO(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_DRX_PUCCH_INFO_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2C06, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_FLOW(v1) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2D06, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_FLOW(v1)
#endif
#define EL1TX_LOG_FLOW_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2D06, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_FLOW2(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x2E06, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_FLOW2(v1, v2)
#endif
#define EL1TX_LOG_FLOW2_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2E06, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_VRB_LEN_RPT(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x2F06, (unsigned short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_VRB_LEN_RPT(v1, v2)
#endif
#define EL1TX_LOG_VRB_LEN_RPT_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2F06, (unsigned short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define EL1TX_LOG_FLOW_TIME_LV(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x80)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x3006, (unsigned char)(v3), (unsigned char)(v4)), (unsigned long)(v1), (unsigned long)(v2));\
	} while(0)
#else
	#define EL1TX_LOG_FLOW_TIME_LV(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_FLOW_TIME_LV_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x3006, (unsigned char)(v3), (unsigned char)(v4)), (unsigned long)(v1), (unsigned long)(v2))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_PDCCH_INIT_WARN(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x08)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x3106, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2));\
	} while(0)
#else
	#define EL1TX_LOG_PDCCH_INIT_WARN(v1, v2)
#endif
#define EL1TX_LOG_PDCCH_INIT_WARN_NOFLTR(v1, v2) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x3106, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_DCI0_FALSE_ALARM(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x3206, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_DCI0_FALSE_ALARM(v1, v2, v3)
#endif
#define EL1TX_LOG_DCI0_FALSE_ALARM_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3206, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_DCI_WARNING(v1) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x08)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3306, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_DCI_WARNING(v1)
#endif
#define EL1TX_LOG_DCI_WARNING_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3306, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define EL1TX_LOG_FUNC_CALL_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3406, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_MSG_SND(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3506, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define EL1TX_LOG_MSG_SND(v1, v2)
#endif
#define EL1TX_LOG_MSG_SND_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3506, (unsigned char)(v1), (unsigned char)(v2)))
...
#endif
#define EL1TX_LOG_MSG_RCV_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3606, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_PS_SF_IND_INFO(v1) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x3706, (unsigned short)(v1)));\
	} while(0)
#else
	#define EL1TX_LOG_PS_SF_IND_INFO(v1)
#endif
#define EL1TX_LOG_PS_SF_IND_INFO_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x3706, (unsigned short)(v1)))
...
#endif
#define EL1TX_LOG_PS_SF_RSP_INFO_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x3806, (unsigned short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define EL1TX_LOG_RT_CMD_PHICH_ENQUEUE(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x3906, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PHICH_ENQUEUE(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_RT_CMD_PHICH_ENQUEUE_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x3906, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define EL1TX_LOG_NRT_CMD_PHICH_DECODE_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x3A06, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_NRT_CMD_PDSCH_OPT(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x3B06, (unsigned short)(v2)), TRC_MERGE_1S2C((unsigned short)(v3), (char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_NRT_CMD_PDSCH_OPT(v1, v2, v3)
#endif
#define EL1TX_LOG_NRT_CMD_PDSCH_OPT_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3B06, (unsigned short)(v2)), TRC_MERGE_1S2C((unsigned short)(v3), (char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_NRT_CMD_FAKE_ACK_OPT(v1) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x3C06, (unsigned short)(v1)));\
	} while(0)
#else
	#define EL1TX_LOG_NRT_CMD_FAKE_ACK_OPT(v1)
#endif
#define EL1TX_LOG_NRT_CMD_FAKE_ACK_OPT_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x3C06, (unsigned short)(v1)))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_Tx_Enbl(v1, v2, v3, v4, v5, v6, v7) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x3D06, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)), TRC_MERGE_4C((unsigned char)(v7), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_Tx_Enbl(v1, v2, v3, v4, v5, v6, v7)
#endif
#define EL1TX_LOG_RT_CMD_Tx_Enbl_NOFLTR(v1, v2, v3, v4, v5, v6, v7) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x3D06, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)), TRC_MERGE_4C((unsigned char)(v7), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_Tx_Enbl2(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3E06, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_Tx_Enbl2(v1, v2)
#endif
#define EL1TX_LOG_RT_CMD_Tx_Enbl2_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3E06, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER)
	#define El1TX_LOG_RT_CMD_Tx_time(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x3F06, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define El1TX_LOG_RT_CMD_Tx_time(v1, v2)
#endif
#define El1TX_LOG_RT_CMD_Tx_time_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3F06, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define EL1TX_LOG_RT_CMD_Rx_time_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x4006, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PUSCH0(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x4106, (unsigned short)(v4)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PUSCH0(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_RT_CMD_PUSCH0_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_2S(0x4106, (unsigned short)(v4)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PUSCH1(v1, v2, v3, v4, v5, v6, v7, v8) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x4206, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v5), (unsigned char)(v2), (unsigned char)(v3)), TRC_MERGE_4C((unsigned char)(v4), (unsigned char)(v6), (unsigned char)(v7), (unsigned char)(v8)));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PUSCH1(v1, v2, v3, v4, v5, v6, v7, v8)
#endif
#define EL1TX_LOG_RT_CMD_PUSCH1_NOFLTR(v1, v2, v3, v4, v5, v6, v7, v8) TRC_SEND_3_DATA(TRC_MERGE_2S(0x4206, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v5), (unsigned char)(v2), (unsigned char)(v3)), TRC_MERGE_4C((unsigned char)(v4), (unsigned char)(v6), (unsigned char)(v7), (unsigned char)(v8)))

#if defined(L1_CATCHER)
	#define El1TX_LOG_RT_CMD_SKIP_TX(v1, v2, v3, v4, v5) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x4306, (unsigned short)(v1)), TRC_MERGE_1S2C((short)(v5), (unsigned char)(v2), (char)(v3)), TRC_MERGE_4C((char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define El1TX_LOG_RT_CMD_SKIP_TX(v1, v2, v3, v4, v5)
#endif
#define El1TX_LOG_RT_CMD_SKIP_TX_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x4306, (unsigned short)(v1)), TRC_MERGE_1S2C((short)(v5), (unsigned char)(v2), (char)(v3)), TRC_MERGE_4C((char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PUSCH2(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4406, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PUSCH2(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_RT_CMD_PUSCH2_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4406, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PUSCH3(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4506, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PUSCH3(v1, v2)
#endif
#define EL1TX_LOG_RT_CMD_PUSCH3_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4506, (unsigned char)(v1), (unsigned char)(v2)))
...
#endif
#define EL1TX_LOG_RT_CMD_PUSCH4_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4606, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PUCCH(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x4706, (unsigned short)(v4)), TRC_MERGE_4C((unsigned char)(v1), (char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PUCCH(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_RT_CMD_PUCCH_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_2S(0x4706, (unsigned short)(v4)), TRC_MERGE_4C((unsigned char)(v1), (char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PUCCH_CQI(v1, v2, v3, v4, v5) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4806, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PUCCH_CQI(v1, v2, v3, v4, v5)
#endif
#define EL1TX_LOG_RT_CMD_PUCCH_CQI_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4806, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PRACH0(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4906, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PRACH0(v1, v2, v3)
#endif
#define EL1TX_LOG_RT_CMD_PRACH0_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4906, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PUSCH_CQI(v1, v2, v3, v4, v5) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4A06, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PUSCH_CQI(v1, v2, v3, v4, v5)
#endif
#define EL1TX_LOG_RT_CMD_PUSCH_CQI_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4A06, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_O_ACK(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x4B06, (unsigned short)(v2)), (unsigned long)(v1));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_O_ACK(v1, v2)
#endif
#define EL1TX_LOG_RT_CMD_O_ACK_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x4B06, (unsigned short)(v2)), (unsigned long)(v1))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PUSCH_ACK(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4C06, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PUSCH_ACK(v1, v2)
#endif
#define EL1TX_LOG_RT_CMD_PUSCH_ACK_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4C06, (unsigned char)(v1), (unsigned char)(v2)))
...
#endif
#define EL1TX_LOG_RT_CMD_PUSCH_ACK_nBundle_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4D06, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PUCCH_ACK(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4E06, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PUCCH_ACK(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_RT_CMD_PUCCH_ACK_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4E06, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PUCCH_TPC(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4F06, (char)(v1), (char)(v2)));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PUCCH_TPC(v1, v2)
#endif
#define EL1TX_LOG_RT_CMD_PUCCH_TPC_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4F06, (char)(v1), (char)(v2)))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_SRS_UCI(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5006, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_SRS_UCI(v1, v2, v3)
#endif
#define EL1TX_LOG_RT_CMD_SRS_UCI_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5006, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_RX_PCSI(v1, v2, v3, v4, v5) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x5106, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5)));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_RX_PCSI(v1, v2, v3, v4, v5)
#endif
#define EL1TX_LOG_RT_CMD_RX_PCSI_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_2S(0x5106, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5)))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_TX_PCSI(v1, v2, v3, v4, v5) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5206, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_TX_PCSI(v1, v2, v3, v4, v5)
#endif
#define EL1TX_LOG_RT_CMD_TX_PCSI_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5206, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_PUXCH_ACK_RPT(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5306, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2));\
	} while(0)
#else
	#define EL1TX_LOG_PUXCH_ACK_RPT(v1, v2)
#endif
#define EL1TX_LOG_PUXCH_ACK_RPT_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5306, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TX_COMMON_RPT(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x5406, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_TX_COMMON_RPT(v1, v2)
#endif
#define EL1TX_LOG_TX_COMMON_RPT_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x5406, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_PUSCH_PRB_RPT(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x5506, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_PUSCH_PRB_RPT(v1, v2, v3)
#endif
#define EL1TX_LOG_PUSCH_PRB_RPT_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x5506, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_ACQI_INFO_RPT(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5606, (char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_ACQI_INFO_RPT(v1, v2, v3)
#endif
#define EL1TX_LOG_ACQI_INFO_RPT_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5606, (char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_ACQI_1_2_WB_RPT(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5706, (char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_ACQI_1_2_WB_RPT(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_ACQI_1_2_WB_RPT_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5706, (char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_ACQI_1_2_PMI_RPT(v1, v2, v3, v4, v5, v6, v7) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x5806, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), (char)(v5), (char)(v6)), TRC_MERGE_4C((char)(v7), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_ACQI_1_2_PMI_RPT(v1, v2, v3, v4, v5, v6, v7)
#endif
#define EL1TX_LOG_ACQI_1_2_PMI_RPT_NOFLTR(v1, v2, v3, v4, v5, v6, v7) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x5806, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), (char)(v5), (char)(v6)), TRC_MERGE_4C((char)(v7), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_ACQI_2_2_WB_RPT(v1, v2, v3, v4, v5) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5906, (char)(v1), (char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (char)(v4), (char)(v5), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_ACQI_2_2_WB_RPT(v1, v2, v3, v4, v5)
#endif
#define EL1TX_LOG_ACQI_2_2_WB_RPT_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5906, (char)(v1), (char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (char)(v4), (char)(v5), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_ACQI_2_2_UE_M_RPT(v1, v2, v3, v4, v5) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x5A06, (char)(v1), (char)(v3)), TRC_MERGE_4C((char)(v4), (char)(v5), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v2));\
	} while(0)
#else
	#define EL1TX_LOG_ACQI_2_2_UE_M_RPT(v1, v2, v3, v4, v5)
#endif
#define EL1TX_LOG_ACQI_2_2_UE_M_RPT_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x5A06, (char)(v1), (char)(v3)), TRC_MERGE_4C((char)(v4), (char)(v5), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v2))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_ACQI_3_1_WB_RPT(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5B06, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_ACQI_3_1_WB_RPT(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_ACQI_3_1_WB_RPT_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5B06, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_ACQI_3_1_SB_RPT(v1, v2, v3, v4, v5, v6, v7) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x5C06, (char)(v1), (char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)), TRC_MERGE_4C((unsigned char)(v7), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_ACQI_3_1_SB_RPT(v1, v2, v3, v4, v5, v6, v7)
#endif
#define EL1TX_LOG_ACQI_3_1_SB_RPT_NOFLTR(v1, v2, v3, v4, v5, v6, v7) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x5C06, (char)(v1), (char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)), TRC_MERGE_4C((unsigned char)(v7), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_PCQI_DATA_RPT(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x5D06, (unsigned short)(v4)), TRC_MERGE_4C((char)(v1), (unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_PCQI_DATA_RPT(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_PCQI_DATA_RPT_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_2S(0x5D06, (unsigned short)(v4)), TRC_MERGE_4C((char)(v1), (unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_PCQI_INFO_RPT(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5E06, (char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_PCQI_INFO_RPT(v1, v2, v3)
#endif
#define EL1TX_LOG_PCQI_INFO_RPT_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x5E06, (char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_PCQI_WB_RPT(v1, v2, v3, v4, v5) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x5F06, (short)(v5)), TRC_MERGE_4C((char)(v1), (unsigned char)(v2), (char)(v3), (unsigned char)(v4)));\
	} while(0)
#else
	#define EL1TX_LOG_PCQI_WB_RPT(v1, v2, v3, v4, v5)
#endif
#define EL1TX_LOG_PCQI_WB_RPT_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_2S(0x5F06, (short)(v5)), TRC_MERGE_4C((char)(v1), (unsigned char)(v2), (char)(v3), (unsigned char)(v4)))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_PCQI_SB_RPT(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x6006, (char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_PCQI_SB_RPT(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_PCQI_SB_RPT_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x6006, (char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_DL_QUAL_CQI(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x6106, (char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_DL_QUAL_CQI(v1, v2, v3)
#endif
#define EL1TX_LOG_DL_QUAL_CQI_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x6106, (char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_MPR_PWR(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x6206, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_MPR_PWR(v1, v2, v3)
#endif
#define EL1TX_LOG_RT_CMD_MPR_PWR_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x6206, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PMPR_PWR(v1) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x6306, (unsigned short)(v1)));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PMPR_PWR(v1)
#endif
#define EL1TX_LOG_RT_CMD_PMPR_PWR_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x6306, (unsigned short)(v1)))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PL_PWR(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x6406, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PL_PWR(v1, v2, v3)
#endif
#define EL1TX_LOG_RT_CMD_PL_PWR_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x6406, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PUSCH_SCALE(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x6506, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PUSCH_SCALE(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_RT_CMD_PUSCH_SCALE_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x6506, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PUSCH_PWR0(v1, v2, v3, v4, v5) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x6606, (short)(v1)), TRC_MERGE_4C((char)(v2), (unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5)));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PUSCH_PWR0(v1, v2, v3, v4, v5)
#endif
#define EL1TX_LOG_RT_CMD_PUSCH_PWR0_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_2S(0x6606, (short)(v1)), TRC_MERGE_4C((char)(v2), (unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5)))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PUSCH_PWR1(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x6706, (short)(v3)), TRC_MERGE_1S2C((short)(v4), (unsigned char)(v1), (char)(v2)));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PUSCH_PWR1(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_RT_CMD_PUSCH_PWR1_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_2S(0x6706, (short)(v3)), TRC_MERGE_1S2C((short)(v4), (unsigned char)(v1), (char)(v2)))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PUSCH_PWR2(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x6806, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v4)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PUSCH_PWR2(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_RT_CMD_PUSCH_PWR2_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x6806, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v4)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PUCCH_PWR0(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x6906, (short)(v1)), TRC_MERGE_4C((char)(v2), (char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PUCCH_PWR0(v1, v2, v3)
#endif
#define EL1TX_LOG_RT_CMD_PUCCH_PWR0_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x6906, (short)(v1)), TRC_MERGE_4C((char)(v2), (char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PUCCH_PWR1(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x6A06, (short)(v3)), TRC_MERGE_1S2C((short)(v4), (unsigned char)(v1), (char)(v2)));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PUCCH_PWR1(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_RT_CMD_PUCCH_PWR1_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_2S(0x6A06, (short)(v3)), TRC_MERGE_1S2C((short)(v4), (unsigned char)(v1), (char)(v2)))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PUCCH_PWR2(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x6B06, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v4)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PUCCH_PWR2(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_RT_CMD_PUCCH_PWR2_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x6B06, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v4)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_PRACH_PWR(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x6C06, (unsigned short)(v1)), TRC_MERGE_4C((char)(v2), (char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_PRACH_PWR(v1, v2, v3)
#endif
#define EL1TX_LOG_RT_CMD_PRACH_PWR_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x6C06, (unsigned short)(v1)), TRC_MERGE_4C((char)(v2), (char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_SRS_PWR0(v1, v2, v3, v4, v5, v6) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x6D06, (short)(v1)), TRC_MERGE_4C((char)(v2), (unsigned char)(v3), (unsigned char)(v4), (char)(v5)), TRC_MERGE_4C((unsigned char)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_SRS_PWR0(v1, v2, v3, v4, v5, v6)
#endif
#define EL1TX_LOG_RT_CMD_SRS_PWR0_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_3_DATA(TRC_MERGE_2S(0x6D06, (short)(v1)), TRC_MERGE_4C((char)(v2), (unsigned char)(v3), (unsigned char)(v4), (char)(v5)), TRC_MERGE_4C((unsigned char)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RT_CMD_SRS_PWR2(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x6E06, (short)(v1)), TRC_MERGE_1S2C((short)(v2), (char)(v3), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RT_CMD_SRS_PWR2(v1, v2, v3)
#endif
#define EL1TX_LOG_RT_CMD_SRS_PWR2_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x6E06, (short)(v1)), TRC_MERGE_1S2C((short)(v2), (char)(v3), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TPC_PHR_RPT(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x6F06, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v4));\
	} while(0)
#else
	#define EL1TX_LOG_TPC_PHR_RPT(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_TPC_PHR_RPT_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x6F06, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v4))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_UMPR_INFO0(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x7006, (unsigned char)(v1), (char)(v2)));\
	} while(0)
#else
	#define EL1TX_LOG_UMPR_INFO0(v1, v2)
#endif
#define EL1TX_LOG_UMPR_INFO0_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x7006, (unsigned char)(v1), (char)(v2)))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_UMPR_INFO1(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x7106, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_UMPR_INFO1(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_UMPR_INFO1_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x7106, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TAS_STATUS(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x7206, (unsigned char)(v1), (unsigned char)(v2)), (long)(v3));\
	} while(0)
#else
	#define EL1TX_LOG_TAS_STATUS(v1, v2, v3)
#endif
#define EL1TX_LOG_TAS_STATUS_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x7206, (unsigned char)(v1), (unsigned char)(v2)), (long)(v3))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TAS_NORMAL0(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x7306, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_TAS_NORMAL0(v1, v2, v3)
#endif
#define EL1TX_LOG_TAS_NORMAL0_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x7306, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TAS_NORMAL1(v1, v2, v3, v4, v5) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x7406, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), (char)(v5), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_TAS_NORMAL1(v1, v2, v3, v4, v5)
#endif
#define EL1TX_LOG_TAS_NORMAL1_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x7406, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), (char)(v5), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TAS_PRE_SWITCH0(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x7506, (char)(v1), (char)(v2)), (long)(v3));\
	} while(0)
#else
	#define EL1TX_LOG_TAS_PRE_SWITCH0(v1, v2, v3)
#endif
#define EL1TX_LOG_TAS_PRE_SWITCH0_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x7506, (char)(v1), (char)(v2)), (long)(v3))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TAS_PRE_SWITCH1(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x7606, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_TAS_PRE_SWITCH1(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_TAS_PRE_SWITCH1_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x7606, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TAS_PHI_STATUS(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x7706, (char)(v1), (char)(v2)));\
	} while(0)
#else
	#define EL1TX_LOG_TAS_PHI_STATUS(v1, v2)
#endif
#define EL1TX_LOG_TAS_PHI_STATUS_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x7706, (char)(v1), (char)(v2)))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TAS_PHI_STATUS1(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x7806, (char)(v1), (char)(v2)));\
	} while(0)
#else
	#define EL1TX_LOG_TAS_PHI_STATUS1(v1, v2)
#endif
#define EL1TX_LOG_TAS_PHI_STATUS1_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x7806, (char)(v1), (char)(v2)))
...
#endif
#define EL1TX_LOG_TAS_DB_STATUS_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x7906, (char)(v1), (char)(v2)))
...
#endif
#define EL1TX_LOG_TAS_FTC_STATUS_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x7A06, (char)(v1), (char)(v2)))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TAS_CB_STATUS(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x7B06, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_TAS_CB_STATUS(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_TAS_CB_STATUS_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x7B06, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define EL1TX_LOG_TAS_FORCE_TX_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x7C06, (char)(v1), (char)(v2)))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RAS_SA_STATUS(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x7D06, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	#define EL1TX_LOG_RAS_SA_STATUS(v1, v2, v3)
#endif
#define EL1TX_LOG_RAS_SA_STATUS_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x7D06, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RAS_RXD_STATUS(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x7E06, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	#define EL1TX_LOG_RAS_RXD_STATUS(v1, v2, v3)
#endif
#define EL1TX_LOG_RAS_RXD_STATUS_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x7E06, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RAS_CB_STATUS(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x7F06, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RAS_CB_STATUS(v1, v2, v3)
#endif
#define EL1TX_LOG_RAS_CB_STATUS_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x7F06, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TAS_FEATURE(v1, v2, v3, v4, v5, v6, v7, v8, v9) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_6_DATA(TRC_MERGE_1S2C(0x8006, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), (char)(v5), TRC_BOXSTER_PAD), (unsigned long)(v6), (unsigned long)(v7), (unsigned long)(v8), (unsigned long)(v9));\
	} while(0)
#else
	#define EL1TX_LOG_TAS_FEATURE(v1, v2, v3, v4, v5, v6, v7, v8, v9)
#endif
#define EL1TX_LOG_TAS_FEATURE_NOFLTR(v1, v2, v3, v4, v5, v6, v7, v8, v9) TRC_SEND_6_DATA(TRC_MERGE_1S2C(0x8006, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), (char)(v5), TRC_BOXSTER_PAD), (unsigned long)(v6), (unsigned long)(v7), (unsigned long)(v8), (unsigned long)(v9))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TAS_RSRP_DIFF_THD(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x8106, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_TAS_RSRP_DIFF_THD(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_TAS_RSRP_DIFF_THD_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x8106, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TAS_CB_THD(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x8206, (short)(v3)), TRC_MERGE_4C((char)(v1), (char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_TAS_CB_THD(v1, v2, v3)
#endif
#define EL1TX_LOG_TAS_CB_THD_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x8206, (short)(v3)), TRC_MERGE_4C((char)(v1), (char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TAS_TPC_HTP_THD(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x8306, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_TAS_TPC_HTP_THD(v1, v2)
#endif
#define EL1TX_LOG_TAS_TPC_HTP_THD_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x8306, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TAS_TPC_SB_THD(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x8406, (short)(v3)), TRC_MERGE_4C((char)(v1), (char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_TAS_TPC_SB_THD(v1, v2, v3)
#endif
#define EL1TX_LOG_TAS_TPC_SB_THD_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x8406, (short)(v3)), TRC_MERGE_4C((char)(v1), (char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TAS_PHI_INFO(v1, v2, v3, v4) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x8506, (short)(v4)), TRC_MERGE_4C((char)(v1), (char)(v2), (char)(v3), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_TAS_PHI_INFO(v1, v2, v3, v4)
#endif
#define EL1TX_LOG_TAS_PHI_INFO_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_2S(0x8506, (short)(v4)), TRC_MERGE_4C((char)(v1), (char)(v2), (char)(v3), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_TAS_DB_INFO0(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x8606, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_TAS_DB_INFO0(v1, v2, v3)
#endif
#define EL1TX_LOG_TAS_DB_INFO0_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x8606, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#endif
#define EL1TX_LOG_TAS_DB_INFO1_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x8706, (short)(v3)), TRC_MERGE_4C((char)(v1), (char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RAS_TPC_HTP_THD(v1, v2) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x8806, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define EL1TX_LOG_RAS_TPC_HTP_THD(v1, v2)
#endif
#define EL1TX_LOG_RAS_TPC_HTP_THD_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x8806, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define EL1TX_LOG_RAS_TIMER(v1, v2, v3) do {\
		if(EL1_TX_1_Trace_Filter[0]==1 && (EL1_TX_1_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x8906, (unsigned short)(v3)), (unsigned long)(v1), (unsigned long)(v2));\
	} while(0)
#else
	#define EL1TX_LOG_RAS_TIMER(v1, v2, v3)
#endif
#define EL1TX_LOG_RAS_TIMER_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x8906, (unsigned short)(v3)), (unsigned long)(v1), (unsigned long)(v2))
