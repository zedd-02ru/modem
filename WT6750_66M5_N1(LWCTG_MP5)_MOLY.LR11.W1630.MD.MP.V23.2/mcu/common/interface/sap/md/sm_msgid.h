...
MODULE_MSG_BEGIN( MSG_ID_SM_CODE_BEGIN )
    ...
    /* MSG_ID_L4CSM_STOP_TO_PERFORM_ACT_RETRY_NOTIFY_REQ 
     * To resolve VZW UICC 5.2.1 (ALPS02732574),  
     * When BIP Open channel, SIM notify L4C notify SM to stop performing activation retry
     * To prevent AT command blocking of AP (VZWINTERNET block VZWADMIN) cause test case fail.
     */
	MSG_ID_L4CSM_STOP_TO_PERFORM_ACT_RETRY_NOTIFY_REQ, 
