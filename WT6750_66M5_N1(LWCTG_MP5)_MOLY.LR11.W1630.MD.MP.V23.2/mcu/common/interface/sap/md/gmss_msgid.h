...
/* messages received from RAC at RAC_GMSS_SAP */
    ...
    MSG_ID_RAC_GMSS_UE_OPLMN_UPDATE_REQ, //NOT use
    MSG_ID_RAC_GMSS_GET_UE_OPLMN_REQ,    //NOT use
    ...
    MSG_ID_RAC_GMSS_SMU_PIN_VERIFY_STATUS_REQ,

/* messages for VZW ECC call */
    MSG_ID_RAC_GMSS_EMC_SESSION_START_REQ,
    MSG_ID_RAC_GMSS_EMC_SESSION_STOP_REQ,
...
/* messages received from NWSEL at GMSS_NWSEL_SAP */
    ...
    MSG_ID_GMSS_NWSEL_SET_3GPP_ACTIVE_CNF,
    MSG_ID_GMSS_NWSEL_SET_3GPP2_ACTIVE_CNF,
    ...
    MSG_ID_GMSS_NWSEL_GET_UE_OPLMN_CNF, //NOT use
    MSG_ID_GMSS_NWSEL_GET_CUSTOM_PLMN_LIST_CNF,
#ifdef __GEMINI_WCDMA_WORLD_PHONE__
    MSG_ID_GMSS_NWSEL_SIM_READY_CNF,
    MSG_ID_GMSS_NWSEL_SERVING_CELL_SIGNAL_QUALITY_IND,
#endif
...
/* messages from GMSS */
    ...
    MSG_ID_GMSS_CODE_END = MSG_ID_RAC_GMSS_LOCATION_INFO_REQ,
