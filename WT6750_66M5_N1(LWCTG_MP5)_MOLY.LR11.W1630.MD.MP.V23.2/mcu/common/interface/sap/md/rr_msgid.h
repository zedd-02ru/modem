...
MODULE_MSG_BEGIN( MSG_ID_RRM_COMMON_CODE_BEGIN )
...
#if defined(__UMTS_RAT__) || defined(__LTE_RAT__)
    MSG_ID_RATCM_GAS_EMC_SESSION_START_REQ,
    MSG_ID_RATCM_GAS_EMC_SESSION_STOP_REQ,
#endif /* defined(__UMTS_RAT__) || defined(__LTE_RAT__) */
    ...
    MSG_ID_RSVAS_GAS_VIRTUAL_SUSPEND_STATUS_IND,
...
MODULE_MSG_BEGIN( MSG_ID_FDD_GAS_CODE_BEGIN )
    ...
    MSG_ID_FDD_GAS_CODE_END = MSG_ID_RATCM_GAS_PLMN_LIST_STATUS_UPDATE_REQ,
