...
typedef enum {
    ...
    MSG_ID_EM_CODE_BEGIN, MSG_ID_EM_CODE_TAIL = MSG_ID_EM_CODE_BEGIN + 500,
    ...
    MSG_ID_UPCM_CODE_BEGIN ,  MSG_ID_UPCM_CODE_TAIL = MSG_ID_UPCM_CODE_BEGIN+30,
    ...
    MSG_ID_SPH_EVS_BEGIN, MSG_ID_SPH_EVS_TAIL = MSG_ID_SPH_EVS_BEGIN + 10,

    MSG_ID_WAAL_CODE_BEGIN, MSG_ID_WAAL_CODE_TAIL = MSG_ID_WAAL_CODE_BEGIN + 20,
