...
#ifdef  __UMTS_RAT__
BUFFER_WHITELIST_DECLARE("mac_cfg_ciphering.c", "UL2", MOD_UMAC_FDD, 6)
#endif

#ifdef __CDMA2000_RAT__
BUFFER_WHITELIST_DECLARE("gmss_sim_access.c", "NWSEL", MOD_GMSS, 12)
BUFFER_WHITELIST_DECLARE("gmss_list.c", "NWSEL", MOD_GMSS, 20)
#endif
...
BUFFER_WHITELIST_DECLARE("gmss_list.c", "NWSEL", MOD_GMSS_2, 20)
...
BUFFER_WHITELIST_DECLARE("gmss_list.c", "NWSEL", MOD_GMSS_3, 20)
...
BUFFER_WHITELIST_DECLARE("gmss_list.c", "NWSEL", MOD_GMSS_4, 20)
