...
#define SIZE_LTE_BAND_MASK_TABLE_EXTENDED  (256/8)  /* Extended supported LTE bitmask size in bits / bits in one byte */
...
#define FDD_MAX_NUM_MEASURED_UMTS_CARRIERS (3)
...
#define PS_SIM1_INSERTED 0x01
#define PS_SIM2_INSERTED 0x02
#define PS_SIM3_INSERTED 0x04
#define PS_SIM4_INSERTED 0x08
/* TYPES DEFINITIONS ********************************************************/
...
typedef enum {
   ...
   ,IR_BG_SRCH
   ,IR_HSR_CR
   ,IR_UMTS_FAST_RETURN /* Required for LR11 MP3 Smart Nw feature */
