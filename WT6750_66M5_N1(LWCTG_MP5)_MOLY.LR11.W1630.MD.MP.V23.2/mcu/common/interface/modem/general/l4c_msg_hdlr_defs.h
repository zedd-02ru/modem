...
L4C_IND(MSG_ID_L4CRAC_RSIM_AUTH_FINISH_IND, l4crac_rsim_auth_finish_ind_hdlr)
#endif
...
//just for avoid build error. If customer patce the new interface without l4 source, will build error.
L4C_CNF(MSG_ID_L4CRAC_GET_UE_OPLMN_CNF, l4crac_get_ue_oplmn_cnf_hdlr)
...
L4C_CNF(MSG_ID_L4CESM_RAT_CHANGE_CNF, l4cesm_rat_change_cnf_hdlr) //(23G4 finish)
...
L4C_CNF(MSG_ID_L4C_ESM_PS_SWITCH_CONTEXT_TRANSFER_CNF, l4c_esm_ps_switch_context_transfer_cnf_hdlr)
...
L4C_IND(MSG_ID_L4CESM_RAT_CHANGE_IND, l4cesm_rat_change_ind_hdlr)
...
L4C_IND(MSG_ID_L4CRAC_EMC_SERVICE_IND, l4crac_emc_service_ind_hdlr)
...
L4C_IND(MSG_ID_L4C_ESM_PS_SWITCH_CONTEXT_TRANSFER_IND, l4c_esm_ps_switch_context_transfer_ind_hdlr)
...
#else
L4C_CNF(MSG_ID_L4CRAC_GMSS_SET_PLMN_BARRING_TIMER_CNF, l4c_null_hdlr)
L4C_CNF(MSG_ID_L4CRAC_GMSS_GET_PLMN_BARRING_TIMER_CNF, l4c_null_hdlr)
L4C_IND(MSG_ID_L4CRAC_IMS_CALL_END_STATUS_IND, l4c_null_hdlr)
