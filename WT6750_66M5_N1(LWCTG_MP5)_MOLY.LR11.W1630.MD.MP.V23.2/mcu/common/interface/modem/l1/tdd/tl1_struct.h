 ...
 * $Log$
 *
 * 10 14 2016 xiaochi.zhang
 * [MOLY00204784] [Android N]TL1 add Tx Rx active time for Android N
 * 	
 * 	.
 * 	[Android N]TL1 add Tx Rx active time for Android N
 *
 * 05 18 2016 zheng.zou
 ...
 * 	.
 *
 * 12 18 2015 xuejing.chen
 * [MOLY00152614] RSSI edBm support on LR11
 * +ERSSI report value in 1/8 dBm.
 *
 * 11 17 2015 yunlong.li
 * [MOLY00134637] [Jade][TK6291][New Feature][ADT] Check in ADT new feature into LR11
 * 	
 * 	.modify marco
 *
 * 10 22 2015 yunlong.li
 * [MOLY00146257] [MT6755] [Jade-L1][MP1][CSFB DSDS][Overnight][FDD][WWFT][HZ][TTLIA] Externel (EE),0,0,99,/data/core/,1,modem,md1:(MCU_L1CORE)err_code1:0x00002403 err_code2:0x0309E720 err_code3:0xF01CF8DF
...
#define HARQ_BUFFER_MAX_SIZE_DEFINE      (32256)   //126K
