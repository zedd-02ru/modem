...
typedef struct
{
   const U_sTXPOWEROFFSETDATA** TpoData_p;
...
{
   /* 3G RX path loss */
   const U_sTEMPAGCOFFSET    **RxPathLoss_p;
   const U_sTEMPAGCOFFSET    **RxDPathLoss_p;
   const U_sPAOCTLVLSETTING  **PaOctLev_p;
   const U_sPARACHTMCOMPDATA **PaRachComp_p;
   const U_sPADRIFTSETTING   **PaDrift_p;
   const U_sRAMPDATA         **RampData_p;
...
typedef struct
{
   UMTS_FE_ROUTE_TABLE_T *FeSetting;
...
typedef struct
{
   ...
   UL1_UMTS_MIPI_ET_PARAM_T       *etParam_p;
#if (IS_3G_VPA_SEL_BY_BAND_SUPPORT)
   UMTS_VPA_SOURCE_TYPE           **vpaSrcSelTable_p;
...
typedef struct
{
   U_sUl1dRfTasData               TasCustomData;
   const UMTS_TAS_Configuration_T       *TasConfigTable_p;
   #if (IS_3G_TAS_ANTENNA_IDX_ON_TEST_SIM)
   const UMTS_TAS_ANT_IDX_T       TasAntIdx;
   #endif
}Ul1CustomDynamicTasData;
#endif
...
************************************************************************************/
extern UMTS_RF_POWER_ON_CAL_DATA_T wrfcalPocResult;

extern void UL1D_RF_DynamicCustomTable_Update(Ul1CustomDynamicInitUmtsFeSettingData *RfFeRoute_array_ptr);
extern void UL1D_RF_DynamicSetRfParameter( U_sUl1dRfCustomInputData *dst, Ul1CustomDynamicRfParameter *RfTiming_ptr );
   #if IS_3G_ELNA_SUPPORT
extern void UL1D_RF_DynamicElna_Update(U_sUl1DElnaSetting *dst, Ul1CustomDynamicElnaData *source);
   #endif
