...
//Define FPGA version code
#define DATE_CODE_BASE      0x80000018
#define PURPOSE_CODE_BASE   0x8000001C
#define PURPOSE_CODE_MASK   0xFF000000
typedef enum
{
   E_Before_20140801,
   E_20140801,
...
extern void INITSYNC_WriteAndPoll(volatile INITSYNC_STATE *writeaddr, volatile INITSYNC_STATE *polladdr);
