...
# Constants
#****************************************************************************
my $MODEMSIZE_CONFIG_VERNO    = " LR11_v0.01";
...
#****************************************************************************
$g_nL1CORE_LV_SIZE = FileInfo::get(FileInfo::L1CORE_LV_SIZE); # if(FileInfo::is_BuiltWithCopro()); 
$g_nL1CORE_RWZI_SIZE = FileInfo::get(FileInfo::L1CORE_RWZI_SIZE); # if(FileInfo::is_BuiltWithCopro()); 
...
sub AutoAdjust
{
    ...
    my $nL1CORE_LVEnd = &CommonUtil::GetMPUAligned( $nL1CORE_LVBase + $g_nL1CORE_LV_SIZE. "L1CORE_LVEnd");
    # update size
    ...
    # 2. RAM Size # reserved margin at least 0.5MB for SWLA (for pcore and l1core)
