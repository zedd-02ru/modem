...
sub get_L1CORE_INFO
{
    ...
    $COPRO_INFO_href->{FileInfo::L1CORE_SWLA_SIZE} = hex(SymFileParser::GetLinkerSymbolAddress("SWLA_REGION",LinkerSymPostfix::Length));
...
sub SetDefaultValue
{
    ...
    {
        $COPRO_INFO_href->{FileInfo::PCORE_LV_SIZE}    = 0x1000000; # 16MB
        $COPRO_INFO_href->{FileInfo::L1CORE_LV_SIZE}   = 0xC00000;  # 12MB
