...
typedef struct
{
    ...
    void* ptr;
} lpp_lppe_wlan_pos_assist_data_request_struct;
...
typedef struct
{
    ...
    kal_uint16                          lppTransID;  /* binded LPP transactio ID of this AD request */
    void* ptr;
} lpp_lppe_bt_pos_assist_data_request_struct;
...
typedef struct
{
    ...
    kal_uint16                          lppTransID;  /* binded LPP transactio ID of this AD request */
    void* ptr;
} lpp_lppe_sensor_pos_assist_data_request_struct;
