...
/* SRN location request info category */
#define SRN_MAX_LOC_REQ_INFO_CATEGORY_ELEMENT     16
...
#define WLAN_AP_MEAS_REQ_TYPE_BIT_OP_CLASS        (1 << 16)  /* 0x00010000 */  /* operating class */
