...
typedef enum
{
   ...
   SERVICE_U_PROSE_DIRECT_DISCOVERY,
   SERVICE_U_HPLMN_PROSE_FUNCTION,
   SERVICE_U_PROSE_DIRECT_COMMUNICATION_RADIO,
   SERVICE_U_PROSE_DIRECT_DISCOVERY_MONITORING_RADIO,
   SERVICE_U_PROSE_DIRECT_DISCOVERY_ANNOUNCING_RADIO,
   SERVICE_U_PROSE_POLICY,
   SERVICE_U_PROSE_GROUP_COUNTER,
