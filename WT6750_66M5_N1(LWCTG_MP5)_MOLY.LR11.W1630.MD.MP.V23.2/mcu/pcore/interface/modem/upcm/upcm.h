...
typedef void (*upcm_dlvr_dl_sdu_f)(kal_uint32 pdn_id, qbm_gpd* p_head, qbm_gpd* p_tail, kal_uint8 sim_idx);
#else
 ...
 */
#ifdef __MULTIPLE_PS__
void upcm_rcv_ul_sdu(ip_type_e ip_type, kal_uint32 pdn_id, qbm_gpd* p_head, qbm_gpd* p_tail, kal_uint8 sim_idx);
#else
 ...
 */
#ifdef __MULTIPLE_PS__
void upcm_rcv_ul_sdu_by_ebi(kal_uint32 ebi, qbm_gpd* p_head, qbm_gpd* p_tail, kal_uint8 sim_idx);
#else
 ...
 */
#ifdef __MULTIPLE_PS__
void upcm_query_epsb_txrx_statistics(upcm_query_epsb_statistics_struct *query_result, kal_uint8 sim_idx);
#else
 ...
 */
#ifdef __MULTIPLE_PS__
kal_uint16 upcm_get_pending_ul_data_status(kal_uint8 sim_idx);
#else
