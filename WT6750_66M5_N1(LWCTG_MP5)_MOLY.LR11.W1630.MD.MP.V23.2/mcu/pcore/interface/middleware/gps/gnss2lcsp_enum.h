 ...
 * $Log$
 *
 * 03 24 2017 wynne.chu
 * [MOLY00236804] [LPPe] Add new interfaces for LPP extensions
 * 	
 * 	.
 *
 * 03 09 2017 jie-yu.wang
 * [MOLY00233106] [Header file] MDT feature change for CMCC requirement
 * [MP5][Header file][LBS]MDTfeature
 *
 * 02 03 2016 roland.li
...
// To add more enum will cause RRLP build warning (considered as build failed)
// Need wrapped by compile option for additional enum
