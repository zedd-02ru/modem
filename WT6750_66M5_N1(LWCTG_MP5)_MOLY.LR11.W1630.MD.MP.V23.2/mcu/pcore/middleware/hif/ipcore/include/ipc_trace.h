...
BEGIN_TRACE_MAP(MOD_IPCORE)
    ...
    TRC_MSG(IPC_TR_SET_UL_THROTTLE_BEGIN, "[IPCORE] ipc_set_ul_throttle(): Set UL throttle, old_state(%d), new_conf_enabled(%d), new_conf_activate(%d), new_conf_suspend(%d), features(0x%x)")
    TRC_MSG(IPC_TR_SET_UL_THROTTLE_END, "[IPCORE] ipc_set_ul_throttle(): Set UL throttle, new_state(%d), new_conf_enabled(%d), new_conf_activate(%d), new_conf_suspend(%d), is_block_IMS(%d)")
    ...
    TRC_MSG(IPC_TR_GET_INFO_SPD_V4_IPV4_HDR_FAILED, "[IPCORE] ipc_get_packet_info_spd(): V4 get IPv4 header failed: ip_packet(0x%x), data_len(%d), packet_len(%d)")
    TRC_MSG(IPC_TR_GET_INFO_SPD_V4_UDP_HDR_FAILED, "[IPCORE] ipc_get_packet_info_spd(): V4 get UDP header failed: ip_packet(0x%x), data_len(%d), packet_len(%d)")
    TRC_MSG(IPC_TR_GET_INFO_SPD_V4_TCP_HDR_FAILED, "[IPCORE] ipc_get_packet_info_spd(): V4 get TCP header failed: ip_packet(0x%x), data_len(%d), packet_len(%d)")
    TRC_MSG(IPC_TR_GET_INFO_SPD_V4_ICMP_HDR_FAILED, "[IPCORE] ipc_get_packet_info_spd(): V4 get ICMP header failed: ip_packet(0x%x), data_len(%d), packet_len(%d)")
    TRC_MSG(IPC_TR_GET_INFO_SPD_V6_IPV6_HDR_FAILED, "[IPCORE] ipc_get_packet_info_spd(): V6 get IPv6 header failed: ip_packet(0x%x), data_len(%d), packet_len(%d)")
    TRC_MSG(IPC_TR_GET_INFO_SPD_V6_UDP_HDR_FAILED, "[IPCORE] ipc_get_packet_info_spd(): V6 get UDP header failed: ip_packet(0x%x), data_len(%d), packet_len(%d)")
    TRC_MSG(IPC_TR_GET_INFO_SPD_V6_TCP_HDR_FAILED, "[IPCORE] ipc_get_packet_info_spd(): V6 get TCP header failed: ip_packet(0x%x), data_len(%d), packet_len(%d)")
    TRC_MSG(IPC_TR_GET_INFO_SPD_V6_ICMP_HDR_FAILED, "[IPCORE] ipc_get_packet_info_spd(): V6 get ICMP header failed: ip_packet(0x%x), data_len(%d), packet_len(%d)")
    TRC_MSG(IPC_TR_GET_INFO_SPD_FIND_V6_EXT_HDR_FAILED, "[IPCORE] ipc_get_packet_info_spd(): V6 get extension header failed: ip_packet(0x%x), data_len(%d), packet_len(%d)")
    TRC_MSG(IPC_TR_DO_FILTER_INVALID_GPD, "[IPCORE] ipc_pkt_do_filter(): got an invalid GPD(0x%X)!")
    TRC_MSG(IPC_TR_DO_FILTER_ALLOC_GPD_NG, "[IPCORE] ipc_do_filter(): Allocating new GPD for the SPD filtered out packet is FAILED: uplink(%d), QBM_TYPE_NET(%d), spd(0x%x), idx(%d), payload_len(%d)")
    ...
    TRC_MSG(PFM_TR_DISPATCH_REGISTER_CMD_NULL_PARAMS, "[PFM] pfm_dispatch_register_cmd(): Invalid parameters: parameters should not be NULL!")
    ...
    TRC_MSG(PFM_TR_DEREG_FILTERS_NULL_PARAMS, "[PFM] pfm_deregister_filters(): Invalid parameters: parameters should not be NULL!")
