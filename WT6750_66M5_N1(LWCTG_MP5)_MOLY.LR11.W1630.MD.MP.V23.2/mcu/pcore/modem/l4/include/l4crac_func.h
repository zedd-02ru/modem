...
extern rat_enum l4crac_get_c2k_preferred_rat();

extern kal_bool l4crac_set_c2k_preferred_rat(rat_enum c2k_preferred_rat);
...
#ifdef __GEMINI_3G_SWITCH__
extern void l4crac_update_nvram_rat_mode(l4c_rat_enum nvram_rat_mode, rat_enum prefer_rat, sim_interface_enum sim_id); //mtk02475: for 3G switchable feature
#endif /* __GEMINI_3G_SWITCH__ */
...
/*****************************************************************************
* FUNCTION
*  l4crac_clean_nvram_ef_epsloci_epsnsc_tin_if_sim_replaced
* DESCRIPTION
*  clean nvram_ef_epsloci_epsnsc_tin whne sim replaced
*
* PARAMETERS
*
* RETURNS
...
*  none
*****************************************************************************/
void l4crac_clean_nvram_ef_epsloci_epsnsc_tin_if_sim_replaced();
