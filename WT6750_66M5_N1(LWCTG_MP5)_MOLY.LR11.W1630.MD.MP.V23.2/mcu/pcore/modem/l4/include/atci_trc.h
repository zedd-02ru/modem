...
BEGIN_TRACE_MAP(MOD_ATCI)
   ...
   TRC_MSG(FUNC_L4C_SMS_EXE_IMS_SEND_FROM_STORAGE_RRSP_ENTRY, "l4c_sms_exe_ims_send_from_storage_rrsp()")
   TRC_MSG(FUNC_L4C_SCP_CELLINFO_SEND_REQ_ENTRY, "l4c_scp_cellinfo_send_req()")
   /* fmttr*/
   ...
   TRC_MSG(FUNC_CHECK_IPV6_ADDR_VALUE16_ENTRY, "check_ipv6_addr_value16()")   
   ...
   TRC_MSG(FUNC_EXTRACT_HEX_NUMBER_ENTRY, "extract_hex_number()")
   ...
   TRC_MSG(FUNC_L4C_SAT_ECUSATS_ENTRY, "rmmi_ecusats_hdlr()")
   ...
   TRC_MSG(FUNC_RMMI_CUAD_HDLR_ENTRY, "rmmi_cuad_hdlr()")
   ...
   TRC_MSG(FUNC_RMMI_ECMSS_HDLR_ENTRY, "rmmi_ecmss_hdlr()")  
   TRC_MSG(FUNC_RMMI_ECMSSU_HDLR_ENTRY, "rmmi_ecmssu_hdlr()")
   ...
   TRC_MSG(FUNC_RMMI_EMMCHLCK_HDLR_ENTRY, "rmmi_emmchlck_hdlr()")   
   TRC_MSG(FUNC_RMMI_ECGREG_HDLR_ENTRY, "rmmi_ecgreg_hdlr()")
   TRC_MSG(FUNC_RMMI_ECEREG_HDLR_ENTRY, "rmmi_ecereg_hdlr()")
   TRC_MSG(FUNC_RMMI_ETWMODE_HDLR_ENTRY, "rmmi_etwmode_hdlr()")
   ...
   TRC_MSG(FUNC_RMMI_EGDCONT_HDLR_ENTRY, "rmmi_egdcont_hdlr()")
   TRC_MSG(FUNC_RMMI_EAPNSYNC_HDLR_ENTRY, "rmmi_eapnsync_hdlr()")
   TRC_MSG(FUNC_RMMI_ECNCFG_HDLR_ENTRY, "rmmi_ecncfg_hdlr()")
   ...
   TRC_MSG(FUNC_RMMI_ELATTPDNCC_HDLR_ENTRY, "rmmi_elattpdncc_hdlr()")
   TRC_MSG(FUNC_RMMI_EACTDELAYT_HDLR_ENTRY, "rmmi_eactdelayt_hdlr()")
   TRC_MSG(FUNC_RMMI_EPDNCTRANS_HDLR_ENTRY, "rmmi_epdnctrans_hdlr()")
   ...
   TRC_MSG(FUNC_RMMI_VZWRSRP_HDLR_ENTRY, "rmmi_vzwrsrp_hdlr()")
   TRC_MSG(FUNC_RMMI_VZWRSRQ_HDLR_ENTRY, "rmmi_vzwrsrq_hdlr()")
   TRC_MSG(FUNC_RMMI_VZWMRUC_HDLR_ENTRY, "rmmi_vzwmruc_hdlr()")
   TRC_MSG(FUNC_RMMI_VZWMRUE_HDLR_ENTRY, "rmmi_vzwmrue_hdlr()")
   
   TRC_MSG(FUNC_RMMI_MRUCLEAR_HDLR_ENTRY, "rmmi_mruclear_hdlr()")
   TRC_MSG(FUNC_RMMI_MRU_HDLR_ENTRY, "rmmi_mru_hdlr()")
   TRC_MSG(FUNC_RMMI_AUXPLMN_HDLR_ENTRY, "rmmi_auxplmn_hdlr()")
   TRC_MSG(FUNC_RMMI_PSMODE_HDLR_ENTRY, "rmmi_psmode_hdlr()")

   TRC_MSG(FUNC_RMMI_RSRP_RSRQ_HDLR_ENTRY, "rmmi_rsrp_rsrq_hdlr()")
   TRC_MSG(FUNC_RMMI_RSCP_ECNO_HDLR_ENTRY, "rmmi_rscp_ecno_hdlr()")
   TRC_MSG(FUNC_RMMI_EAPC_HDLR_ENTRY, "rmmi_eapc_hdlr()")

   TRC_MSG(FUNC_RMMI_EITMR_HDLR_ENTRY, "rmmi_eitmr_hdlr()")
   ...
   TRC_MSG(RMMI_SCP_COMMAND_ENUM, "[SCP]Receive CMD = %Mrmmi_scp_cmd_enum")
   TRC_MSG(RMMI_SCP_CELLID_AND_RSSI, "[SCP]Cellid=%d, RSSI=%d, is_cell_changed=%d")
   TRC_MSG(RMMI_SCP_DATA_SEND, "[SCP_DATA]%02X %02X %02X %02X %02X %02X %02X %02X, %02X %02X %02X %02X %02X %02X %02X %02X")
   TRC_MSG(RMMI_EIMSPS_RAT_TYPE, "eimsps_rat=%Mrat_enum, eimsps_type=%d")
   ...
   TRC_MSG(WARNING_UNEXPECTED_RAT, "Warning: unexpected RAT: %d")
