...
/* +EGPPPAUTH */
kal_bool l4ctcm_get_ppp_auth(kal_uint8 context_id, kal_uint8 *auth_type);

kal_bool l4ctcm_get_config_option_info(l4c_config_option_list_struct *info);

/* EAPNSYNC */
void l4ctcm_get_eapnsync_info(l4ctcm_query_eapnsync_struct *eapn_info);
...
void tcml4c_get_current_plmn_id(kal_uint8 *sim_plmn, kal_uint8 *nw_plmn, kal_bool is_for_4g_attach);
#endif

extern kal_bool l4ctcm_get_suggest_delay_time(kal_uint8 cid, kal_uint32 *suggest_time);
...
extern kal_bool l4ctcm_set_sib_is_retry_by_l4(kal_uint8 cid, kal_bool is_retry_by_l4);
