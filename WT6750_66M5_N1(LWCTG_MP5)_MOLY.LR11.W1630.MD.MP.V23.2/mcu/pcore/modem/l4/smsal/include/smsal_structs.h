...
#define SMSAL_VM_INALID_SIM_RECORD_NO (kal_uint16)(-1)
...
typedef struct
{
	kal_uint16     sim_index;
	kal_bool       is_sim_full;
	kal_bool       is_vm_sim_msg;
}smsal_voicemail_sms_info_struct;
#endif
...
#ifdef __TC01__
   smsal_voicemail_sms_info_struct voicemail_sms_info;
#endif
