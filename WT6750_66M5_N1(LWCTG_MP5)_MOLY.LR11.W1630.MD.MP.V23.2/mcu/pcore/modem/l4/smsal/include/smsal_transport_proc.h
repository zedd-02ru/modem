...
extern kal_bool smsal_ims_sim_data_dl_hdlr(smsal_deliver_peer_struct *deliver_ptr, peer_buff_struct *peer_buff_ptr, sms_addr_struct *sc_addr, kal_uint8 src_id, kal_uint8 deliver_type);

extern void smsal_ims_sim_data_download_cnf(kal_uint8 id, local_para_struct *local_para_ptr);
