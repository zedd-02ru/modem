...
extern void l4c_eval_lteca_band_update_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct * peer_buff_ptr);
...
extern void l4cas_apc_status_ind_hdlr(local_para_struct *local_para_ptr);
...
extern void l4c_esm_ps_switch_context_transfer_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
...
extern void l4c_esm_ps_switch_context_transfer_ind_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
...
extern void l4crac_get_ue_oplmn_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct * peer_buff_ptr);
...
extern void l4c_nw_umts_signal_quality_rind(void);
#endif
...
extern void l4crac_rsim_auth_finish_ind_hdlr(local_para_struct * local_para_ptr, peer_buff_struct * peer_buff_ptr);
#endif
