...
extern kal_bool l4c_nw_get_plmn_list_req(kal_uint8 src_id, l4c_action_enum action, user_list_type_enum type);
...
extern kal_bool l4c_nw_lteca_band_read_req (kal_uint8 src_id, kal_int8 version, kal_int8 enable);


extern kal_bool l4c_nw_lteca_band_set_ver1_req (kal_uint8 l4c_source_id_enum,
                                    kal_uint8 inter_band_num,
                                    kal_uint32 *inter_band,
                                    kal_uint32 intra_ncca_band,
                                    kal_uint32 intra_cca_band_1_32,
                                    kal_uint32 intra_cca_band_33_64);

extern kal_bool l4c_nw_lteca_band_set_ver2_req (kal_uint8 l4c_source_id_enum,
                                    kal_uint8 enable,
                                    kal_uint8 num_band, 
...
extern kal_bool l4c_nw_set_prefer_rat_req(kal_uint8 src_id, rat_enum prefer_rat, l4c_rat_enum rat_mode);
...
extern kal_bool l4c_nw_ims_scm_req(ims_scm_info_type_enum application, ims_scm_info_action_enum indication);
#endif
...
extern kal_bool l4c_nw_get_preferred_oper_list_req(custom_plmn_type_enum type);
...
extern kal_bool l4c_nw_enable_hvolte_req(l4c_source_id_enum src_id, kal_bool update_for_roaming, kal_bool enable);
...
extern kal_bool l4c_nw_emc_service_scan_req(l4c_source_id_enum src_id);
