...
#if defined(__LTE_RAT__)
extern void l4c_gprs_check_and_perform_initial_attach();
...
extern void l4c_gprs_ipv4v6_act_table_free(l4c_gprs_ipv4v6_act_struct** v4v6_act_ptr, kal_uint8 init_context_id);
...
extern kal_bool l4c_gprs_ipv4v6_pdp_activate_rej_helper(l4c_gprs_ipv4v6_act_struct** v4v6_act_ptr, l4c_ipv4v6_activator_enum user, kal_uint8 context_id, kal_uint16 cause, kal_bool* rsp_result, kal_uint16* rsp_cause, kal_uint8 src_id);
...
extern void l4c_ps_check_context_consistency(void);
