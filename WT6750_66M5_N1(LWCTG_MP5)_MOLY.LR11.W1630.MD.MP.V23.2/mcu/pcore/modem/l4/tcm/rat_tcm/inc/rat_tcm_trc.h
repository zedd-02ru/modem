...
TRC_MSG(RAT_TCM_DEACT_TRIGGERED_FLAG_INACTIVITY_TIMER_STATE, "context id [%hd].deact_triggered_flag.is_deact_by_inactivity_timer %Mkal_bool >> %Mkal_bool")
TRC_MSG(RAT_TCM_DEACT_TRIGGERED_FLAG_ALL_STATE, "cid[%hd].deact_triggered_flag => user/tft_conflict/enas/tft_valid/IA timer:%d/%d/%d/%d/%d")
...
/* TRACE_INFO */
TRC_MSG(RAT_TCM_NOT_FORWARD_IA_TIMER_EVENT, "rat_tcm_handler_for_ilm_type_deact_fail() Not forward inactivity timer triggered deact to L4C ")
TRC_MSG(RAT_TCM_TRACE_INFO_START_IRAT_QUEUE_TIMER_WITH_CID, "rat_tcm_start_irat_queue_timer(): cid:%d")
TRC_MSG(RAT_TCM_TRACE_INFO_STOP_IRAT_QUEUE_TIMER_WITH_CID,  "rat_tcm_stop_irat_queue_timer(): cid:%d")
TRC_MSG(RAT_TCM_TRACE_INFO_CHECK_IRAT_QUEUE_TIMER_IS_RUNNING, "rat_tcm_irat_queue_timer_running: CID %d Timer_Running %d")
TRC_MSG(RAT_TCM_TRACE_INFO_DETERMINE_PROCESSING_TIME_LIMIT_IN_SECS, "rat_tcm_determine_processing_time_limit_in_secs: processing_time_limit_in_secs %u -> %u")
TRC_MSG(RAT_TCM_TRACE_INFO_GET_CURRENT_TIME, "rat_tcm_time_get_current_time(): current_time_in_secs:%u")
TRC_MSG(RAT_TCM_TRACE_INFO_REMAINING_PROCESSING_TIME_LIMIT_IN_SECS, "rat_tcm_get_remaining_processing_time_limit_in_secs(): processing_time_limit_in_secs:%u")
/* TRACE_GROUP_1 */

/* TRACE_GROUP_2 */
TRC_MSG(RAT_TCM_TRACE_FUNC_IRAT_QUEUE_TIMER_TICK_EXPIRY_HANDLER, "rat_tcm_irat_queue_timer_tick_expiry_handler()")
