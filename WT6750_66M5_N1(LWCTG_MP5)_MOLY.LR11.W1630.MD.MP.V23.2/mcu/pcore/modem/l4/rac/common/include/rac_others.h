...
extern void rac_send_sat_rat_mode_ind();
...
extern void rac_send_custom_plmn_list_update(kal_bool is_update_needed, kal_uint16 no_plmn_entry, kal_uint8 *plmn_data, kal_uint8 *plmn_ver, custom_plmn_type_enum type);
#else
...
extern void rac_gmss_send_detach_req(kal_bool is_poweroff, l4c_rac_detach_cause_enum detach_cause);
#else
extern void rac_gmss_send_detach_req(kal_bool is_poweroff);
#endif
extern void rac_send_attach_req(domain_id_enum service);
#ifdef __GEMINI_WCDMA_WORLD_PHONE__
extern void rac_send_detach_req(domain_id_enum service,kal_bool is_poweroff, l4c_rac_detach_cause_enum detach_cause);
#else
...
#ifdef __SAT__
extern void rac_send_sat_location_info_ind(sat_loc_send_type_enum send_type);
...
extern kal_bool rac_is_send_dereg_cnf();
...
/*****************************************************************************
* FUNCTION
*  rac_get_active_rat_info
* DESCRIPTION
*  This function gets active rat (FDD/TDD) for EM
*
* PARAMETERS
*  em_rac_info_ind_struct *em_msg_ptr
*
* RETURNS
...
*  none
*****************************************************************************/
rac_em_active_rat_info_enum rac_get_active_rat_info();

/*****************************************************************************
* FUNCTION
*  rac_get_att_radio_service_state
* DESCRIPTION
*  This function gets att_radio_service_state for EM
*
* PARAMETERS
*  em_rac_info_ind_struct *em_msg_ptr
*
...
*  none
*****************************************************************************/
rac_em_att_service_state_enum rac_get_att_radio_service_state();

/*****************************************************************************
* FUNCTION
*  rac_get_att_nw_service_state
* DESCRIPTION
*  This function gets att_nw_service_state for EM
*
* PARAMETERS
*  em_rac_info_ind_struct *em_msg_ptr
*
...
*  none
*****************************************************************************/
rac_em_att_service_state_enum rac_get_att_nw_service_state();

#if defined(__TC01__)
/*****************************************************************************
* FUNCTION
*  rac_send_unknown_state
* DESCRIPTION
* Workaround for LGE IMS
*  Send CGREG:4(unknown) when 1x_silent_redial happens. After this call, EMM will send attach_cnf/detach_ind to update state.
*
* PARAMETERS
*  None
*
...
*  none
*****************************************************************************/
void rac_send_unknown_state();
#endif

#ifdef UNIT_TEST
/*****************************************************************************
* FUNCTION
*  rac_test_query_function
* DESCRIPTION
*  This function tests the chosen query function
*  This test stops when it gose into default as the end of testing
*  So the test case should be added in sequence
*
* PARAMETERS
*  kal_uint8 index
*
* RETURNS
*  kal_bool    KAL_TRUE   keep testing
               KAL_FALSE  test is finished
* GLOBALS AFFECTED
*  none
*****************************************************************************/
kal_bool rac_test_query_function(kal_uint8 index);
#endif
