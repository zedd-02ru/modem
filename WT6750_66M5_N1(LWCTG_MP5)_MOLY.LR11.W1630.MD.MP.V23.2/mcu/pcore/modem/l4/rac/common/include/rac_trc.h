...
TRC_MSG(RAC_TRC_rac_e_change_vdp_by_sim, "rac_e_change_vdp_by_sim")
...
TRC_MSG(RAC_CURRENT_RAT, "[RAC] Cur RAT = %Mrat_enum")
...
TRC_MSG(RAC_TRC_VOICE_DOMAIN_PREFERENCE_EUTRAN, "[RAC] VDP from AP = %Mkal_bool,Voice Domain Preference for EUTRAN = %Ml4_voice_domain_preference_enum")
...
TRC_MSG(RAC_TRC_UPDATE_NEW_ATTACH_DOMAIN, "[RAC] update attach domain by sending %s")
TRC_MSG(RAC_TRC_TO_UPDATE_LAST_ATTACH_DOMAIN, "[RAC] update last attach domain when detach = %Mkal_bool, service = %Mdomain_id_enum")
TRC_MSG(RAC_TRC_FAILURE_LIST_CURTIME, "[RAC] cur time: %d, maxlogtime: %d")
TRC_MSG(RAC_TRC_FAILURE_LIST_CURTIME2, "[RAC] cur time: %u, maxlogtime: %d")

TRC_MSG(RAC_TRC_FAILURE_LIST_PREVTIME, "[RAC] prev time[%d]: %d")
TRC_MSG(RAC_TRC_FAILURE_LIST_TIMEDIFF1, "[RAC] timediff_1: %d")
TRC_MSG(RAC_TRC_FAILURE_LIST_TIMEDIFF2, "[RAC] timediff_2: %d")

TRC_MSG(RAC_TRC_CLEAR_FAILURE_LIST, "[RAC] clear failure list[%d]: diff=%d cur=%d prev=%d")
TRC_MSG(RAC_TRC_KEEP_FAILURE_LIST, "[RAC] keep failure list[%d]: diff=%d cur=%d prev=%d")
...
TRC_MSG(RAC_NOT_START_TIMER, "[RAC] not start %Mrac_timer_id_enum ")
...
TRC_MSG(RAC_START_RAC_IMS_REG_TIMER, "[RAC] start IMS_REG_GUARD_TIMER in rac_gmss_wait_for_ims_reg_status_ind()")
TRC_MSG(RAC_CHANGE_IMS_REG_STATUS_BY_IMS_REG_TIMER, "[RAC] change to IMS_REG_STATUS_UNSPECIFIED")
...
TRC_MSG(RAC_FDD_HSPA_PREFERENCE, "[RAC] fdd_hspa_preference = %Mhspa_preference_enum")
TRC_MSG(RAC_TDD_HSPA_PREFERENCE, "[RAC] tdd_hspa_preference = %Mhspa_preference_enum")
//#endif
...
TRC_MSG(RAC_CHANGE_VDP_BY_SIM, "[RAC] Change VDP setting by sim to %d")
TRC_MSG(RAC_VDP_SRVCC_CONFIG_BY_SIM, "[RAC] VDP by sim %d, SRVCC by SIM %d")
...
TRC_MSG(RAC_TRC_UT_QUERY_FUNC, "[RAC] case %d finished")
TRC_MSG(RAC_TRC_NV_REPORTED_RAT_NONE, "[RAC] REPORTED_RAT FROM NVRAM IS NONE!")

TRC_MSG(RAC_CHECK_NOT_TO_SEND, "[RAC] Display optimization. %s skip this reg_ind")
TRC_MSG(RAC_CMD_CONFLICT_IRAT, "[RAC] Source_RAT = %Mrat_type_enum, Target_RAT = %Mrat_type_enum, is_rfoff_sent = %Mkal_bool, is_set_rat_sent = %Mkal_bool")
/*--------------------TRACE_ERROR Class--------------------*/
TRC_MSG(RAC_TRC_ERROR_ACTION_CONFLICT,"[RAC]ori: %Mrac_action_enum, new: %Mrac_action_enum")
TRC_MSG(RAC_TRC_ERROR_ABNORMAL_CSRA,"[RAC]Abnormal CSRA: %d")
TRC_MSG(RAC_TRC_ERROR_SEPARATE_DOMAIN,"[RAC]Should separate domain")
TRC_MSG(RAC_IGNORE_ABNORMAL_LESS_THEN_4_TIMES,"[RAC] RAC ignored ATTACH CNF, Abnormal less than 4 times: %Mmm_cause_enum")
