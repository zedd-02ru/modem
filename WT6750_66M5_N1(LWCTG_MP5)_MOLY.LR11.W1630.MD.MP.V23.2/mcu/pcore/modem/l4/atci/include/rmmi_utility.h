...
extern kal_uint16 check_dcs_toGsm7bit(kal_uint8 *src_text, kal_uint8 *dest_text);
...
extern void check_vzw_pdp_type_name(kal_uint8 code, kal_uint8 *str);

extern kal_uint8 check_vzw_pdp_type_code(kal_uint8 *str);
...
extern void print_hex_value_ext(kal_uint8 *val, kal_uint8 *str, kal_uint16 length);
...
extern kal_uint32 rmmi_extract_hex_number(rmmi_string_struct *source_string_ptr, rmmi_validator_cause_enum *result, kal_uint32 max);
...
extern kal_bool rmmi_is_cfunoff_command(kal_uint8 *data, kal_uint16 length);
...
extern kal_uint8 rmmi_ipv6_subnet_cidr_no_lead_comp_zero_to_dotstring(kal_uint8 *val, kal_uint8 *str, kal_bool has_subnet);
extern kal_uint8 rmmi_ipv6_subnet_cidr_comp_zero_to_dotstring(kal_uint8 *val, kal_uint8 *str, kal_bool has_subnet);
extern kal_uint8 rmmi_ipv6_subnet_cidr_no_lead_zero_to_dotstring(kal_uint8 *val, kal_uint8 *str, kal_bool has_subnet);
extern kal_uint8 rmmi_ipv6_subnet_cidr_to_dotstring(kal_uint8 *val, kal_uint8 *str);
extern kal_uint8 rmmi_ipv6_addr_to_string(kal_uint8 *val, kal_uint8 *str, kal_bool has_subnet);
extern kal_uint32 rmmi_ipv6_addr_extract_hex_number(rmmi_string_struct *source_string_ptr, 
        rmmi_ipv6_addr_validator_cause_enum *result);
extern kal_uint8 check_ipv6_addr_subnet_comp_zero_format(kal_uint8 *str, kal_uint8 *val);
extern kal_uint8 check_ipv6_addr_subnet_cidr_format(kal_uint8 *str, kal_uint8 *val);
extern kal_uint8 check_ipv6_addr_subnet_format(kal_uint8 *str, kal_uint8 *val);

extern kal_bool rmmi_ipv6_addr_mask_format_decode(kal_uint8 *str, kal_uint8 *val);
extern kal_bool rmmi_ipv6_addr_mask_format_encode(kal_uint8 *str, kal_uint8 *val);
extern kal_bool rmmi_ipv6_addr_format_encode(kal_uint8 *val, kal_uint8 *str);
extern irat_system_type_enum convert_vzwmru_rat_string_to_enum(kal_uint8 *rat_str);
extern void convert_enum_to_vzwmru_rat_string(irat_system_type_enum rat, kal_uint8 *rat_str);
