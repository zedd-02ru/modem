...
extern void l4c_nw_get_plmn_list_rrsp(l4c_result_struct result, user_list_type_enum type, kal_uint8 length, l4c_rat_plmn_info_struct *list);
...
extern void l4c_eval_lteca_band_read_ver1_rrsp(l4c_source_id_enum src_id,
        kal_bool result,
        kal_uint8 num_inter_band,
        kal_uint32 *inter_band,
        kal_uint32 intra_ncca_band,
        kal_uint32 intra_band_1_32,
        kal_uint32 intra_band_33_64);

extern void l4c_eval_lteca_band_read_ver2_rrsp(l4c_source_id_enum src_id,
        kal_bool result,
        kal_uint8 enable,
        kal_uint8 num_band,
...
extern void l4c_hspa_lce_report_rrsp(kal_uint8 src_id, kal_uint8 lce_status, kal_uint32 act_int);
extern void l4c_hspa_lce_pulldata_rrsp(kal_uint8 src_id, kal_uint8 conf_level, kal_uint8 lce_suspend, kal_uint32 last_hop_cap);
