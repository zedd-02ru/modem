...
extern void l4c_sat_estknum_ind(kal_uint8 *addr, kal_uint8 no_addr);
#endif
...
extern void l4c_nw_rat_select_rind(kal_uint32 gmss_rat, plmn_id_struct *plmn_id, kal_uint8 status, kal_uint32 curr_reported_rat, kal_bool is_home_country);
...
extern void l4c_ps_gprs_event_report_rind(kal_uint8 src_id, kal_uint8 event_id, kal_uint8 context_id, kal_uint8 parameter1, kal_uint8 parameter2, kal_uint8 *parameter3);
...
extern void l4c_ps_cgprco_rind(kal_uint8 src_id, kal_uint8 cid);
...
extern void l4c_nw_eapc_status_ind_rind(kal_uint8 result,kal_uint8 *plmn_id,kal_uint8 *lac,	kal_uint16 cell_id,kal_uint16 arfcn,kal_uint8 bsic);
...
extern void l4c_hspa_lcedata_rind(kal_uint8 conf_level, kal_uint8 lce_suspend, kal_uint32 last_hop_cap);
...
extern void l4c_nw_ims_pref_status_rind(void);
extern void l4c_nw_eimsps_rind(rat_enum rat, kal_uint8 type);
...
extern void l4c_nw_exit_ecbm_rind();
...
extern void l4c_sim_rsimauth_rind(kal_uint8 msg_id_type, kal_uint8 sim_id);
