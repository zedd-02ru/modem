...
#if (defined(__SIM_RECOVERY__) && !defined(__SIM_PLUS__))
...
#if defined(__SIM_RECOVERY_ENHANCEMENT__) && defined(__RETRY_SIM_WHEN_CARD_DETECT_FAIL__)
extern void sim_retry_sim_detect_fail_req_handler(ilm_struct *ilm_ptr, sim_context_struct *this_sim );
#endif
...
extern void sat_utk_enabled_update_req(sat_utk_enabled_update_req_struct *utk_req_ptr, sim_context_struct *this_sim);
...
extern void sat_rat_mode_ind_handler(ilm_struct *sim_ilm_ptr, sim_context_struct *this_sim);
...
extern void sim_cdma_detection(sim_context_struct *this_sim, DCL_SIM_POWER *ResultVolt_ptr, kal_bool *is_reset_error);
...
extern void sim_plug_out_call_back(kal_uint32 which_sim, kal_bool no_sim_previously);
#else
...
extern void sim_em_send_event_info(sim_context_struct *this_sim, kal_uint32 count, sim_monitor_type monitor_event);
#endif
...
extern void sim_read_nvram_vsim_profile(kal_uint8 profile_id, nvram_vsim_profile_struct *vsim_prof_buf, sim_context_struct *this_sim);

extern void sim_write_nvram_vsim_profile(kal_uint8 profile_id, nvram_vsim_profile_struct *vsim_prof_buf, sim_context_struct *this_sim);
...
extern void sim_read_nvram_vsim_config(nvram_vsim_config_struct *vsim_conf_buf, sim_context_struct *this_sim);

extern void sim_write_nvram_vsim_config(nvram_vsim_config_struct *vsim_conf_buf, sim_context_struct *this_sim);
...
extern void sim_op20_ap_simlock_req_handler(ilm_struct *sim_ilm_ptr, sim_context_struct *this_sim);
