 ...
 * 	.
 *
 * 10 18 2016 vend_mtb_aricent_05
...
#define MAX_BYTE_LTE_BAND_BITMASK_EXTENDED  (256/8)  /* Extended supported LTE bitmask size in bits / bits in one byte */
//#dif
...
extern void Scsi_SE_RetrieveC2kBandBitmask(kal_uint32 *pC2KBandBitmask);

extern void Scsi_SE_ComposeC2kBandBitmask(kal_uint32 C2KBandBitmask);
...
#ifdef __BAND_EXTENSION_SUPPORT__
extern void Scsi_SE_ComposeLteBandBitmask_extended(SCSI_SIM_INDEX sim_index, SCSI_LTE_Band_Bitmask_Extended LBandBitmask);
#endif
