...
kal_uint8 mrs_gas_get_radio_access_cap(MRS_SIM_INDEX sim_index, kal_uint8 support_band, kal_uint8 **ra_cap);
...
extern kal_uint16 rr_arfcn_PCS_band_tag(kal_uint16 arfcn);
...
#ifdef __PS_SERVICE__
extern kal_uint8 fdd_mrs_gas_get_radio_access_cap (MRS_SIM_INDEX sim_index, kal_uint8 support_band, kal_uint8 **ra_cap);
extern kal_uint8 fdd_mrs_mac_get_radio_access_cap(MRS_SIM_INDEX sim_index, kal_uint8 support_band, kal_uint8 **ra_cap, kal_bool *is_truncated, const kal_bool is_exclude_A5, const kal_uint8 bit_len_limit);
#endif /* __PS_SERVICE__ */
