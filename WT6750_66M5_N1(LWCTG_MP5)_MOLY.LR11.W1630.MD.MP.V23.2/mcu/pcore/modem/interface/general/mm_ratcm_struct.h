...
#if defined(__LTE_RAT__) && !defined (__SGLTE__)
...
typedef nwsel_mm_plmn_list_req_struct mm_ratcm_plmn_list_req_struct;
...
typedef struct {
    ...
    kal_bool is_gemini_ps_high_sem_req;
...
typedef struct {
    LOCAL_PARA_HDR
    kal_bool is_gemini_ps_high_sem_req;
} mm_ratcm_ps_session_stop_req_struct;
#endif /* __MULTIPLE_PS__ */
...
}mm_ratcm_serving_cell_signal_quality_ind_struct;
#endif
