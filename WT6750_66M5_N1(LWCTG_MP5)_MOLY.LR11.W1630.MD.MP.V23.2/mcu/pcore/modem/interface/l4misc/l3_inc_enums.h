...
typedef enum
{
    EMC_BAR_TYPE_NONE = 0,                           /*normal case */
    EMC_BAR_CALL_BAR = 1,                              /* ac-bar for emergency */
    EMC_BAR_ATTACH_NOT_SUPPORTED = 2,  /* emergency attach is not supported */
    EMC_BAR_EMB_S1_NOT_SUPPORTED = 3,  /* emergency bearer is not supported*/
    EMC_BAR_L4_SELF_REPORTED = 4               /* L4 reported current RAT in previous query*/
} emc_bar_type_enum;
...
} mm_emm_common_timer_id_enum;  // __REL10__: t3346
...
typedef enum
{
    ...
    GMSS_RAT_U_G            = 8,    /* UMTS & GSM*/
    GMSS_RAT_E_G            = 9,    /* LTE & GSM*/
    GMSS_RAT_E_U            = 10    /* LTE & UMTS*/
} gmss_rat_enum;
...
typedef enum
{
        ...
        SR_FAILURE_CAUSE_T3346_START,
        SR_FAILURE_CAUSE_T3346_STOP,
        SR_FAILURE_CAUSE_T3346_EXPIRY,   
        SR_FAILURE_CAUSE_CONN_FAIL
...
{
    GMSS_PLMN_LIST_MPSR,
    GMSS_PLMN_LIST_SUITABLE     /* List PLMNs with suitable cells */
} gmss_plmn_list_type_enum;
#endif
