...
//#endif
   ...
   SAT_RECV_DATA_EXE,
    ...
    ES3G_EXE,
    ESIMMAP_EXE, // Dynamic SIM SWITCH
   ATO_EXE,                      
...
typedef enum
{
    ...
    L4C_TIMER_ID_UPPER_THRESHOLD, //12: Power Lever Upper Threshold timer
    L4C_TIMER_ID_LOWER_THRESHOLD, //13: Power Lever Lower Threshold timer
    L4C_TIMER_ID_TXRXTIME,  // 14: txrx active time
    L4C_TIMER_ID_UMTS_SIGNAL_REPORT,   //15. UMTS cell power level indication timer
    L4C_TIMER_ID_OP01_LOCK_TIMER,//16 op01 lock to send dereg if needed
    L4C_TIMER_ID_OP01_UNLOCK_TIMER,//17 op01 unlock to send reg if needed
    L4C_TIMER_ID_MAX
} l4c_timer_id_enum;
