...
typedef struct {
    LOCAL_PARA_HDR
    vdm_voice_status_enum   call_status;
...
typedef struct
{
    ...
    kal_uint8               band;           /* only valid when emc_bar_type !=  EMC_BAR_TYPE_NONE */
} l4crac_emc_bar_network_req_struct;
...
typedef struct {
    LOCAL_PARA_HDR
    smu_pin_verify_status_enum   pin_verify_status;
} l4crac_smu_pin_verify_status_req_struct;
