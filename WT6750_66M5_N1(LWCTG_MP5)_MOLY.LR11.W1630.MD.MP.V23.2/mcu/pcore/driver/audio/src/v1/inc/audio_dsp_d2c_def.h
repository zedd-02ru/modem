...
#if defined(MT6280) || defined(MT6589) || defined(MT6572) || defined(MT6582) || defined(MT6290) || defined(MT6592) || defined(MT6571) || defined(MT6595) || defined(TK6291) || defined(MT6755) || defined(MT6797) || defined(MT6757) || defined(MT6750S)
...
#define DPRAM2_base(a)                       ((volatile uint16*)DPRAM2_CPU_base+(a))
    ...
    // OpenDsp
    #define DP_D2C_OPENDSP_UL_GET       (DP_D2C_INT_MAPPING_BASIC+SAL_DSPINT_PRIO_OD_UL_GET ) // opendsp for UL GET
    #define DP_D2C_OPENDSP_UL_PUT       (DP_D2C_INT_MAPPING_BASIC+SAL_DSPINT_PRIO_OD_UL_PUT ) // opendsp for UL PUT
    #define DP_D2C_OPENDSP_DL_GET       (DP_D2C_INT_MAPPING_BASIC+SAL_DSPINT_PRIO_OD_DL_GET ) // opendsp for DL GET
    #define DP_D2C_OPENDSP_DL_PUT       (DP_D2C_INT_MAPPING_BASIC+SAL_DSPINT_PRIO_OD_DL_PUT ) // opendsp for DL PUT
	 /*
