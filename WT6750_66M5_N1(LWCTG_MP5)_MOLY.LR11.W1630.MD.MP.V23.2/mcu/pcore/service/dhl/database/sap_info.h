...
BEGIN_SAP_INFO
	...
	SAP_INFO(RLC_REASM_SAP,MOD_RLC_FDD_2,MOD_REASM_TDD_2)
  ...
  /* ERRC ineternal module SAP INFO */
    ...
    SAP_INFO(EMM_EVALIF_TIMERIF_SAP, MOD_EMM_EVALIF, MOD_EMM_TIMERIF)
    ...
    /* ERT_WPR SAP */
    SAP_INFO(ERT_WPR_ERT_WPR_SAP, MOD_ERT_HISR, MOD_ERT_WPR)
    ...
    SAP_INFO(EL2TASK_EMAC_SAP, MOD_EL2TASK, MOD_EMAC)
    SAP_INFO(ERT_WPR_EMAC_SAP, MOD_ERT_WPR, MOD_EMAC)
    ...
    SAP_INFO(RSVAS_L4C_SAP, MOD_RSVAS, MOD_RAC)
    SAP_INFO(RSVAS_L4C_SAP, MOD_RSVAS, MOD_RAC_2)
    ...
    SAP_INFO(IMSP_IMC_SAP, MOD_IMSP_2, MOD_IMC_2)
    SAP_INFO(IMSP_IMC_SAP, MOD_IMC_2, MOD_IMSP_2)

    /* SDM */
    SAP_INFO(SDM_IMSP_SAP, MOD_SDM, MOD_IMSP)
    SAP_INFO(SDM_IMSP_SAP, MOD_IMSP, MOD_SDM)
    SAP_INFO(SDM_IMC_SAP, MOD_SDM, MOD_IMC)
    SAP_INFO(SDM_IMC_SAP, MOD_SDM, MOD_IMCSMS)
	SAP_INFO(SDM_IMSP_SAP, MOD_SDM_2, MOD_IMSP_2)
    SAP_INFO(SDM_IMSP_SAP, MOD_IMSP_2, MOD_SDM_2)
    ...
    SAP_INFO(VDM_IMSP_SAP, MOD_VDM_2, MOD_IMSP_2)
    ...
    SAP_INFO(IMSP_IMC_SAP, MOD_IMSP_2, MOD_IMCSMS_2)
    ...
    SAP_INFO(MOB_LMOB_VIR_SAP,MOD_ERRC_MOB,MOD_LMOB_VIR)
    SAP_INFO(MOB_LMOB_VIR_SAP,MOD_LMOB_VIR,MOD_ERRC_MOB)
    ...
    SAP_INFO(CLC_ERRC_SAP, MOD_CLC_MD3, MOD_ERRC_MOB)
    SAP_INFO(CLC_ERRC_SAP, MOD_ERRC_MOB, MOD_CLC_MD3)
    SAP_INFO(CLC_LMOB_SAP, MOD_CLC_MD3, MOD_LMOB)
    SAP_INFO(CLC_LMOB_SAP, MOD_LMOB, MOD_CLC_MD3)
...
//#endif
   ...
   /* Force Timer Expiry: From NIL to RRCE FDD */
   ...
   /* Manual trigger MSG_ID_TIMER_EXPIRY: Event Scheduler	*/
