...
void nvram_init_uL1_mipiEtOnCw(void)
{
   ...
   kal_mem_cpy(UMTS_MIPI_ET_ON_STATIC_CW_PCORE_ptr, ul1_rf_mipi_et_on_buffer, sizeof(ul1mipi_etOnCwData_T));
...
void nvram_init_uL1_mipiEtOffCw(void)
{
   ...
   kal_mem_cpy(UMTS_MIPI_ET_OFF_STATIC_CW_PCORE_ptr, ul1_rf_mipi_et_off_buffer, sizeof(ul1mipi_etOffCwData_T));
...
void nvram_init_uL1_mipiEtParam(void)
{
   ...
   ul1mipi_etparam_T *ul1_rf_mipi_et_param_buffer = (ul1mipi_etparam_T *)get_ctrl_buffer(sizeof(ul1mipi_etparam_T));

   error_no = nvram_external_read_data(NVRAM_EF_UL1_MIPI_ET_PARAM_LID, 1, (kal_uint8 *)ul1_rf_mipi_et_param_buffer, sizeof(ul1mipi_etparam_T));
   ASSERT(error_no == KAL_TRUE);

   kal_mem_cpy(UL1_ET_PARAM_PCORE_ptr, ul1_rf_mipi_et_param_buffer, sizeof(ul1mipi_etparam_T));
   free_ctrl_buffer(ul1_rf_mipi_et_param_buffer);
}
...
void nvram_init_uL1_etData(void)
{
   ...
   for (lid = NVRAM_EF_UL1_MIPI_ET_START; lid <= NVRAM_EF_UL1_MIPI_ET_END; lid++)
   {
       ...
       kal_mem_cpy(UMTS_MIPI_ET_PCORE_TABLE[tableIdx], ul1_rf_mipi_data_buffer, sizeof(ul1mipi_etData_T));
   }
   free_ctrl_buffer(ul1_rf_mipi_data_buffer);
...
void nvram_init_uL1_tasRf(void)
{
   ...
   kal_mem_cpy(UMTS_TAS_RF_PCORE_ptr, ul1_tas_rf_buffer, sizeof(U_sUl1dRfTasData));
...
void nvram_init_uL1_tasCustom(void)
{
   ...
   UMTS_TAS_Configuration_T *ul1_tas_custom_buffer = (UMTS_TAS_Configuration_T *)get_ctrl_buffer(sizeof(UMTS_TAS_Configuration_T));
   ...
   kal_mem_cpy(UMTS_TAS_Configuration_PCORE_ptr, ul1_tas_custom_buffer, sizeof(UMTS_TAS_Configuration_T));
...
void nvram_init_uL1_tasAntIdxByBand(void)
{
   ...
   kal_mem_cpy(UMTS_TAS_ANT_IDX_PCORE_ptr, ul1_tas_ant_idx_buffer, sizeof(UMTS_TAS_ANT_IDX_T));
...
void ul1d_update_elna_from_custom(void)
{
   kal_uint16 setIdx;
   setIdx = MML1_RF_DRDI_Dynamic_GetParamAddr_FromLocalParams(MML1_RF_3G_FDD);
   UL1D_RF_DynamicElna_Update(UMTS_ELNA_DATA_PCORE_ptr, &(ul1CustomElnaData[setIdx]));
}
#endif
 ...
 ****************************************************************************/
Ul1CustomDynamicInitMipiData *ul1d_mipiData_array_ptr;
Ul1CustomDynamicInitUmtsFeSettingData *ul1d_RfFeRoute_array_ptr;
Ul1CustomDynamicInitUmtsCalData *ul1d_rf_calData_ptr;
Ul1CustomDynamicRfParameter *ul1d_rf_parameter_ptr;
#if (IS_3G_TAS_NVRAM_SUPPORT)
Ul1CustomDynamicTasData *ul1d_rf_tasData_ptr;
#endif
#if (IS_3G_TX_POWER_OFFSET_SUPPORT)
Ul1CustomDynamicTpoData *ul1d_rf_tpoData_ptr;
#endif
...
void nvram_UL1D_DrdiPointerInit(kal_uint16 setIdx)
{
   ...
   #if (IS_3G_TAS_NVRAM_SUPPORT)
   ul1d_rf_tasData_ptr = &(ul1CustomUmtsTasData[setIdx]);
   #endif
...
/* end of chliu */
   ...
   //add by wilson for pa drift compensation
        ...
        case NVRAM_EF_UL1_MIPI_ET_LOWBAND2_LID:
            ...
            #if (IS_3G_DRDI_SUPPORT)
               if (ul1d_mipiData_array_ptr->etTable_p[index_select] != 0)
               {
                  kal_mem_cpy(buffer, ul1d_mipiData_array_ptr->etTable_p[index_select], sizeof(ul1mipi_etData_T));            
               }
            #else
               if (UMTS_MIPI_ET_TABLE_SetDefault[index_select] != 0)
               {
                  kal_mem_cpy(buffer, UMTS_MIPI_ET_TABLE_SetDefault[index_select], sizeof(ul1mipi_etData_T));
               }
            #endif
            }
            break;
        ...
        case NVRAM_EF_UL1_MIPI_ET_ON_CW_LID:
            {
            #if (IS_3G_DRDI_SUPPORT)
               kal_mem_cpy(buffer, ul1d_mipiData_array_ptr->etOnStaticCwTable_p, sizeof(ul1mipi_etOnCwData_T));
            #else
               kal_mem_cpy(buffer, UMTS_MIPI_ET_ON_STATIC_CW_SetDefault, sizeof(ul1mipi_etOnCwData_T));
            #endif
            }
            break;
        case NVRAM_EF_UL1_MIPI_ET_OFF_CW_LID:
            {
            #if (IS_3G_DRDI_SUPPORT)
               kal_mem_cpy(buffer, ul1d_mipiData_array_ptr->etOffStaticCwTable_p, sizeof(ul1mipi_etOffCwData_T));
            #else
               kal_mem_cpy(buffer, UMTS_MIPI_ET_OFF_STATIC_CW_SetDefault, sizeof(ul1mipi_etOffCwData_T));
            #endif
            }
            break;
        case NVRAM_EF_UL1_MIPI_ET_PARAM_LID:
            {
            #if (IS_3G_DRDI_SUPPORT)
               kal_mem_cpy(buffer, ul1d_mipiData_array_ptr->etParam_p, sizeof(ul1mipi_etparam_T));
            #else
               kal_mem_cpy(buffer, &UL1_ET_PARAM_SetDefault, sizeof(ul1mipi_etparam_T));
            #endif
            }
            break;
        #endif/*IS_3G_ET_NVRAM_SUPPORT*/
        ...
        case NVRAM_EF_UL1_VPA_SRC_SEL_LOWBAND2_LID:
            ...
            #if (IS_3G_DRDI_SUPPORT)
               if (ul1d_mipiData_array_ptr->vpaSrcSelTable_p[index_select] != 0)
               {
                  kal_mem_cpy(buffer, ul1d_mipiData_array_ptr->vpaSrcSelTable_p[index_select], sizeof(ul1vpa_sel_T));            
               }
            #else
        ...
        case NVRAM_EF_UL1_TAS_RF_LID:
            {
            #if (IS_3G_DRDI_SUPPORT)
               kal_mem_cpy(buffer, &ul1d_rf_tasData_ptr->TasCustomData, sizeof(U_sUl1dRfTasData));
            #else
               kal_mem_cpy(buffer, &UMTS_TAS_RF_TABLE_PCORE, sizeof(U_sUl1dRfTasData));
            #endif
            }
            break;
        ...
        case NVRAM_EF_UL1_TAS_CUSTOM_LID:
            {
            #if (IS_3G_DRDI_SUPPORT)
               kal_mem_cpy(buffer, ul1d_rf_tasData_ptr->TasConfigTable_p, sizeof(UMTS_TAS_Configuration_T));
            #else
               kal_mem_cpy(buffer, &UMTS_TAS_Configuration_Table_SetDefault, sizeof(UMTS_TAS_Configuration_T));
            #endif
            }
            break;
#endif/*IS_3G_TAS_NVRAM_SUPPORT*/
        ...
        case NVRAM_EF_UL1_TAS_ANT_IDX_TEST_SIM_LID:
            {
               kal_mem_cpy(buffer, &ul1d_rf_tasData_ptr->TasAntIdx, sizeof(UMTS_TAS_ANT_IDX_T));
            }
            break;
#endif
