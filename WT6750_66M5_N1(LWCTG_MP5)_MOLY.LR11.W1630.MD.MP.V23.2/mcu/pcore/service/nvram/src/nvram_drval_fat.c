            ...
            nvram_attr_enum attr)
{
    ...
    do
    {
		...
		result = nvram_drv_fat_read_section_cmpt(hFile, rec_index, rec_amount, rec_size, buffer, type, attr,(kal_wchar*)filename, &nvram_param);
#endif
    }while(0);
    ...
    nvram_attr_enum attr)
{
    ...
    {
        working_buffer_size = CCCI_TRANSFER_SIZE_LIMIT;
    }
