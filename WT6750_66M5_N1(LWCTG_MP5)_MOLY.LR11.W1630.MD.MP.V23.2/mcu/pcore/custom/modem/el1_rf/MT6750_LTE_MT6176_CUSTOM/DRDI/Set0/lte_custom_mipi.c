...
LTE_MIPI_EVENT_TABLE_T LTE_Band34_MIPI_RX_EVENT_Set0[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_ASM , { 0    , 6    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ASM_RX_ON0_Set0 },
   { /* 1  */ LTE_MIPI_ASM , { 7    , 18    }, LTE_MIPI_TRX_OFF   , LTE_FDD_MIPI_ASM_RX_OFF0_Set0},
   { /* 2  */ LTE_MIPI_NULL, { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                       },
};
...
LTE_MIPI_EVENT_TABLE_T LTE_Band66_MIPI_RX_EVENT_Set0[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_ASM , { 0    , 1    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ASM_RX_ON0_Set0 },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band34_MIPI_RX_DATA_Set0[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band66_MIPI_RX_DATA_Set0[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_ASM , LTE_MIPI_PORT3    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 21100 /*100 kHz*/ ,0x1C ,0x38 }, { 21325 /*100 kHz*/ ,0x1C ,0x38 }, { 21550 /*100 kHz*/ ,0x1C ,0x38 }, { 21775 /*100 kHz*/ ,0x1C ,0x38 }, { 22000 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 1  */ LTE_MIPI_ASM , LTE_MIPI_PORT3    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 21100 /*100 kHz*/ ,0x00 ,0x01 }, { 21325 /*100 kHz*/ ,0x00 ,0x01 }, { 21550 /*100 kHz*/ ,0x00 ,0x01 }, { 21775 /*100 kHz*/ ,0x00 ,0x01 }, { 22000 /*100 kHz*/ ,0x00 ,0x01 },} },
   { /* 2  */ LTE_MIPI_ASM , LTE_MIPI_PORT3    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 21100 /*100 kHz*/ ,0x1C ,0x38 }, { 21325 /*100 kHz*/ ,0x1C ,0x38 }, { 21550 /*100 kHz*/ ,0x1C ,0x38 }, { 21775 /*100 kHz*/ ,0x1C ,0x38 }, { 22000 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 3  */ LTE_MIPI_ASM , LTE_MIPI_PORT3    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 21100 /*100 kHz*/ ,0x00 ,0x02 }, { 21325 /*100 kHz*/ ,0x00 ,0x02 }, { 21550 /*100 kHz*/ ,0x00 ,0x02 }, { 21775 /*100 kHz*/ ,0x00 ,0x02 }, { 22000 /*100 kHz*/ ,0x00 ,0x02 },} },
   { /* 4  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_EVENT_TABLE_T LTE_Band34_MIPI_TX_EVENT_Set0[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_ASM  , { 0    , 11    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_PA_TX_ON0_Set0  }, //PA On
   { /* 1  */ LTE_MIPI_ASM  , { 12    , 12    }, LTE_MIPI_TRX_OFF   , LTE_TDD_MIPI_PA_TX_OFF0_Set0 }, //PA Off
   { /* 2  */ LTE_MIPI_NULL, { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                       },
};
...
LTE_MIPI_EVENT_TABLE_T LTE_Band66_MIPI_TX_EVENT_Set0[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_PA  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_PA_TX_ON0_Set0  }, //PA On
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band34_MIPI_TX_DATA_Set0[] =
{
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band66_MIPI_TX_DATA_Set0[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 17100 /*100 kHz*/ ,0x1C ,0x38 }, { 17275 /*100 kHz*/ ,0x1C ,0x38 }, { 17450 /*100 kHz*/ ,0x1C ,0x38 }, { 17625 /*100 kHz*/ ,0x1C ,0x38 }, { 17800 /*100 kHz*/ ,0x1C ,0x38},} }, // PA On PM_Trig: normal mode
   { /* 1  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 17100 /*100 kHz*/ ,0x00 ,0x08 }, { 17275 /*100 kHz*/ ,0x00 ,0x08 }, { 17450 /*100 kHz*/ ,0x00 ,0x08 }, { 17625 /*100 kHz*/ ,0x00 ,0x08 }, { 17800 /*100 kHz*/ ,0x00 ,0x08},} }, // PA path sel
   { /* 2  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 17100 /*100 kHz*/ ,0x01 ,0x1F }, { 17275 /*100 kHz*/ ,0x01 ,0x1F }, { 17450 /*100 kHz*/ ,0x01 ,0x1F }, { 17625 /*100 kHz*/ ,0x01 ,0x1F }, { 17800 /*100 kHz*/ ,0x01 ,0x1F},} }, // PA enable
   { /* 3  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 17100 /*100 kHz*/ ,0x02 ,0x00 }, { 17275 /*100 kHz*/ ,0x02 ,0x00 }, { 17450 /*100 kHz*/ ,0x02 ,0x00 }, { 17625 /*100 kHz*/ ,0x02 ,0x00 }, { 17800 /*100 kHz*/ ,0x02 ,0x00},} }, // Iref
   { /* 4  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 17100 /*100 kHz*/ ,0x03 ,0x00 }, { 17275 /*100 kHz*/ ,0x03 ,0x00 }, { 17450 /*100 kHz*/ ,0x03 ,0x00 }, { 17625 /*100 kHz*/ ,0x03 ,0x00 }, { 17800 /*100 kHz*/ ,0x03 ,0x00},} }, // Iref
   { /* 5  */ LTE_MIPI_PA  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_PA0    ,{ { 17100 /*100 kHz*/ ,0x01 ,0x00 }, { 17275 /*100 kHz*/ ,0x01 ,0x00 }, { 17450 /*100 kHz*/ ,0x01 ,0x00 }, { 17625 /*100 kHz*/ ,0x01 ,0x00 }, { 17800 /*100 kHz*/ ,0x01 ,0x00},} }, // PA disable
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT3    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 17100 /*100 kHz*/ ,0x1C ,0x38 }, { 17275 /*100 kHz*/ ,0x1C ,0x38 }, { 17450 /*100 kHz*/ ,0x1C ,0x38 }, { 17625 /*100 kHz*/ ,0x1C ,0x38 }, { 17800 /*100 kHz*/ ,0x1C ,0x38},} }, // ASM PM_Trig: normal mode
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT3    , LTE_REG_W     , MIPI_USID_ASM0   ,{ { 17100 /*100 kHz*/ ,0x00 ,0x01 }, { 17275 /*100 kHz*/ ,0x00 ,0x01 }, { 17450 /*100 kHz*/ ,0x00 ,0x01 }, { 17625 /*100 kHz*/ ,0x00 ,0x01 }, { 17800 /*100 kHz*/ ,0x00 ,0x01},} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_EVENT_TABLE_T LTE_Band34_MIPI_TPC_EVENT_Set0[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset    */
   /*                        { start, stop },                      ( us )        */
...
LTE_MIPI_EVENT_TABLE_T LTE_Band66_MIPI_TPC_EVENT_Set0[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset    */
   /*                        { start, stop },                      ( us )        */
   { /* 0  */ LTE_MIPI_PA  , { 0    , 2    }, LTE_MIPI_TPC_SET   , US2OFFCNT(7.5)  },
...
LTE_MIPI_DATA_TABLE_T LTE_Band34_MIPI_TPC_DATA_Set0[] =
{
   //No.     elm type       , port_sel         , data_seq    , USID                         , address                      , data
   {/* 0  */ LTE_MIPI_PA_SEC, LTE_MIPI_PORT0   , LTE_REG_W   , LTE_MIPI_PA_SECTION_USID     , LTE_MIPI_PA_SECTION_ADDRESS  , LTE_MIPI_PA_SECTION_DATA0}, // PA On Band Select
   {/* 1  */ LTE_MIPI_PA_SEC, LTE_MIPI_PORT0   , LTE_REG_W   , LTE_MIPI_PA_SECTION_USID     , LTE_MIPI_PA_SECTION_ADDRESS  , LTE_MIPI_PA_SECTION_DATA1}, // Data ref. by PA Section table idx 0
...
LTE_MIPI_DATA_TABLE_T LTE_Band66_MIPI_TPC_DATA_Set0[] =
{
   //No.     elm type       , port_sel         , data_seq    , USID                         , address                      , data
   {/* 0  */ LTE_MIPI_PA_SEC, LTE_MIPI_PORT0   , LTE_REG_W   , LTE_MIPI_PA_SECTION_USID     , LTE_MIPI_PA_SECTION_ADDRESS  , LTE_MIPI_PA_SECTION_DATA0}, // PA On Band Select
   {/* 1  */ LTE_MIPI_PA_SEC, LTE_MIPI_PORT0   , LTE_REG_W   , LTE_MIPI_PA_SECTION_USID     , LTE_MIPI_PA_SECTION_ADDRESS  , LTE_MIPI_PA_SECTION_DATA1}, // Data ref. by PA Section table idx 0
...
LTE_MIPI_TPC_SECTION_TABLE_T LTE_Band34_MIPI_PA_SECTION_DATA_Set0[] =
{
   {
      20100, /*100kHz*/
...
LTE_MIPI_TPC_SECTION_TABLE_T LTE_Band66_MIPI_PA_SECTION_DATA_Set0[] =
{
   {
      17100, /*100kHz*/
      MIPI_USID_PA0, /*USID*/
