...
LTE_MIPI_EVENT_TABLE_T LTE_Band34_MIPI_ANTRX_EVENT_Set0[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
...
LTE_MIPI_EVENT_TABLE_T LTE_Band66_MIPI_ANTRX_EVENT_Set0[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_Set0  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band34_MIPI_ANTTX_EVENT_Set0[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
...
LTE_MIPI_EVENT_TABLE_T LTE_Band66_MIPI_ANTTX_EVENT_Set0[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_Set0  },  
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band34_MIPI_ANTRX_DATA_Set0[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band66_MIPI_ANTRX_DATA_Set0[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band34_MIPI_ANTTX_DATA_Set0[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band66_MIPI_ANTTX_DATA_Set0[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
