...
//ANT RX
LTE_MIPI_EVENT_TABLE_T LTE_BandNone_MIPI_ANTRX_EVENT_SetDefault[] =
{
...
LTE_MIPI_EVENT_TABLE_T LTE_Band1_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  },  
   //{ /* 1  */ LTE_MIPI_ANT  , { 5    , 7    }, LTE_MIPI_TRX_OFF   , LTE_FDD_MIPI_ANT_RX_OFF0_SetDefault },  
   { /* 2  */ LTE_MIPI_NULL , { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                                  },
};

LTE_MIPI_EVENT_TABLE_T LTE_Band2_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band3_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band4_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band5_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band7_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  },  
   //{ /* 1  */ LTE_MIPI_ANT  , { 4    , 5    }, LTE_MIPI_TRX_OFF   , LTE_FDD_MIPI_ANT_RX_OFF0_SetDefault },  
   { /* 2  */ LTE_MIPI_NULL , { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                                  },
};

LTE_MIPI_EVENT_TABLE_T LTE_Band8_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band12_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band13_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band17_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band20_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band26_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band28_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band29_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band30_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band34_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 2    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_RX_ON0_Set1  },  
   //{ /* 1  */ LTE_MIPI_ANT  , { 3    , 5    }, LTE_MIPI_TRX_OFF   , LTE_TDD_MIPI_ANT_RX_OFF0_Set1 },  
   { /* 2  */ LTE_MIPI_NULL , { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                                  },
};

LTE_MIPI_EVENT_TABLE_T LTE_Band38_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 2    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_RX_ON0_SetDefault  },  
   //{ /* 1  */ LTE_MIPI_ANT  , { 3    , 5    }, LTE_MIPI_TRX_OFF   , LTE_TDD_MIPI_ANT_RX_OFF0_SetDefault },  
   { /* 2  */ LTE_MIPI_NULL , { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                                  },
};

LTE_MIPI_EVENT_TABLE_T LTE_Band39_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 2    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_RX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band40_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 2    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_RX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band41_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 2    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_RX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band66_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  },  
...
//ANT TX
LTE_MIPI_EVENT_TABLE_T LTE_BandNone_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_NULL, { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                       },
...
LTE_MIPI_EVENT_TABLE_T LTE_Band1_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  },  
   //{ /* 1  */ LTE_MIPI_ANT  , { 5    , 7    }, LTE_MIPI_TRX_OFF   , LTE_FDD_MIPI_ANT_TX_OFF0_SetDefault },  
   { /* 3  */ LTE_MIPI_NULL , { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                                  },
};

LTE_MIPI_EVENT_TABLE_T LTE_Band2_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band3_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band4_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band5_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band7_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  },  
   //{ /* 1  */ LTE_MIPI_ANT  , { 4    , 5    }, LTE_MIPI_TRX_OFF   , LTE_FDD_MIPI_ANT_TX_OFF0_SetDefault },  
   { /* 3  */ LTE_MIPI_NULL , { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                                  },
};

LTE_MIPI_EVENT_TABLE_T LTE_Band8_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band12_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band13_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band17_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band20_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band26_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band28_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band30_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band34_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 2    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_TX_ON0_Set1  },  
   //{ /* 1  */ LTE_MIPI_ANT  , { 3    , 5    }, LTE_MIPI_TRX_OFF   , LTE_TDD_MIPI_ANT_TX_OFF0_Set1 },  
   { /* 3  */ LTE_MIPI_NULL , { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                                  },
};

LTE_MIPI_EVENT_TABLE_T LTE_Band38_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_TX_ON0_SetDefault  },  
   //{ /* 1  */ LTE_MIPI_ANT  , { 4    , 5    }, LTE_MIPI_TRX_OFF   , LTE_TDD_MIPI_ANT_TX_OFF0_SetDefault },  
   { /* 2  */ LTE_MIPI_NULL, { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                                  },
};
LTE_MIPI_EVENT_TABLE_T LTE_Band39_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_TX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band40_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_TX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band41_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ANT_TX_ON0_SetDefault  },  
...
LTE_MIPI_EVENT_TABLE_T LTE_Band66_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   //{ /* 0  */ LTE_MIPI_ANT  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  },  
...
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
kal_uint32  LTE_MIPI_ANTRX_EVENT_SIZE_TABLE_SetDefault[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
...
LTE_MIPI_EVENT_TABLE_T*  LTE_MIPI_ANTRX_EVENT_TABLE_SetDefault[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
...
kal_uint32  LTE_MIPI_ANTTX_EVENT_SIZE_TABLE_SetDefault[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
...
LTE_MIPI_EVENT_TABLE_T*  LTE_MIPI_ANTTX_EVENT_TABLE_SetDefault[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_BandNone_MIPI_ANTRX_DATA_SetDefault[] =
{
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band1_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band2_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band3_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band4_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band5_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band7_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band8_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band12_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band13_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band17_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band20_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band26_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band28_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band29_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band30_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band34_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band38_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band39_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   //{ /* 0  */ LTE_MIPI_ANT , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_ANT0   ,{ { 18800 /*100 kHz*/ ,0x1C ,0x38 }, { 18900 /*100 kHz*/ ,0x1C ,0x38 }, { 19000 /*100 kHz*/ ,0x1C ,0x38 }, { 19100 /*100 kHz*/ ,0x1C ,0x38 }, { 19200 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band40_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band41_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band66_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   //{ /* 0  */ LTE_MIPI_ANT , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_ANT0   ,{ { 21100 /*100 kHz*/ ,0x1C ,0x38 }, { 21325 /*100 kHz*/ ,0x1C ,0x38 }, { 21550 /*100 kHz*/ ,0x1C ,0x38 }, { 21775 /*100 kHz*/ ,0x1C ,0x38 }, { 22000 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};


//ANT TX start
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_BandNone_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    , 0   }, {     0 /*100 kHz*/ ,0    , 0   }, {     0 /*100 kHz*/ ,0    , 0   }, {     0 /*100 kHz*/ ,0    , 0   }, {     0 /*100 kHz*/ ,0    , 0   },} },
};

LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band1_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band2_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band3_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band4_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band5_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band6_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band7_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band8_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band12_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band13_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band17_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band20_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band26_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band28_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band30_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band34_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band38_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band39_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   //{ /* 0  */ LTE_MIPI_ANT  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ANT0    ,{ { 18800 /*100 kHz*/ ,0x1C ,0x38 }, { 18900 /*100 kHz*/ ,0x1C ,0x38 }, { 19000 /*100 kHz*/ ,0x1C ,0x38 }, { 19100 /*100 kHz*/ ,0x1C ,0x38 }, { 19200 /*100 kHz*/ ,0x1C ,0x38 },} },  
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band40_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band41_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band66_MIPI_ANTTX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   //{ /* 0  */ LTE_MIPI_ANT  , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ANT0    ,{ { 17100 /*100 kHz*/ ,0x1C ,0x38 }, { 17275 /*100 kHz*/ ,0x1C ,0x38 }, { 17450 /*100 kHz*/ ,0x1C ,0x38 }, { 17625 /*100 kHz*/ ,0x1C ,0x38 }, { 17800 /*100 kHz*/ ,0x1C ,0x38},} },  
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};

//ANT RX
kal_uint32  LTE_MIPI_ANTRX_DATA_SIZE_TABLE_SetDefault[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
...
LTE_MIPI_DATA_SUBBAND_TABLE_T*  LTE_MIPI_ANTRX_DATA_TABLE_SetDefault[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
...
//ANT TX
kal_uint32  LTE_MIPI_ANTTX_DATA_SIZE_TABLE_SetDefault[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
...
LTE_MIPI_DATA_SUBBAND_TABLE_T*  LTE_MIPI_ANTTX_DATA_TABLE_SetDefault[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
