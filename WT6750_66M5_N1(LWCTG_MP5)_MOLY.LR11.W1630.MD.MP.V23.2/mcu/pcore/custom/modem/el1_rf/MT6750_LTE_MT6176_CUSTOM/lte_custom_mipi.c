...
LTE_MIPI_IMM_DATA_TABLE_T LTE_MIPI_INITIAL_CW_SetDefault[LTE_MIPI_INITIAL_CW_SIZE_SetDefault] =
{
...
LTE_MIPI_IMM_DATA_TABLE_T LTE_MIPI_SLEEP_CW_SetDefault[LTE_MIPI_SLEEP_CW_SIZE_SetDefault] =
{
   // elm type   , port_sel      , data_seq ,    USID          , addr , data  , wait_time(us)
...
LTE_MIPI_EVENT_TABLE_T LTE_Band34_MIPI_RX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_ASM , { 0    , 6    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ASM_RX_ON0_SetDefault },
   { /* 1  */ LTE_MIPI_ASM , { 7    , 18    }, LTE_MIPI_TRX_OFF   , LTE_FDD_MIPI_ASM_RX_OFF0_SetDefault},
   { /* 2  */ LTE_MIPI_NULL, { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                       },
};
...
LTE_MIPI_EVENT_TABLE_T LTE_Band38_MIPI_RX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_PA  , { 0    , 3    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_PA_TX_ON0_SetDefault  }, //
   { /* 1  */ LTE_MIPI_PA  , { 4    , 7    }, LTE_MIPI_TRX_OFF   , LTE_TDD_MIPI_PA_TX_OFF0_SetDefault }, //3P4T Off
   { /* 2  */ LTE_MIPI_NULL, { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                       },
};
...
kal_uint32 LTE_MIPI_RX_EVENT_SIZE_TABLE_SetDefault[] =
{
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR0,     SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR1,     SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR2,     SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR3,     SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR4,     SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR5,     SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR6,     SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR7,     SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR8,     SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR9,     SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR10,    SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR11,    SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR12,    SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR13,    SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR14,    SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR15,    SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR16,    SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR17,    SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR18,    SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR19,    SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT(      BAND_INDICATOR20,    SetDefault)),
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND21, SetDefault)),     /*Index 0*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND22, SetDefault)),     /*Index 1*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND23, SetDefault)),     /*Index 2*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND24, SetDefault)),     /*Index 3*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND25, SetDefault)),     /*Index 4*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND26, SetDefault)),     /*Index 5*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND27, SetDefault)),     /*Index 6*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND28, SetDefault)),     /*Index 7*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND29, SetDefault)),     /*Index 8*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND30, SetDefault)),     /*Index 9*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND31, SetDefault)),     /*Index10*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND32, SetDefault)),     /*Index11*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND33, SetDefault)),     /*Index12*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND34, SetDefault)),     /*Index13*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND35, SetDefault)),     /*Index14*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND36, SetDefault)),     /*Index15*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND37, SetDefault)),     /*Index16*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND38, SetDefault)),     /*Index17*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND39, SetDefault)),     /*Index18*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND40, SetDefault)),     /*Index19*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND41, SetDefault)),     /*Index20*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND42, SetDefault)),     /*Index21*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND43, SetDefault)),     /*Index22*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND44, SetDefault)),     /*Index23*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND45, SetDefault)),     /*Index24*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND46, SetDefault)),     /*Index25*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND47, SetDefault)),     /*Index26*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND48, SetDefault)),     /*Index27*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND49, SetDefault)),     /*Index28*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND50, SetDefault)),     /*Index29*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND51, SetDefault)),     /*Index30*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND52, SetDefault)),     /*Index31*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND53, SetDefault)),     /*Index32*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND54, SetDefault)),     /*Index33*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND55, SetDefault)),     /*Index34*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND56, SetDefault)),     /*Index35*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND57, SetDefault)),     /*Index36*/
   sizeof(LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND58, SetDefault)),     /*Index37*/
};

LTE_MIPI_EVENT_TABLE_T*  LTE_MIPI_RX_EVENT_TABLE_SetDefault[LTE_MAX_SUPPORT_FE_ROUTE_NUM] =
{
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR0,     SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR1,     SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR2,     SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR3,     SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR4,     SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR5,     SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR6,     SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR7,     SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR8,     SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR9,     SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR10,    SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR11,    SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR12,    SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR13,    SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR14,    SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR15,    SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR16,    SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR17,    SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR18,    SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR19,    SetDefault),
   LTE_MIPI_RX_EVENT(      BAND_INDICATOR20,    SetDefault),
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND21, SetDefault),     /*Index 0*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND22, SetDefault),     /*Index 1*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND23, SetDefault),     /*Index 2*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND24, SetDefault),     /*Index 3*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND25, SetDefault),     /*Index 4*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND26, SetDefault),     /*Index 5*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND27, SetDefault),     /*Index 6*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND28, SetDefault),     /*Index 7*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND29, SetDefault),     /*Index 8*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND30, SetDefault),     /*Index 9*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND31, SetDefault),     /*Index10*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND32, SetDefault),     /*Index11*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND33, SetDefault),     /*Index12*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND34, SetDefault),     /*Index13*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND35, SetDefault),     /*Index14*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND36, SetDefault),     /*Index15*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND37, SetDefault),     /*Index16*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND38, SetDefault),     /*Index17*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND39, SetDefault),     /*Index18*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND40, SetDefault),     /*Index19*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND41, SetDefault),     /*Index20*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND42, SetDefault),     /*Index21*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND43, SetDefault),     /*Index22*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND44, SetDefault),     /*Index23*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND45, SetDefault),     /*Index24*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND46, SetDefault),     /*Index25*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND47, SetDefault),     /*Index26*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND48, SetDefault),     /*Index27*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND49, SetDefault),     /*Index28*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND50, SetDefault),     /*Index29*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND51, SetDefault),     /*Index30*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND52, SetDefault),     /*Index31*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND53, SetDefault),     /*Index32*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND54, SetDefault),     /*Index33*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND55, SetDefault),     /*Index34*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND56, SetDefault),     /*Index35*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND57, SetDefault),     /*Index36*/
   LTE_MIPI_RX_EVENT_ROUTE(MIPI_RX_ROUTE_IND58, SetDefault),     /*Index37*/
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band2_MIPI_RX_DATA_SetDefault[] =
{
   ...
   { /* 2  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 19300 /*100 kHz*/ ,0x1C ,0x38 }, { 19450 /*100 kHz*/ ,0x1C ,0x38 }, { 19600 /*100 kHz*/ ,0x1C ,0x38 }, { 19750 /*100 kHz*/ ,0x1C ,0x38 }, { 19900 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 3  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 19300 /*100 kHz*/ ,0x01 ,0x04 }, { 19450 /*100 kHz*/ ,0x01 ,0x04 }, { 19600 /*100 kHz*/ ,0x01 ,0x04 }, { 19750 /*100 kHz*/ ,0x01 ,0x04 }, { 19900 /*100 kHz*/ ,0x01 ,0x04 },} },
   ...
   { /* 5  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 19300 /*100 kHz*/ ,0x05 ,0x00 }, { 19450 /*100 kHz*/ ,0x05 ,0x00 }, { 19600 /*100 kHz*/ ,0x05 ,0x00 }, { 19750 /*100 kHz*/ ,0x05 ,0x00 }, { 19900 /*100 kHz*/ ,0x05 ,0x00 },} },
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 19300 /*100 kHz*/ ,0x1C ,0x38 }, { 19450 /*100 kHz*/ ,0x1C ,0x38 }, { 19600 /*100 kHz*/ ,0x1C ,0x38 }, { 19750 /*100 kHz*/ ,0x1C ,0x38 }, { 19900 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 19300 /*100 kHz*/ ,0x01 ,0x00 }, { 19450 /*100 kHz*/ ,0x01 ,0x00 }, { 19600 /*100 kHz*/ ,0x01 ,0x00 }, { 19750 /*100 kHz*/ ,0x01 ,0x00 }, { 19900 /*100 kHz*/ ,0x01 ,0x00 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ { 0     /*100 kHz*/ ,0    ,0    }, { 0     /*100 kHz*/ ,0    ,0    }, { 0     /*100 kHz*/ ,0    ,0    }, { 0     /*100 kHz*/ ,0    ,0    }, { 0     /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band3_MIPI_RX_DATA_SetDefault[] =
{
   ...
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 18050 /*100 kHz*/ ,0x01 ,0x00 }, { 18238 /*100 kHz*/ ,0x01 ,0x00 }, { 18425 /*100 kHz*/ ,0x01 ,0x00 }, { 18612 /*100 kHz*/ ,0x01 ,0x00 }, { 18800 /*100 kHz*/ ,0x01 ,0x00 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ { 0     /*100 kHz*/ ,0    ,0    }, { 0     /*100 kHz*/ ,0    ,0    }, { 0     /*100 kHz*/ ,0    ,0    }, { 0     /*100 kHz*/ ,0    ,0    }, { 0     /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band4_MIPI_RX_DATA_SetDefault[] =
{
   ...
   { /* 2  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 21100 /*100 kHz*/ ,0x1C ,0x38 }, { 21212 /*100 kHz*/ ,0x1C ,0x38 }, { 21325 /*100 kHz*/ ,0x1C ,0x38 }, { 21437 /*100 kHz*/ ,0x1C ,0x38 }, { 21550 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 3  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 21100 /*100 kHz*/ ,0x01 ,0x04 }, { 21212 /*100 kHz*/ ,0x01 ,0x04 }, { 21325 /*100 kHz*/ ,0x01 ,0x04 }, { 21437 /*100 kHz*/ ,0x01 ,0x04 }, { 21550 /*100 kHz*/ ,0x01 ,0x04 },} },
   ...
   { /* 5  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 21100 /*100 kHz*/ ,0x05 ,0x00 }, { 21212 /*100 kHz*/ ,0x05 ,0x00 }, { 21325 /*100 kHz*/ ,0x05 ,0x00 }, { 21437 /*100 kHz*/ ,0x05 ,0x00 }, { 21550 /*100 kHz*/ ,0x05 ,0x00 },} },
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 21100 /*100 kHz*/ ,0x1C ,0x38 }, { 21212 /*100 kHz*/ ,0x1C ,0x38 }, { 21325 /*100 kHz*/ ,0x1C ,0x38 }, { 21437 /*100 kHz*/ ,0x1C ,0x38 }, { 21550 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 21100 /*100 kHz*/ ,0x01 ,0x00 }, { 21212 /*100 kHz*/ ,0x01 ,0x00 }, { 21325 /*100 kHz*/ ,0x01 ,0x00 }, { 21437 /*100 kHz*/ ,0x01 ,0x00 }, { 21550 /*100 kHz*/ ,0x01 ,0x00 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band5_MIPI_RX_DATA_SetDefault[] =
{
   ...
   { /* 2  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  8690 /*100 kHz*/ ,0x1C ,0x38 }, {  8753 /*100 kHz*/ ,0x1C ,0x38 }, {  8816 /*100 kHz*/ ,0x1C ,0x38 }, {  8879 /*100 kHz*/ ,0x1C ,0x38 }, {  8940 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 3  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  8690 /*100 kHz*/ ,0x00 ,0x04 }, {  8753 /*100 kHz*/ ,0x00 ,0x04 }, {  8816 /*100 kHz*/ ,0x00 ,0x04 }, {  8879 /*100 kHz*/ ,0x00 ,0x04 }, {  8940 /*100 kHz*/ ,0x00 ,0x04 },} },
   ...
   { /* 5  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ {  8690 /*100 kHz*/ ,0x02 ,0x00 }, {  8753 /*100 kHz*/ ,0x02 ,0x00 }, {  8816 /*100 kHz*/ ,0x02 ,0x00 }, {  8879 /*100 kHz*/ ,0x02 ,0x00 }, {  8940 /*100 kHz*/ ,0x02 ,0x00 },} },
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  8690 /*100 kHz*/ ,0x1C ,0x38 }, {  8753 /*100 kHz*/ ,0x1C ,0x38 }, {  8816 /*100 kHz*/ ,0x1C ,0x38 }, {  8879 /*100 kHz*/ ,0x1C ,0x38 }, {  8940 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  8690 /*100 kHz*/ ,0x00 ,0x00 }, {  8753 /*100 kHz*/ ,0x00 ,0x00 }, {  8816 /*100 kHz*/ ,0x00 ,0x00 }, {  8879 /*100 kHz*/ ,0x00 ,0x00 }, {  8940 /*100 kHz*/ ,0x00 ,0x00 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band7_MIPI_RX_DATA_SetDefault[] =
{
   ...
   { /* 3  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 26200 /*100 kHz*/ ,0x03 , 0x00}, { 26375 /*100 kHz*/ ,0x03 , 0x00}, { 26550 /*100 kHz*/ ,0x03 , 0x00}, { 26725 /*100 kHz*/ ,0x03 , 0x00}, { 26900 /*100 kHz*/ ,0x03 , 0x00},} }, 
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band8_MIPI_RX_DATA_SetDefault[] =
{
   ...
   { /* 2  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  9250 /*100 kHz*/ ,0x1C ,0x38 }, {  9337 /*100 kHz*/ ,0x1C ,0x38 }, {  9425 /*100 kHz*/ ,0x1C ,0x38 }, {  9512 /*100 kHz*/ ,0x1C ,0x38 }, {  9600 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 3  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  9250 /*100 kHz*/ ,0x00 ,0x03 }, {  9337 /*100 kHz*/ ,0x00 ,0x03 }, {  9425 /*100 kHz*/ ,0x00 ,0x03 }, {  9512 /*100 kHz*/ ,0x00 ,0x03 }, {  9600 /*100 kHz*/ ,0x00 ,0x03 },} },
   ...
   { /* 5  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ {  9250 /*100 kHz*/ ,0x02 ,0x00 }, {  9337 /*100 kHz*/ ,0x02 ,0x00 }, {  9425 /*100 kHz*/ ,0x02 ,0x00 }, {  9512 /*100 kHz*/ ,0x02 ,0x00 }, {  9600 /*100 kHz*/ ,0x02 ,0x00 },} },
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  9250 /*100 kHz*/ ,0x1C ,0x38 }, {  9337 /*100 kHz*/ ,0x1C ,0x38 }, {  9425 /*100 kHz*/ ,0x1C ,0x38 }, {  9512 /*100 kHz*/ ,0x1C ,0x38 }, {  9600 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  9250 /*100 kHz*/ ,0x00 ,0x00 }, {  9337 /*100 kHz*/ ,0x00 ,0x00 }, {  9425 /*100 kHz*/ ,0x00 ,0x00 }, {  9512 /*100 kHz*/ ,0x00 ,0x00 }, {  9600 /*100 kHz*/ ,0x00 ,0x00 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band12_MIPI_RX_DATA_SetDefault[] =
{
   ...
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  7290 /*100 kHz*/ ,0x1C ,0x38 }, {  7332 /*100 kHz*/ ,0x1C ,0x38 }, {  7375 /*100 kHz*/ ,0x1C ,0x38 }, {  7417 /*100 kHz*/ ,0x1C ,0x38 }, {  7460 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  7290 /*100 kHz*/ ,0x00 ,0x00 }, {  7332 /*100 kHz*/ ,0x00 ,0x00 }, {  7375 /*100 kHz*/ ,0x00 ,0x00 }, {  7417 /*100 kHz*/ ,0x00 ,0x00 }, {  7460 /*100 kHz*/ ,0x00 ,0x00 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band20_MIPI_RX_DATA_SetDefault[] =
{
   ...
   { /* 2  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  7910 /*100 kHz*/ ,0x1C ,0x38 }, {  7985 /*100 kHz*/ ,0x1C ,0x38 }, {  8060 /*100 kHz*/ ,0x1C ,0x38 }, {  8135 /*100 kHz*/ ,0x1C ,0x38 }, {  8210 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 3  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  7910 /*100 kHz*/ ,0x00 ,0x02 }, {  7985 /*100 kHz*/ ,0x00 ,0x02 }, {  8060 /*100 kHz*/ ,0x00 ,0x02 }, {  8135 /*100 kHz*/ ,0x00 ,0x02 }, {  8210 /*100 kHz*/ ,0x00 ,0x02 },} },
   ...
   { /* 5  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ {  7910 /*100 kHz*/ ,0x02 ,0x00 }, {  7985 /*100 kHz*/ ,0x02 ,0x00 }, {  8060 /*100 kHz*/ ,0x02 ,0x00 }, {  8135 /*100 kHz*/ ,0x02 ,0x00 }, {  8210 /*100 kHz*/ ,0x02 ,0x00 },} },
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  7910 /*100 kHz*/ ,0x1C ,0x38 }, {  7985 /*100 kHz*/ ,0x1C ,0x38 }, {  8060 /*100 kHz*/ ,0x1C ,0x38 }, {  8135 /*100 kHz*/ ,0x1C ,0x38 }, {  8210 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  7910 /*100 kHz*/ ,0x00 ,0x00 }, {  7985 /*100 kHz*/ ,0x00 ,0x00 }, {  8060 /*100 kHz*/ ,0x00 ,0x00 }, {  8135 /*100 kHz*/ ,0x00 ,0x00 }, {  8210 /*100 kHz*/ ,0x00 ,0x00 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band26_MIPI_RX_DATA_SetDefault[] =
{
   ...
   { /* 2  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  8590 /*100 kHz*/ ,0x1C ,0x38 }, {  8677 /*100 kHz*/ ,0x1C ,0x38 }, {  8765 /*100 kHz*/ ,0x1C ,0x38 }, {  8852 /*100 kHz*/ ,0x1C ,0x38 }, {  8940 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 3  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  8590 /*100 kHz*/ ,0x00 ,0x04 }, {  8677 /*100 kHz*/ ,0x00 ,0x04 }, {  8765 /*100 kHz*/ ,0x00 ,0x04 }, {  8852 /*100 kHz*/ ,0x00 ,0x04 }, {  8940 /*100 kHz*/ ,0x00 ,0x04 },} },
   ...
   { /* 5  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ {  8590 /*100 kHz*/ ,0x02 ,0x00 }, {  8677 /*100 kHz*/ ,0x02 ,0x00 }, {  8765 /*100 kHz*/ ,0x02 ,0x00 }, {  8852 /*100 kHz*/ ,0x02 ,0x00 }, {  8940 /*100 kHz*/ ,0x02 ,0x00 },} },
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  8590 /*100 kHz*/ ,0x1C ,0x38 }, {  8677 /*100 kHz*/ ,0x1C ,0x38 }, {  8765 /*100 kHz*/ ,0x1C ,0x38 }, {  8852 /*100 kHz*/ ,0x1C ,0x38 }, {  8940 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  8590 /*100 kHz*/ ,0x00 ,0x00 }, {  8677 /*100 kHz*/ ,0x00 ,0x00 }, {  8765 /*100 kHz*/ ,0x00 ,0x00 }, {  8852 /*100 kHz*/ ,0x00 ,0x00 }, {  8940 /*100 kHz*/ ,0x00 ,0x00 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band28_MIPI_RX_DATA_SetDefault[] =
{
   ...
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  7580 /*100 kHz*/ ,0x1C ,0x38 }, {  7692 /*100 kHz*/ ,0x1C ,0x38 }, {  7805 /*100 kHz*/ ,0x1C ,0x38 }, {  7917 /*100 kHz*/ ,0x1C ,0x38 }, {  8030 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  7580 /*100 kHz*/ ,0x00 ,0x00 }, {  7692 /*100 kHz*/ ,0x00 ,0x00 }, {  7805 /*100 kHz*/ ,0x00 ,0x00 }, {  7917 /*100 kHz*/ ,0x00 ,0x00 }, {  8030 /*100 kHz*/ ,0x00 ,0x00 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band29_MIPI_RX_DATA_SetDefault[] =
{
   ...
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  7170 /*100 kHz*/ ,0x1C ,0x38 }, {  7197 /*100 kHz*/ ,0x1C ,0x38 }, {  7225 /*100 kHz*/ ,0x1C ,0x38 }, {  7252 /*100 kHz*/ ,0x1C ,0x38 }, {  7280 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ {  7170 /*100 kHz*/ ,0x00 ,0x00 }, {  7197 /*100 kHz*/ ,0x00 ,0x00 }, {  7225 /*100 kHz*/ ,0x00 ,0x00 }, {  7252 /*100 kHz*/ ,0x00 ,0x00 }, {  7280 /*100 kHz*/ ,0x00 ,0x00 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band30_MIPI_RX_DATA_SetDefault[] =
{
   ...
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 23500 /*100 kHz*/ ,0x1C ,0x38 }, { 23525 /*100 kHz*/ ,0x1C ,0x38 }, { 23550 /*100 kHz*/ ,0x1C ,0x38 }, { 23575 /*100 kHz*/ ,0x1C ,0x38 }, { 23600 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 23500 /*100 kHz*/ ,0x01 ,0x00 }, { 23525 /*100 kHz*/ ,0x01 ,0x00 }, { 23550 /*100 kHz*/ ,0x01 ,0x00 }, { 23575 /*100 kHz*/ ,0x01 ,0x00 }, { 23600 /*100 kHz*/ ,0x01 ,0x00 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/ ,0x1C ,0x38 }, { 20140 /*100 kHz*/ ,0x1C ,0x38 }, { 20175 /*100 kHz*/ ,0x1C ,0x38 }, { 20212 /*100 kHz*/ ,0x1C ,0x38 }, { 20250 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 1  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/ ,0x05 ,0x01 }, { 20140 /*100 kHz*/ ,0x05 ,0x01 }, { 20175 /*100 kHz*/ ,0x05 ,0x01 }, { 20212 /*100 kHz*/ ,0x05 ,0x01 }, { 20250 /*100 kHz*/ ,0x05 ,0x01 },} },
   { /* 2  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/ ,0x1C ,0x38 }, { 20140 /*100 kHz*/ ,0x1C ,0x38 }, { 20175 /*100 kHz*/ ,0x1C ,0x38 }, { 20212 /*100 kHz*/ ,0x1C ,0x38 }, { 20250 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 3  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/ ,0x1C ,0x38 }, { 20140 /*100 kHz*/ ,0x1C ,0x38 }, { 20175 /*100 kHz*/ ,0x1C ,0x38 }, { 20212 /*100 kHz*/ ,0x1C ,0x38 }, { 20250 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 4  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/ ,0x1C ,0x38 }, { 20140 /*100 kHz*/ ,0x1C ,0x38 }, { 20175 /*100 kHz*/ ,0x1C ,0x38 }, { 20212 /*100 kHz*/ ,0x1C ,0x38 }, { 20250 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 5  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 20100 /*100 kHz*/ ,0x1C ,0x38 }, { 20140 /*100 kHz*/ ,0x1C ,0x38 }, { 20175 /*100 kHz*/ ,0x1C ,0x38 }, { 20212 /*100 kHz*/ ,0x1C ,0x38 }, { 20250 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 20100 /*100 kHz*/ ,0x01 ,0x03 }, { 20140 /*100 kHz*/ ,0x01 ,0x03 }, { 20175 /*100 kHz*/ ,0x01 ,0x03 }, { 20212 /*100 kHz*/ ,0x01 ,0x03 }, { 20250 /*100 kHz*/ ,0x01 ,0x03 },} },
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/ ,0x1C ,0x38 }, { 20140 /*100 kHz*/ ,0x1C ,0x38 }, { 20175 /*100 kHz*/ ,0x1C ,0x38 }, { 20212 /*100 kHz*/ ,0x1C ,0x38 }, { 20250 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 8  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/ ,0x05 ,0x00 }, { 20140 /*100 kHz*/ ,0x05 ,0x00 }, { 20175 /*100 kHz*/ ,0x05 ,0x00 }, { 20212 /*100 kHz*/ ,0x05 ,0x00 }, { 20250 /*100 kHz*/ ,0x05 ,0x00 },} },
   { /* 9  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/ ,0x1C ,0x38 }, { 20140 /*100 kHz*/ ,0x1C ,0x38 }, { 20175 /*100 kHz*/ ,0x1C ,0x38 }, { 20212 /*100 kHz*/ ,0x1C ,0x38 }, { 20250 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 10  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/ ,0x1C ,0x38 }, { 20140 /*100 kHz*/ ,0x1C ,0x38 }, { 20175 /*100 kHz*/ ,0x1C ,0x38 }, { 20212 /*100 kHz*/ ,0x1C ,0x38 }, { 20250 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 11  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/ ,0x1C ,0x38 }, { 20140 /*100 kHz*/ ,0x1C ,0x38 }, { 20175 /*100 kHz*/ ,0x1C ,0x38 }, { 20212 /*100 kHz*/ ,0x1C ,0x38 }, { 20250 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 12  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/ ,0x1C ,0x38 }, { 20140 /*100 kHz*/ ,0x1C ,0x38 }, { 20175 /*100 kHz*/ ,0x1C ,0x38 }, { 20212 /*100 kHz*/ ,0x1C ,0x38 }, { 20250 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 13  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/ ,0x04 ,0x00 }, { 20140 /*100 kHz*/ ,0x04 ,0x00 }, { 20175 /*100 kHz*/ ,0x04 ,0x00 }, { 20212 /*100 kHz*/ ,0x04 ,0x00 }, { 20250 /*100 kHz*/ ,0x04 ,0x00 },} },
   { /* 14  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/ ,0x1C ,0x38 }, { 20140 /*100 kHz*/ ,0x1C ,0x38 }, { 20175 /*100 kHz*/ ,0x1C ,0x38 }, { 20212 /*100 kHz*/ ,0x1C ,0x38 }, { 20250 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 15  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/ ,0x1C ,0x38 }, { 20140 /*100 kHz*/ ,0x1C ,0x38 }, { 20175 /*100 kHz*/ ,0x1C ,0x38 }, { 20212 /*100 kHz*/ ,0x1C ,0x38 }, { 20250 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 16  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/ ,0x1C ,0x38 }, { 20140 /*100 kHz*/ ,0x1C ,0x38 }, { 20175 /*100 kHz*/ ,0x1C ,0x38 }, { 20212 /*100 kHz*/ ,0x1C ,0x38 }, { 20250 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 17  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 20100 /*100 kHz*/ ,0x1C ,0x38 }, { 20140 /*100 kHz*/ ,0x1C ,0x38 }, { 20175 /*100 kHz*/ ,0x1C ,0x38 }, { 20212 /*100 kHz*/ ,0x1C ,0x38 }, { 20250 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 18  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 20100 /*100 kHz*/ ,0x01 ,0x00 }, { 20140 /*100 kHz*/ ,0x01 ,0x00 }, { 20175 /*100 kHz*/ ,0x01 ,0x00 }, { 20212 /*100 kHz*/ ,0x01 ,0x00 }, { 20250 /*100 kHz*/ ,0x01 ,0x00 },} },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band38_MIPI_RX_DATA_SetDefault[] =
{
   ...
   { /* 2  */ LTE_MIPI_PA , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3    ,{ { 25700 /*100 kHz*/ ,0x1C ,0x38 }, { 25825 /*100 kHz*/ ,0x1C ,0x38 }, { 25950 /*100 kHz*/ ,0x1C ,0x38 }, { 26075 /*100 kHz*/ ,0x1C ,0x38 }, { 26200 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 3  */ LTE_MIPI_PA , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3    ,{ { 25700 /*100 kHz*/ ,0x02 ,0x03 }, { 25825 /*100 kHz*/ ,0x02 ,0x03 }, { 25950 /*100 kHz*/ ,0x02 ,0x03 }, { 26075 /*100 kHz*/ ,0x02 ,0x03 }, { 26200 /*100 kHz*/ ,0x02 ,0x03 },} },   
   ...
   { /* 5  */ LTE_MIPI_PA , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 25700 /*100 kHz*/ ,0x03 ,0x00 }, { 25825 /*100 kHz*/ ,0x03 ,0x00 }, { 25950 /*100 kHz*/ ,0x03 ,0x00 }, { 26075 /*100 kHz*/ ,0x03 ,0x00 }, { 26200 /*100 kHz*/ ,0x03 ,0x00 },} },
   { /* 6  */ LTE_MIPI_PA , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3    ,{ { 25700 /*100 kHz*/ ,0x1C ,0x38 }, { 25825 /*100 kHz*/ ,0x1C ,0x38 }, { 25950 /*100 kHz*/ ,0x1C ,0x38 }, { 26075 /*100 kHz*/ ,0x1C ,0x38 }, { 26200 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 7  */ LTE_MIPI_PA , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3    ,{ { 25700 /*100 kHz*/ ,0x02 ,0x00 }, { 25825 /*100 kHz*/ ,0x02 ,0x00 }, { 25950 /*100 kHz*/ ,0x02 ,0x00 }, { 26075 /*100 kHz*/ ,0x02 ,0x00 }, { 26200 /*100 kHz*/ ,0x02 ,0x00 },} },  
   { /* 8  */ LTE_MIPI_NULL, 0                , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band39_MIPI_RX_DATA_SetDefault[] =
{
   ...
   { /* 2  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 18800 /*100 kHz*/ ,0x1C ,0x38 }, { 18900 /*100 kHz*/ ,0x1C ,0x38 }, { 19000 /*100 kHz*/ ,0x1C ,0x38 }, { 19100 /*100 kHz*/ ,0x1C ,0x38 }, { 19200 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 3  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 18800 /*100 kHz*/ ,0x01 ,0x03 }, { 18900 /*100 kHz*/ ,0x01 ,0x03 }, { 19000 /*100 kHz*/ ,0x01 ,0x03 }, { 19100 /*100 kHz*/ ,0x01 ,0x03 }, { 19200 /*100 kHz*/ ,0x01 ,0x03 },} },
   ...
   { /* 5  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 18800 /*100 kHz*/ ,0x05 ,0x00 }, { 18900 /*100 kHz*/ ,0x05 ,0x00 }, { 19000 /*100 kHz*/ ,0x05 ,0x00 }, { 19100 /*100 kHz*/ ,0x05 ,0x00 }, { 19200 /*100 kHz*/ ,0x05 ,0x00 },} },
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 18800 /*100 kHz*/ ,0x1C ,0x38 }, { 18900 /*100 kHz*/ ,0x1C ,0x38 }, { 19000 /*100 kHz*/ ,0x1C ,0x38 }, { 19100 /*100 kHz*/ ,0x1C ,0x38 }, { 19200 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 18800 /*100 kHz*/ ,0x01 ,0x00 }, { 18900 /*100 kHz*/ ,0x01 ,0x00 }, { 19000 /*100 kHz*/ ,0x01 ,0x00 }, { 19100 /*100 kHz*/ ,0x01 ,0x00 }, { 19200 /*100 kHz*/ ,0x01 ,0x00 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band40_MIPI_RX_DATA_SetDefault[] =
{
   ...
   { /* 2  */ LTE_MIPI_PA , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3    ,{ { 23000 /*100 kHz*/ ,0x1C ,0x38 }, { 23250 /*100 kHz*/ ,0x1C ,0x38 }, { 23500 /*100 kHz*/ ,0x1C ,0x38 }, { 23750 /*100 kHz*/ ,0x1C ,0x38 }, { 24000 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 3  */ LTE_MIPI_PA , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3    ,{ { 23000 /*100 kHz*/ ,0x02 ,0x02 }, { 23250 /*100 kHz*/ ,0x02 ,0x02 }, { 23500 /*100 kHz*/ ,0x02 ,0x02 }, { 23750 /*100 kHz*/ ,0x02 ,0x02 }, { 24000 /*100 kHz*/ ,0x02 ,0x02 },} },
   ...
   { /* 5  */ LTE_MIPI_PA , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 23000 /*100 kHz*/ ,0x03 ,0x00 }, { 23250 /*100 kHz*/ ,0x03 ,0x00 }, { 23500 /*100 kHz*/ ,0x03 ,0x00 }, { 23750 /*100 kHz*/ ,0x03 ,0x00 }, { 24000 /*100 kHz*/ ,0x03 ,0x00 },} },
   { /* 6  */ LTE_MIPI_PA , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3    ,{ { 23000 /*100 kHz*/ ,0x1C ,0x38 }, { 23250 /*100 kHz*/ ,0x1C ,0x38 }, { 23500 /*100 kHz*/ ,0x1C ,0x38 }, { 23750 /*100 kHz*/ ,0x1C ,0x38 }, { 24000 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 7  */ LTE_MIPI_PA , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3    ,{ { 23000 /*100 kHz*/ ,0x02 ,0x00 }, { 23250 /*100 kHz*/ ,0x02 ,0x00 }, { 23500 /*100 kHz*/ ,0x02 ,0x00 }, { 23750 /*100 kHz*/ ,0x02 ,0x00 }, { 24000 /*100 kHz*/ ,0x02 ,0x00 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band41_MIPI_RX_DATA_SetDefault[] =
{
   ...
   { /* 2  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W    , MIPI_USID_PA0_P3    ,{ { 24960 /*100 kHz*/ ,0x1C ,0x38 }, { 25445 /*100 kHz*/ ,0x1C ,0x38 }, { 25930 /*100 kHz*/ ,0x1C ,0x38 }, { 26415 /*100 kHz*/ ,0x1C ,0x38 }, { 26900 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 3  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W    , MIPI_USID_PA0_P3    ,{ { 24960 /*100 kHz*/ ,0x02 ,0x03 }, { 25445 /*100 kHz*/ ,0x02 ,0x03 }, { 25930 /*100 kHz*/ ,0x02 ,0x03 }, { 26415 /*100 kHz*/ ,0x02 ,0x03 }, { 26900 /*100 kHz*/ ,0x02 ,0x03 },} },
   ...
   { /* 5  */ LTE_MIPI_PA , LTE_MIPI_PORT0    , LTE_REG_W    , MIPI_USID_ASM0_P3    ,{ { 24960 /*100 kHz*/ ,0x03 ,0x00 }, { 25445 /*100 kHz*/ ,0x03 ,0x00 }, { 25930 /*100 kHz*/ ,0x03 ,0x00 }, { 26415 /*100 kHz*/ ,0x03 ,0x00 }, { 26900 /*100 kHz*/ ,0x03 ,0x00 },} },
   { /* 6  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W    , MIPI_USID_PA0_P3    ,{ { 24960 /*100 kHz*/ ,0x1C ,0x38 }, { 25445 /*100 kHz*/ ,0x1C ,0x38 }, { 25930 /*100 kHz*/ ,0x1C ,0x38 }, { 26415 /*100 kHz*/ ,0x1C ,0x38 }, { 26900 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 7  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W    , MIPI_USID_PA0_P3    ,{ { 24960 /*100 kHz*/ ,0x02 ,0x00 }, { 25445 /*100 kHz*/ ,0x02 ,0x00 }, { 25930 /*100 kHz*/ ,0x02 ,0x00 }, { 26415 /*100 kHz*/ ,0x02 ,0x00 }, { 26900 /*100 kHz*/ ,0x02 ,0x00 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0               ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 21100 /*100 kHz*/ ,0x1C ,0x38 }, { 21325 /*100 kHz*/ ,0x1C ,0x38 }, { 21550 /*100 kHz*/ ,0x1C ,0x38 }, { 21775 /*100 kHz*/ ,0x1C ,0x38 }, { 22000 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 1  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 21100 /*100 kHz*/ ,0x05 ,0x05 }, { 21325 /*100 kHz*/ ,0x05 ,0x05 }, { 21550 /*100 kHz*/ ,0x05 ,0x05 }, { 21775 /*100 kHz*/ ,0x05 ,0x05 }, { 22000 /*100 kHz*/ ,0x05 ,0x05 },} },
   { /* 2  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 21100 /*100 kHz*/ ,0x1C ,0x38 }, { 21325 /*100 kHz*/ ,0x1C ,0x38 }, { 21550 /*100 kHz*/ ,0x1C ,0x38 }, { 21775 /*100 kHz*/ ,0x1C ,0x38 }, { 22000 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 3  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 21100 /*100 kHz*/ ,0x01 ,0x04 }, { 21325 /*100 kHz*/ ,0x01 ,0x04 }, { 21550 /*100 kHz*/ ,0x01 ,0x04 }, { 21775 /*100 kHz*/ ,0x01 ,0x04 }, { 22000 /*100 kHz*/ ,0x01 ,0x04 },} },
   { /* 4  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 21100 /*100 kHz*/ ,0x1C ,0x38 }, { 21325 /*100 kHz*/ ,0x1C ,0x38 }, { 21550 /*100 kHz*/ ,0x1C ,0x38 }, { 21775 /*100 kHz*/ ,0x1C ,0x38 }, { 22000 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 5  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 21100 /*100 kHz*/ ,0x05 ,0x00 }, { 21325 /*100 kHz*/ ,0x05 ,0x00 }, { 21550 /*100 kHz*/ ,0x05 ,0x00 }, { 21775 /*100 kHz*/ ,0x05 ,0x00 }, { 22000 /*100 kHz*/ ,0x05 ,0x00 },} },
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 21100 /*100 kHz*/ ,0x1C ,0x38 }, { 21325 /*100 kHz*/ ,0x1C ,0x38 }, { 21550 /*100 kHz*/ ,0x1C ,0x38 }, { 21775 /*100 kHz*/ ,0x1C ,0x38 }, { 22000 /*100 kHz*/ ,0x1C ,0x38 },} },
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM1_P3   ,{ { 21100 /*100 kHz*/ ,0x01 ,0x00 }, { 21325 /*100 kHz*/ ,0x01 ,0x00 }, { 21550 /*100 kHz*/ ,0x01 ,0x00 }, { 21775 /*100 kHz*/ ,0x01 ,0x00 }, { 22000 /*100 kHz*/ ,0x01 ,0x00 },} },
   { /* 8  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};

/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */

kal_uint32  LTE_MIPI_RX_DATA_SIZE_TABLE_SetDefault[LTE_MAX_SUPPORT_FE_ROUTE_NUM] =
{
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR0,     SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR1,     SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR2,     SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR3,     SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR4,     SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR5,     SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR6,     SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR7,     SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR8,     SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR9,     SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR10,    SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR11,    SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR12,    SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR13,    SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR14,    SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR15,    SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR16,    SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR17,    SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR18,    SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR19,    SetDefault)),
   sizeof(LTE_MIPI_RX_DATA(      BAND_INDICATOR20,    SetDefault)),
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND21, SetDefault)),     /*Index 0*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND22, SetDefault)),     /*Index 1*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND23, SetDefault)),     /*Index 2*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND24, SetDefault)),     /*Index 3*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND25, SetDefault)),     /*Index 4*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND26, SetDefault)),     /*Index 5*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND27, SetDefault)),     /*Index 6*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND28, SetDefault)),     /*Index 7*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND29, SetDefault)),     /*Index 8*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND30, SetDefault)),     /*Index 9*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND31, SetDefault)),     /*Index10*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND32, SetDefault)),     /*Index11*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND33, SetDefault)),     /*Index12*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND34, SetDefault)),     /*Index13*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND35, SetDefault)),     /*Index14*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND36, SetDefault)),     /*Index15*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND37, SetDefault)),     /*Index16*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND38, SetDefault)),     /*Index17*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND39, SetDefault)),     /*Index18*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND40, SetDefault)),     /*Index19*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND41, SetDefault)),     /*Index20*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND42, SetDefault)),     /*Index21*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND43, SetDefault)),     /*Index22*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND44, SetDefault)),     /*Index23*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND45, SetDefault)),     /*Index24*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND46, SetDefault)),     /*Index25*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND47, SetDefault)),     /*Index26*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND48, SetDefault)),     /*Index27*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND49, SetDefault)),     /*Index28*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND50, SetDefault)),     /*Index29*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND51, SetDefault)),     /*Index30*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND52, SetDefault)),     /*Index31*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND53, SetDefault)),     /*Index32*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND54, SetDefault)),     /*Index33*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND55, SetDefault)),     /*Index34*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND56, SetDefault)),     /*Index35*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND57, SetDefault)),     /*Index36*/
   sizeof(LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND58, SetDefault)),     /*Index37*/
};

LTE_MIPI_DATA_SUBBAND_TABLE_T*  LTE_MIPI_RX_DATA_TABLE_SetDefault[LTE_MAX_SUPPORT_FE_ROUTE_NUM] =
{
   LTE_MIPI_RX_DATA(      BAND_INDICATOR0,     SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR1,     SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR2,     SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR3,     SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR4,     SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR5,     SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR6,     SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR7,     SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR8,     SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR9,     SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR10,    SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR11,    SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR12,    SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR13,    SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR14,    SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR15,    SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR16,    SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR17,    SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR18,    SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR19,    SetDefault),
   LTE_MIPI_RX_DATA(      BAND_INDICATOR20,    SetDefault),
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND21, SetDefault),     /*Index 0*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND22, SetDefault),     /*Index 1*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND23, SetDefault),     /*Index 2*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND24, SetDefault),     /*Index 3*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND25, SetDefault),     /*Index 4*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND26, SetDefault),     /*Index 5*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND27, SetDefault),     /*Index 6*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND28, SetDefault),     /*Index 7*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND29, SetDefault),     /*Index 8*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND30, SetDefault),     /*Index 9*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND31, SetDefault),     /*Index10*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND32, SetDefault),     /*Index11*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND33, SetDefault),     /*Index12*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND34, SetDefault),     /*Index13*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND35, SetDefault),     /*Index14*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND36, SetDefault),     /*Index15*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND37, SetDefault),     /*Index16*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND38, SetDefault),     /*Index17*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND39, SetDefault),     /*Index18*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND40, SetDefault),     /*Index19*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND41, SetDefault),     /*Index20*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND42, SetDefault),     /*Index21*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND43, SetDefault),     /*Index22*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND44, SetDefault),     /*Index23*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND45, SetDefault),     /*Index24*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND46, SetDefault),     /*Index25*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND47, SetDefault),     /*Index26*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND48, SetDefault),     /*Index27*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND49, SetDefault),     /*Index28*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND50, SetDefault),     /*Index29*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND51, SetDefault),     /*Index30*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND52, SetDefault),     /*Index31*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND53, SetDefault),     /*Index32*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND54, SetDefault),     /*Index33*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND55, SetDefault),     /*Index34*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND56, SetDefault),     /*Index35*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND57, SetDefault),     /*Index36*/
   LTE_MIPI_RX_DATA_ROUTE(MIPI_RX_ROUTE_IND58, SetDefault),     /*Index37*/
};
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
...
LTE_MIPI_EVENT_TABLE_T LTE_Band1_MIPI_TX_EVENT_SetDefault[] =
{
   ...
   { /* 2  */ LTE_MIPI_ASM , { 6    , 8    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ASM_TX_ON0_SetDefault },
...
LTE_MIPI_EVENT_TABLE_T LTE_Band34_MIPI_TX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_ASM  , { 0    , 11    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_PA_TX_ON0_SetDefault  }, //PA On
   { /* 1  */ LTE_MIPI_ASM  , { 12    , 12    }, LTE_MIPI_TRX_OFF   , LTE_TDD_MIPI_PA_TX_OFF0_SetDefault }, //PA Off
   { /* 2  */ LTE_MIPI_NULL, { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                       },
};
...
LTE_MIPI_EVENT_TABLE_T LTE_Band38_MIPI_TX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_PA  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_PA_TX_ON0_SetDefault  }, //PA On
   { /* 1  */ LTE_MIPI_PA  , { 5    , 5    }, LTE_MIPI_TRX_OFF   , LTE_TDD_MIPI_PA_TX_OFF0_SetDefault }, //PA Off
   { /* 2  */ LTE_MIPI_ASM , { 6    , 8    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ASM_TX_ON0_SetDefault },
   { /* 3  */ LTE_MIPI_NULL, { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                       },
};
...
LTE_MIPI_EVENT_TABLE_T LTE_Band39_MIPI_TX_EVENT_SetDefault[] =
{
   ...
   { /* 0  */ LTE_MIPI_PA  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_PA_TX_ON0_SetDefault  }, //PA On
   { /* 1  */ LTE_MIPI_PA  , { 5    , 5    }, LTE_MIPI_TRX_OFF   , LTE_TDD_MIPI_PA_TX_OFF0_SetDefault }, //PA Off
   { /* 2  */ LTE_MIPI_ASM , { 6    , 11   }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_ASM_TX_ON1_SetDefault },
   { /* 3  */ LTE_MIPI_NULL, { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0                       },
};
...
kal_uint32  LTE_MIPI_TX_EVENT_SIZE_TABLE_SetDefault[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR0,  SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR1,  SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR2,  SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR3,  SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR4,  SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR5,  SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR6,  SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR7,  SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR8,  SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR9,  SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR10, SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR11, SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR12, SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR13, SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR14, SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR15, SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR16, SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR17, SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR18, SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR19, SetDefault)),
   sizeof(LTE_MIPI_TX_EVENT(BAND_INDICATOR20, SetDefault)),
};

LTE_MIPI_EVENT_TABLE_T*  LTE_MIPI_TX_EVENT_TABLE_SetDefault[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
   LTE_MIPI_TX_EVENT(BAND_INDICATOR0,  SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR1,  SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR2,  SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR3,  SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR4,  SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR5,  SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR6,  SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR7,  SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR8,  SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR9,  SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR10, SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR11, SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR12, SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR13, SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR14, SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR15, SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR16, SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR17, SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR18, SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR19, SetDefault),
   LTE_MIPI_TX_EVENT(BAND_INDICATOR20, SetDefault),
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band1_MIPI_TX_DATA_SetDefault[] =
{
   ...
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 19200 /*100 kHz*/    ,0x05 , 0x03}, { 19350 /*100 kHz*/    ,0x05 , 0x03}, { 19500 /*100 kHz*/    ,0x05 , 0x03}, { 19650 /*100 kHz*/    ,0x05 , 0x03}, { 19800 /*100 kHz*/    ,0x05 , 0x03},} }, // ASM PM_Trig: normal mode
   { /* 8  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 19200 /*100 kHz*/    ,0x04 , 0x13}, { 19350 /*100 kHz*/    ,0x04 , 0x13}, { 19500 /*100 kHz*/    ,0x04 , 0x13}, { 19650 /*100 kHz*/    ,0x04 , 0x13}, { 19800 /*100 kHz*/    ,0x04 , 0x13},} },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band2_MIPI_TX_DATA_SetDefault[] =
{
   ...
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 18500 /*100 kHz*/ ,0x05 ,0x05 }, { 18650 /*100 kHz*/ ,0x05 ,0x05 }, { 18800 /*100 kHz*/ ,0x05 ,0x05 }, { 18950 /*100 kHz*/ ,0x05 ,0x05 }, { 19100 /*100 kHz*/ ,0x05 ,0x05 },} },
   { /* 8  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 18500 /*100 kHz*/ ,0x04 ,0x13 }, { 18650 /*100 kHz*/ ,0x04 ,0x13 }, { 18800 /*100 kHz*/ ,0x04 ,0x13 }, { 18950 /*100 kHz*/ ,0x04 ,0x13 }, { 19100 /*100 kHz*/ ,0x04 ,0x13 },} },
   { /* 9  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band3_MIPI_TX_DATA_SetDefault[] =
{
   ...
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 17100 /*100 kHz*/    ,0x05 , 0x03}, { 17287 /*100 kHz*/    ,0x05 , 0x03}, { 17475 /*100 kHz*/    ,0x05 , 0x03}, { 17662 /*100 kHz*/    ,0x05 , 0x03}, { 17850 /*100 kHz*/    ,0x05 , 0x03},} },
   { /* 8  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 17100 /*100 kHz*/    ,0x04 , 0x13}, { 17287 /*100 kHz*/    ,0x04 , 0x13}, { 17475 /*100 kHz*/    ,0x04 , 0x13}, { 17662 /*100 kHz*/    ,0x04 , 0x13}, { 17850 /*100 kHz*/    ,0x04 , 0x13},} },
   { /* 9  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band4_MIPI_TX_DATA_SetDefault[] =
{
   ...
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 17100 /*100 kHz*/ ,0x05 ,0x05 }, { 17212 /*100 kHz*/ ,0x05 ,0x05 }, { 17325 /*100 kHz*/ ,0x05 ,0x05 }, { 17437 /*100 kHz*/ ,0x05 ,0x05 }, { 17550 /*100 kHz*/ ,0x05 ,0x05},} },
   { /* 8  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 17100 /*100 kHz*/ ,0x04 ,0x13 }, { 17212 /*100 kHz*/ ,0x04 ,0x13 }, { 17325 /*100 kHz*/ ,0x04 ,0x13 }, { 17437 /*100 kHz*/ ,0x04 ,0x13 }, { 17550 /*100 kHz*/ ,0x04 ,0x13},} },
   { /* 9  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band5_MIPI_TX_DATA_SetDefault[] =
{
   ...
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 8240  /*100 kHz*/    ,0x02 , 0x04}, { 8302  /*100 kHz*/    ,0x02 , 0x04}, { 8365  /*100 kHz*/    ,0x02 , 0x04}, { 8427  /*100 kHz*/    ,0x02 , 0x04}, { 8490  /*100 kHz*/    ,0x02 , 0x04},} },
   { /* 8  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 8240  /*100 kHz*/    ,0x04 , 0x0B}, { 8302  /*100 kHz*/    ,0x04 , 0x0B}, { 8365  /*100 kHz*/    ,0x04 , 0x0B}, { 8427  /*100 kHz*/    ,0x04 , 0x0B}, { 8490  /*100 kHz*/    ,0x04 , 0x0B},} },
   { /* 9  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band7_MIPI_TX_DATA_SetDefault[] =
{
   ...
   { /* 7  */ LTE_MIPI_ASM  , LTE_MIPI_PORT0   , LTE_REG_W     , MIPI_USID_ASM0_P3  ,{ { 25000 /*100 kHz*/    ,0x03 , 0x80}, { 25175 /*100 kHz*/    ,0x03 , 0x80}, { 25350 /*100 kHz*/    ,0x03 , 0x80}, { 25525 /*100 kHz*/    ,0x03 , 0x80}, { 25700 /*100 kHz*/    ,0x03 , 0x80},} }, // ASM Path select                 
   { /* 8  */ LTE_MIPI_ASM  , LTE_MIPI_PORT0   , LTE_REG_W     , MIPI_USID_ASM0_P3  ,{ { 25000 /*100 kHz*/    ,0x04 , 0x19}, { 25175 /*100 kHz*/    ,0x04 , 0x19}, { 25350 /*100 kHz*/    ,0x04 , 0x19}, { 25525 /*100 kHz*/    ,0x04 , 0x19}, { 25700 /*100 kHz*/    ,0x04 , 0x19},} },
   { /* 9  */ LTE_MIPI_NULL, 0                 , 0             , 0               ,{ { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   },} },                              
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band8_MIPI_TX_DATA_SetDefault[] =
{
   ...
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ {  8800 /*100 kHz*/ ,0x02 ,0x02 }, {  8887 /*100 kHz*/ ,0x02 ,0x02 }, {  8975 /*100 kHz*/ ,0x02 ,0x02 }, {  9062 /*100 kHz*/ ,0x02 ,0x02 }, {  9150 /*100 kHz*/ ,0x02 ,0x02 },} },
   { /* 8  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ {  8800 /*100 kHz*/ ,0x04 ,0x0B }, {  8887 /*100 kHz*/ ,0x04 ,0x0B }, {  8975 /*100 kHz*/ ,0x04 ,0x0B }, {  9062 /*100 kHz*/ ,0x04 ,0x0B }, {  9150 /*100 kHz*/ ,0x04 ,0x0B },} },
   { /* 9  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band20_MIPI_TX_DATA_SetDefault[] =
{
   ...
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ {  8320 /*100 kHz*/ ,0x02 ,0x01 }, {  8395 /*100 kHz*/ ,0x02 ,0x01 }, {  8470 /*100 kHz*/ ,0x02 ,0x01 }, {  8545 /*100 kHz*/ ,0x02 ,0x01 }, {  8620 /*100 kHz*/ ,0x02 ,0x01 },} },
   { /* 8  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ {  8320 /*100 kHz*/ ,0x04 ,0x0B }, {  8395 /*100 kHz*/ ,0x04 ,0x0B }, {  8470 /*100 kHz*/ ,0x04 ,0x0B }, {  8545 /*100 kHz*/ ,0x04 ,0x0B }, {  8620 /*100 kHz*/ ,0x04 ,0x0B },} },
   { /* 9  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band26_MIPI_TX_DATA_SetDefault[] =
{
   ...
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ {  8140 /*100 kHz*/ ,0x02 ,0x04 }, {  8227 /*100 kHz*/ ,0x02 ,0x04 }, {  8315 /*100 kHz*/ ,0x02 ,0x04 }, {  8402 /*100 kHz*/ ,0x02 ,0x04 }, {  8490 /*100 kHz*/ ,0x02 ,0x04 },} },
   { /* 8  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ {  8140 /*100 kHz*/ ,0x04 ,0x0B }, {  8227 /*100 kHz*/ ,0x04 ,0x0B }, {  8315 /*100 kHz*/ ,0x04 ,0x0B }, {  8402 /*100 kHz*/ ,0x04 ,0x0B }, {  8490 /*100 kHz*/ ,0x04 ,0x0B },} },
   { /* 9  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band28_MIPI_TX_DATA_SetDefault[] =
{
   ...
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ {  7030 /*100 kHz*/ ,0x02 ,0x03 }, {  7142 /*100 kHz*/ ,0x02 ,0x03 }, {  7255 /*100 kHz*/ ,0x02 ,0x05 }, {  7367 /*100 kHz*/ ,0x02 ,0x05 }, {  7480 /*100 kHz*/ ,0x02 ,0x05 },} },
   { /* 8  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ {  7030 /*100 kHz*/ ,0x04 ,0x0B }, {  7142 /*100 kHz*/ ,0x04 ,0x0B }, {  7255 /*100 kHz*/ ,0x04 ,0x0B }, {  7367 /*100 kHz*/ ,0x04 ,0x0B }, {  7480 /*100 kHz*/ ,0x04 ,0x0B },} },
   { /* 9  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband earfcn /*0*/ ,addr ,data }, { subband earfcn /*1*/ ,addr ,data }, { subband earfcn /*2*/ ,addr ,data }, { subband earfcn /*3*/ ,addr ,data }, { subband earfcn /*4*/ ,addr ,data } },
   { /* 0  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/    ,0x1C , 0x38}, { 20140 /*100 kHz*/    ,0x1C , 0x38}, { 20175 /*100 kHz*/    ,0x1C , 0x38}, { 20212 /*100 kHz*/    ,0x1C , 0x38}, { 20250 /*100 kHz*/    ,0x1C , 0x38},} }, // ASM PM_Trig: normal mode
   { /* 1  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/    ,0x00 , 0xAF}, { 20140 /*100 kHz*/    ,0x00 , 0xAF}, { 20175 /*100 kHz*/    ,0x00 , 0xAF}, { 20212 /*100 kHz*/    ,0x00 , 0xAF}, { 20250 /*100 kHz*/    ,0x00 , 0xAF},} }, // PA HB/EDGE linear mode
   { /* 2  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/    ,0x01 , 0x28}, { 20140 /*100 kHz*/    ,0x01 , 0x28}, { 20175 /*100 kHz*/    ,0x01 , 0x28}, { 20212 /*100 kHz*/    ,0x01 , 0x28}, { 20250 /*100 kHz*/    ,0x01 , 0x28},} }, // PA bias control
   { /* 3  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/    ,0x04 , 0x13}, { 20140 /*100 kHz*/    ,0x04 , 0x13}, { 20175 /*100 kHz*/    ,0x04 , 0x13}, { 20212 /*100 kHz*/    ,0x04 , 0x13}, { 20250 /*100 kHz*/    ,0x04 , 0x13},} }, // coupler turn on
   { /* 4  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/    ,0x1C , 0x38}, { 20140 /*100 kHz*/    ,0x1C , 0x38}, { 20175 /*100 kHz*/    ,0x1C , 0x38}, { 20212 /*100 kHz*/    ,0x1C , 0x38}, { 20250 /*100 kHz*/    ,0x1C , 0x38},} },
   { /* 5  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/    ,0x1C , 0x38}, { 20140 /*100 kHz*/    ,0x1C , 0x38}, { 20175 /*100 kHz*/    ,0x1C , 0x38}, { 20212 /*100 kHz*/    ,0x1C , 0x38}, { 20250 /*100 kHz*/    ,0x1C , 0x38},} },
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/    ,0x1C , 0x38}, { 20140 /*100 kHz*/    ,0x1C , 0x38}, { 20175 /*100 kHz*/    ,0x1C , 0x38}, { 20212 /*100 kHz*/    ,0x1C , 0x38}, { 20250 /*100 kHz*/    ,0x1C , 0x38},} },
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/    ,0x1C , 0x38}, { 20140 /*100 kHz*/    ,0x1C , 0x38}, { 20175 /*100 kHz*/    ,0x1C , 0x38}, { 20212 /*100 kHz*/    ,0x1C , 0x38}, { 20250 /*100 kHz*/    ,0x1C , 0x38},} },
   { /* 8  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/    ,0x05 , 0x06}, { 20140 /*100 kHz*/    ,0x05 , 0x06}, { 20175 /*100 kHz*/    ,0x05 , 0x06}, { 20212 /*100 kHz*/    ,0x05 , 0x06}, { 20250 /*100 kHz*/    ,0x05 , 0x06},} }, // TXM switch isolation mode for time mask
   { /* 9  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/    ,0x1C , 0x38}, { 20140 /*100 kHz*/    ,0x1C , 0x38}, { 20175 /*100 kHz*/    ,0x1C , 0x38}, { 20212 /*100 kHz*/    ,0x1C , 0x38}, { 20250 /*100 kHz*/    ,0x1C , 0x38},} },
   { /* 10  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/    ,0x1C , 0x38}, { 20140 /*100 kHz*/    ,0x1C , 0x38}, { 20175 /*100 kHz*/    ,0x1C , 0x38}, { 20212 /*100 kHz*/    ,0x1C , 0x38}, { 20250 /*100 kHz*/    ,0x1C , 0x38},} },
   { /* 11  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/    ,0x1C , 0x38}, { 20140 /*100 kHz*/    ,0x1C , 0x38}, { 20175 /*100 kHz*/    ,0x1C , 0x38}, { 20212 /*100 kHz*/    ,0x1C , 0x38}, { 20250 /*100 kHz*/    ,0x1C , 0x38},} },
   { /* 12  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 20100 /*100 kHz*/    ,0x00 , 0x00}, { 20140 /*100 kHz*/    ,0x00 , 0x00}, { 20175 /*100 kHz*/    ,0x00 , 0x00}, { 20212 /*100 kHz*/    ,0x00 , 0x00}, { 20250 /*100 kHz*/    ,0x00 , 0x00},} }, // PA(TXM re-use) disable
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band38_MIPI_TX_DATA_SetDefault[] =
{
   ...
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3  ,{ { 25700 /*100 kHz*/    ,0x03 , 0x40}, { 25825 /*100 kHz*/    ,0x03 , 0x40}, { 25950 /*100 kHz*/    ,0x03 , 0x40}, { 26075 /*100 kHz*/    ,0x03 , 0x40}, { 26200 /*100 kHz*/    ,0x03 , 0x40},} },
   { /* 8  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3  ,{ { 25700 /*100 kHz*/    ,0x04 , 0x18}, { 25825 /*100 kHz*/    ,0x04 , 0x18}, { 25950 /*100 kHz*/    ,0x04 , 0x18}, { 26075 /*100 kHz*/    ,0x04 , 0x18}, { 26200 /*100 kHz*/    ,0x04 , 0x18},} },
   { /* 9  */ LTE_MIPI_NULL, 0                 , 0             , 0               ,{ { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   },} },
};
...
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband earfcn /*0*/ ,addr ,data }, { subband earfcn /*1*/ ,addr ,data }, { subband earfcn /*2*/ ,addr ,data }, { subband earfcn /*3*/ ,addr ,data }, { subband earfcn /*4*/ ,addr ,data } },
   { /* 0  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3    ,{ { 18800 /*100 kHz*/    ,0x1C , 0x38}, { 18900 /*100 kHz*/    ,0x1C , 0x38}, { 19000 /*100 kHz*/    ,0x1C , 0x38}, { 19100 /*100 kHz*/    ,0x1C , 0x38}, { 19200 /*100 kHz*/    ,0x1C , 0x38},} }, // PA On PM_Trig: normal mode
   { /* 1  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3    ,{ { 18800 /*100 kHz*/    ,0x00 , 0x00}, { 18900 /*100 kHz*/    ,0x00 , 0x00}, { 19000 /*100 kHz*/    ,0x00 , 0x00}, { 19100 /*100 kHz*/    ,0x00 , 0x00}, { 19200 /*100 kHz*/    ,0x00 , 0x00},} }, // PA path sel
   { /* 2  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3    ,{ { 18800 /*100 kHz*/    ,0x01 , 0x00}, { 18900 /*100 kHz*/    ,0x01 , 0x00}, { 19000 /*100 kHz*/    ,0x01 , 0x00}, { 19100 /*100 kHz*/    ,0x01 , 0x00}, { 19200 /*100 kHz*/    ,0x01 , 0x00},} }, // PA enable
   { /* 3  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3    ,{ { 18800 /*100 kHz*/    ,0x02 , 0x00}, { 18900 /*100 kHz*/    ,0x02 , 0x00}, { 19000 /*100 kHz*/    ,0x02 , 0x00}, { 19100 /*100 kHz*/    ,0x02 , 0x00}, { 19200 /*100 kHz*/    ,0x02 , 0x00},} }, // Iref
   { /* 4  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3    ,{ { 18800 /*100 kHz*/    ,0x03 , 0x00}, { 18900 /*100 kHz*/    ,0x03 , 0x00}, { 19000 /*100 kHz*/    ,0x03 , 0x00}, { 19100 /*100 kHz*/    ,0x03 , 0x00}, { 19200 /*100 kHz*/    ,0x03 , 0x00},} }, // Iref
   { /* 5  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3    ,{ { 18800 /*100 kHz*/    ,0x00 , 0x00}, { 18900 /*100 kHz*/    ,0x00 , 0x00}, { 19000 /*100 kHz*/    ,0x00 , 0x00}, { 19100 /*100 kHz*/    ,0x00 , 0x00}, { 19200 /*100 kHz*/    ,0x00 , 0x00},} }, // PA disable
   { /* 6  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 18800 /*100 kHz*/    ,0x1C , 0x38}, { 18900 /*100 kHz*/    ,0x1C , 0x38}, { 19000 /*100 kHz*/    ,0x1C , 0x38}, { 19100 /*100 kHz*/    ,0x1C , 0x38}, { 19200 /*100 kHz*/    ,0x1C , 0x38},} }, // ASM PM_Trig: normal mode
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 18800 /*100 kHz*/    ,0x02 , 0x00}, { 18900 /*100 kHz*/    ,0x02 , 0x00}, { 19000 /*100 kHz*/    ,0x02 , 0x00}, { 19100 /*100 kHz*/    ,0x02,  0x00}, { 19200 /*100 kHz*/    ,0x02 , 0x00},} },
   { /* 8  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 18800 /*100 kHz*/    ,0x00 , 0xAF}, { 18900 /*100 kHz*/    ,0x00 , 0xAF}, { 19000 /*100 kHz*/    ,0x00 , 0xAF}, { 19100 /*100 kHz*/    ,0x00 , 0xAF}, { 19200 /*100 kHz*/    ,0x00 , 0xAF},} },
   { /* 9  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 18800 /*100 kHz*/    ,0x01 , 0x28}, { 18900 /*100 kHz*/    ,0x01 , 0x28}, { 19000 /*100 kHz*/    ,0x01 , 0x28}, { 19100 /*100 kHz*/    ,0x01 , 0x28}, { 19200 /*100 kHz*/    ,0x01 , 0x28},} },
   { /* 10 */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 18800 /*100 kHz*/    ,0x04 , 0x13}, { 18900 /*100 kHz*/    ,0x04 , 0x13}, { 19000 /*100 kHz*/    ,0x04 , 0x13}, { 19100 /*100 kHz*/    ,0x04 , 0x13}, { 19200 /*100 kHz*/    ,0x04 , 0x13},} },
   { /* 11 */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3   ,{ { 18800 /*100 kHz*/    ,0x05 , 0x06}, { 18900 /*100 kHz*/    ,0x05 , 0x06}, { 19000 /*100 kHz*/    ,0x05 , 0x06}, { 19100 /*100 kHz*/    ,0x05 , 0x06}, { 19200 /*100 kHz*/    ,0x05 , 0x06},} },
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band40_MIPI_TX_DATA_SetDefault[] =
{
   ...
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3  ,{ { 23000 /*100 kHz*/    ,0x03 , 0x60}, { 23250 /*100 kHz*/    ,0x03 , 0x60}, { 23500 /*100 kHz*/    ,0x03 , 0x60}, { 23750 /*100 kHz*/    ,0x03 , 0x60}, { 24000 /*100 kHz*/    ,0x03 , 0x60},} },
   { /* 8  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3  ,{ { 23000 /*100 kHz*/    ,0x04 , 0x18}, { 23250 /*100 kHz*/    ,0x04 , 0x18}, { 23500 /*100 kHz*/    ,0x04 , 0x18}, { 23750 /*100 kHz*/    ,0x04 , 0x18}, { 24000 /*100 kHz*/    ,0x04 , 0x18},} },
   { /* 9  */ LTE_MIPI_NULL, 0                 , 0             , 0               ,{ { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   },} },
};
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band41_MIPI_TX_DATA_SetDefault[] =
{
   ...
   { /* 7  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3  ,{ { 24960 /*100 kHz*/    ,0x03 , 0x40}, { 25445 /*100 kHz*/    ,0x03 , 0x40}, { 25930 /*100 kHz*/    ,0x03 , 0x40}, { 26415 /*100 kHz*/    ,0x03 , 0x40}, { 26900 /*100 kHz*/    ,0x03 , 0x40},} },
   { /* 8  */ LTE_MIPI_ASM , LTE_MIPI_PORT0    , LTE_REG_W     , MIPI_USID_ASM0_P3  ,{ { 24960 /*100 kHz*/    ,0x04 , 0x18}, { 25445 /*100 kHz*/    ,0x04 , 0x18}, { 25930 /*100 kHz*/    ,0x04 , 0x18}, { 26415 /*100 kHz*/    ,0x04 , 0x18}, { 26900 /*100 kHz*/    ,0x04 , 0x18},} },
   { /* 9  */ LTE_MIPI_NULL, 0                 , 0             , 0               ,{ { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   },} },
};
...
kal_uint32  LTE_MIPI_TX_DATA_SIZE_TABLE_SetDefault[] =
{
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR0,  SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR1,  SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR2,  SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR3,  SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR4,  SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR5,  SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR6,  SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR7,  SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR8,  SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR9,  SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR10, SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR11, SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR12, SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR13, SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR14, SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR15, SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR16, SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR17, SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR18, SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR19, SetDefault)),
   sizeof(LTE_MIPI_TX_DATA(BAND_INDICATOR20, SetDefault)),
};

LTE_MIPI_DATA_SUBBAND_TABLE_T*  LTE_MIPI_TX_DATA_TABLE_SetDefault[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
   LTE_MIPI_TX_DATA(BAND_INDICATOR0,  SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR1,  SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR2,  SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR3,  SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR4,  SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR5,  SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR6,  SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR7,  SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR8,  SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR9,  SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR10, SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR11, SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR12, SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR13, SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR14, SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR15, SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR16, SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR17, SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR18, SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR19, SetDefault),
   LTE_MIPI_TX_DATA(BAND_INDICATOR20, SetDefault),
};
...
LTE_MIPI_EVENT_TABLE_T LTE_Band30_MIPI_TPC_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset    */
   /*                        { start, stop },                      ( us )        */
   { /* 0  */ LTE_MIPI_PA  , { 0    , 1    }, LTE_MIPI_TPC_SET   , US2OFFCNT(8.5)  },
   { /* 1  */ LTE_MIPI_NULL, { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0              },
};
...
kal_uint32  LTE_MIPI_TPC_EVENT_SIZE_TABLE_SetDefault[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR0,  SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR1,  SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR2,  SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR3,  SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR4,  SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR5,  SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR6,  SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR7,  SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR8,  SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR9,  SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR10, SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR11, SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR12, SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR13, SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR14, SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR15, SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR16, SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR17, SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR18, SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR19, SetDefault)),
   sizeof(LTE_MIPI_TPC_EVENT(BAND_INDICATOR20, SetDefault)),
};

LTE_MIPI_EVENT_TABLE_T*  LTE_MIPI_TPC_EVENT_TABLE_SetDefault[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR0,  SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR1,  SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR2,  SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR3,  SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR4,  SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR5,  SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR6,  SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR7,  SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR8,  SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR9,  SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR10, SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR11, SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR12, SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR13, SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR14, SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR15, SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR16, SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR17, SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR18, SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR19, SetDefault),
   LTE_MIPI_TPC_EVENT(BAND_INDICATOR20, SetDefault),
};
...
LTE_MIPI_DATA_TABLE_T*  LTE_MIPI_TPC_DATA_TABLE_SetDefault[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
   LTE_MIPI_TPC_DATA(BAND_INDICATOR0,  SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR1,  SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR2,  SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR3,  SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR4,  SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR5,  SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR6,  SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR7,  SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR8,  SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR9,  SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR10, SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR11, SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR12, SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR13, SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR14, SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR15, SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR16, SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR17, SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR18, SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR19, SetDefault),
   LTE_MIPI_TPC_DATA(BAND_INDICATOR20, SetDefault),
};
...
{
   {
      ...
      MIPI_USID_PA0_P3, /*USID*/
      {
         ...
         {{ { 0x1, 0x47}, { 0x3, 0x86}, { 0x0, 0x1C}, { 0x0, 0x0 }, { 0x0, 0x0 }}},
         {{ { 0x1, 0x97}, { 0x3, 0x86}, { 0x0, 0x1C}, { 0x0, 0x0 }, { 0x0, 0x0 }}},
         {{ { 0x1, 0x00}, { 0x3, 0x00}, { 0x0, 0x00}, { 0x0, 0x0 }, { 0x0, 0x0 }}},//SRS
      }
   },
   {
...
{
   {
      ...
      MIPI_USID_PA1_P3, /*USID*/
      {
         ...
         {{ { 0x1, 0x77}, { 0x3, 0x89}, { 0x0, 0x0D}, { 0x0, 0x0 }, { 0x0, 0x0 }}},
         {{ { 0x1, 0x00}, { 0x3, 0x00}, { 0x0, 0x00}, { 0x0, 0x0 }, { 0x0, 0x0 }}},//SRS
      }
   },
   {
...
{
   {
      ...
      MIPI_USID_ASM0_P3, /*USID*/
      {
         ...
         {{ { 0x5, 0x0F}, { 0x0, 0x8F}, { 0x1, 0x5E},  { 0x0, 0x0 }, { 0x0, 0x0 }}},
         {{ { 0x5, 0x0F}, { 0x0, 0x8F}, { 0x1, 0x5E},  { 0x0, 0x0 }, { 0x0, 0x0 }}},
         {{ { 0x5, 0x01}, { 0x0, 0xAF}, { 0x1, 0x00},  { 0x0, 0x0 }, { 0x0, 0x0 }}},//SRS
      }
   },
   {
      20140, /*100kHz*/
...
{
   {
      ...
      MIPI_USID_ASM0_P3, /*USID*/
      {
         ...
         {{ { 0x5, 0x0F}, { 0x0, 0x8F}, { 0x1, 0x5E},  { 0x0, 0x0 }, { 0x0, 0x0 }}},
         {{ { 0x5, 0x0F}, { 0x0, 0x8F}, { 0x1, 0x5E},  { 0x0, 0x0 }, { 0x0, 0x0 }}},
         {{ { 0x5, 0x00}, { 0x0, 0xAF}, { 0x1, 0x00},  { 0x0, 0x0 }, { 0x0, 0x0 }}},//SRS
      }
   },
   {
      18900, /*100kHz*/
...
kal_uint32  LTE_MIPI_PA_TPC_SECTION_DATA_SIZE_SetDefault[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR0,  SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR1,  SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR2,  SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR3,  SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR4,  SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR5,  SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR6,  SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR7,  SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR8,  SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR9,  SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR10, SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR11, SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR12, SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR13, SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR14, SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR15, SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR16, SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR17, SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR18, SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR19, SetDefault)),
   sizeof(LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR20, SetDefault)),
};

LTE_MIPI_TPC_SECTION_TABLE_T*  LTE_MIPI_PA_TPC_SECTION_DATA_SetDefault[LTE_TARGET_MAX_SUPPORT_BAND_NUM] =
{
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR0,  SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR1,  SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR2,  SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR3,  SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR4,  SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR5,  SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR6,  SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR7,  SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR8,  SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR9,  SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR10, SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR11, SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR12, SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR13, SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR14, SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR15, SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR16, SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR17, SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR18, SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR19, SetDefault),
   LTE_MIPI_PA_SECTION_DATA(BAND_INDICATOR20, SetDefault),
};
...
LTE_MIPI_EVENT_TABLE_T LTE_BandNone_MIPI_BYPASS_TX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset     */
   /*                        { start, stop },                      ( us )         */
   { /* 0  */ LTE_MIPI_NULL, { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0              },
...
LTE_MIPI_EVENT_TABLE_T LTE_Band38_MIPI_BYPASS_TX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset              */
   /*                        { start, stop },                      ( us )                  */
   { /* 0  */ LTE_MIPI_PA  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_PA_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band40_MIPI_BYPASS_TX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset              */
   /*                        { start, stop },                      ( us )                  */
   { /* 0  */ LTE_MIPI_PA  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_PA_TX_ON0_SetDefault  }, //PA On
...
LTE_MIPI_EVENT_TABLE_T LTE_Band41_MIPI_BYPASS_TX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset              */
   /*                        { start, stop },                      ( us )                  */
   { /* 0  */ LTE_MIPI_PA  , { 0    , 4    }, LTE_MIPI_TRX_ON    , LTE_TDD_MIPI_PA_TX_ON0_SetDefault  }, //PA On
...
kal_uint32  LTE_MIPI_BYPASS_TX_EVENT_SIZE_TABLE_SetDefault[] =
{
   sizeof(LTE_MIPI_BYPASS_TX_EVENT(BAND_BYPASS_INDICATOR0, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_TX_EVENT(BAND_BYPASS_INDICATOR1, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_TX_EVENT(BAND_BYPASS_INDICATOR2, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_TX_EVENT(BAND_BYPASS_INDICATOR3, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_TX_EVENT(BAND_BYPASS_INDICATOR4, SetDefault)),
};

LTE_MIPI_EVENT_TABLE_T*  LTE_MIPI_BYPASS_TX_EVENT_TABLE_SetDefault[] =
{
   LTE_MIPI_BYPASS_TX_EVENT(BAND_BYPASS_INDICATOR0, SetDefault),
   LTE_MIPI_BYPASS_TX_EVENT(BAND_BYPASS_INDICATOR1, SetDefault),
   LTE_MIPI_BYPASS_TX_EVENT(BAND_BYPASS_INDICATOR2, SetDefault),
   LTE_MIPI_BYPASS_TX_EVENT(BAND_BYPASS_INDICATOR3, SetDefault),
   LTE_MIPI_BYPASS_TX_EVENT(BAND_BYPASS_INDICATOR4, SetDefault),
};

/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */

LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_BandNone_MIPI_BYPASS_TX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband earfcn /*0*/ ,addr ,data }, { subband earfcn /*1*/ ,addr ,data }, { subband earfcn /*2*/ ,addr ,data }, { subband earfcn /*3*/ ,addr ,data }, { subband earfcn /*4*/ ,addr ,data } },
   { /* 0  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ { 0 /*100 kHz*/        ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   }, { 0     /*100 kHz*/    ,0    , 0   },} }, // ASM PM_Trig: normal mode
};

LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band38_MIPI_BYPASS_TX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband earfcn /*0*/ ,addr ,data }, { subband earfcn /*1*/ ,addr ,data }, { subband earfcn /*2*/ ,addr ,data }, { subband earfcn /*3*/ ,addr ,data }, { subband earfcn /*4*/ ,addr ,data } },
   { /* 0  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3   ,{ { 25700 /*100 kHz*/    ,0x1C , 0x38}, { 25825 /*100 kHz*/    ,0x1C , 0x38}, { 25950 /*100 kHz*/    ,0x1C , 0x38}, { 26075 /*100 kHz*/    ,0x1C , 0x38}, { 26200 /*100 kHz*/    ,0x1C , 0x38},} }, // PA On PM_Trig: normal mode
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band40_MIPI_BYPASS_TX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband earfcn /*0*/ ,addr ,data }, { subband earfcn /*1*/ ,addr ,data }, { subband earfcn /*2*/ ,addr ,data }, { subband earfcn /*3*/ ,addr ,data }, { subband earfcn /*4*/ ,addr ,data } },
   { /* 0  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3   ,{ { 23000 /*100 kHz*/    ,0x1C , 0x38}, { 23250 /*100 kHz*/    ,0x1C , 0x38}, { 23500 /*100 kHz*/    ,0x1C , 0x38}, { 23750 /*100 kHz*/    ,0x1C , 0x38}, { 24000 /*100 kHz*/    ,0x1C , 0x38},} }, // PA On PM_Trig: normal mode
   { /* 1  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3   ,{ { 23000 /*100 kHz*/    ,0x00 , 0x44}, { 23250 /*100 kHz*/    ,0x00 , 0x44}, { 23500 /*100 kHz*/    ,0x00 , 0x44}, { 23750 /*100 kHz*/    ,0x00 , 0x44}, { 24000 /*100 kHz*/    ,0x00 , 0x44},} }, // PA path sel
...
LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band41_MIPI_BYPASS_TX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband earfcn /*0*/ ,addr ,data }, { subband earfcn /*1*/ ,addr ,data }, { subband earfcn /*2*/ ,addr ,data }, { subband earfcn /*3*/ ,addr ,data }, { subband earfcn /*4*/ ,addr ,data } },
   { /* 0  */ LTE_MIPI_PA  , LTE_MIPI_PORT1    , LTE_REG_W     , MIPI_USID_PA0_P3   ,{ { 24960 /*100 kHz*/    ,0x1C , 0x38}, { 25445 /*100 kHz*/    ,0x1C , 0x38}, { 25930 /*100 kHz*/    ,0x1C , 0x38}, { 26415 /*100 kHz*/    ,0x1C , 0x38}, { 26900 /*100 kHz*/    ,0x1C , 0x38},} }, // PA On PM_Trig: normal mode
...
kal_uint32  LTE_MIPI_BYPASS_TX_DATA_SIZE_TABLE_SetDefault[] =
{
   sizeof(LTE_MIPI_BYPASS_TX_DATA(BAND_BYPASS_INDICATOR0, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_TX_DATA(BAND_BYPASS_INDICATOR1, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_TX_DATA(BAND_BYPASS_INDICATOR2, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_TX_DATA(BAND_BYPASS_INDICATOR3, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_TX_DATA(BAND_BYPASS_INDICATOR4, SetDefault)),
};

LTE_MIPI_DATA_SUBBAND_TABLE_T*  LTE_MIPI_BYPASS_TX_DATA_TABLE_SetDefault[] =
{
   LTE_MIPI_BYPASS_TX_DATA(BAND_BYPASS_INDICATOR0, SetDefault),
   LTE_MIPI_BYPASS_TX_DATA(BAND_BYPASS_INDICATOR1, SetDefault),
   LTE_MIPI_BYPASS_TX_DATA(BAND_BYPASS_INDICATOR2, SetDefault),
   LTE_MIPI_BYPASS_TX_DATA(BAND_BYPASS_INDICATOR3, SetDefault),
   LTE_MIPI_BYPASS_TX_DATA(BAND_BYPASS_INDICATOR4, SetDefault),
};

/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */

LTE_MIPI_EVENT_TABLE_T LTE_BandNone_MIPI_BYPASS_TPC_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset     */
   /*                        { start, stop },                      ( us )         */
   { /* 0  */ LTE_MIPI_NULL, { 0    , 0    }, LTE_MIPI_EVENT_NULL, 0              },
...
LTE_MIPI_EVENT_TABLE_T LTE_Band38_MIPI_BYPASS_TPC_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset     */
   /*                        { start, stop },                      ( us )         */
...
LTE_MIPI_EVENT_TABLE_T LTE_Band40_MIPI_BYPASS_TPC_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset     */
   /*                        { start, stop },                      ( us )         */
   { /* 0  */ LTE_MIPI_PA  , { 0    , 2    }, LTE_MIPI_TPC_SET   , US2OFFCNT(9)   },
...
LTE_MIPI_EVENT_TABLE_T LTE_Band41_MIPI_BYPASS_TPC_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset     */
   /*                        { start, stop },                      ( us )         */
   { /* 0  */ LTE_MIPI_PA  , { 0    , 2    }, LTE_MIPI_TPC_SET   , US2OFFCNT(9)   },
...
kal_uint32  LTE_MIPI_BYPASS_TPC_EVENT_SIZE_TABLE_SetDefault[] =
{
   sizeof(LTE_MIPI_BYPASS_TPC_EVENT(BAND_BYPASS_INDICATOR0, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_TPC_EVENT(BAND_BYPASS_INDICATOR1, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_TPC_EVENT(BAND_BYPASS_INDICATOR2, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_TPC_EVENT(BAND_BYPASS_INDICATOR3, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_TPC_EVENT(BAND_BYPASS_INDICATOR4, SetDefault)),
};

LTE_MIPI_EVENT_TABLE_T*  LTE_MIPI_BYPASS_TPC_EVENT_TABLE_SetDefault[] =
{
   LTE_MIPI_BYPASS_TPC_EVENT(BAND_BYPASS_INDICATOR0, SetDefault),
   LTE_MIPI_BYPASS_TPC_EVENT(BAND_BYPASS_INDICATOR1, SetDefault),
   LTE_MIPI_BYPASS_TPC_EVENT(BAND_BYPASS_INDICATOR2, SetDefault),
   LTE_MIPI_BYPASS_TPC_EVENT(BAND_BYPASS_INDICATOR3, SetDefault),
   LTE_MIPI_BYPASS_TPC_EVENT(BAND_BYPASS_INDICATOR4, SetDefault),
};

/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */

LTE_MIPI_DATA_TABLE_T LTE_BandNone_MIPI_BYPASS_TPC_DATA_SetDefault[] =
{
   //No.     elm type       , port_sel         , data_seq    , USID                         , address                      , data
   {/* 0  */ LTE_MIPI_NULL  , 0                , 0           , 0                            , 0                            , 0                        },
};

LTE_MIPI_DATA_TABLE_T LTE_Band38_MIPI_BYPASS_TPC_DATA_SetDefault[] =
{
   //No.     elm type       , port_sel         , data_seq    , USID                         , address                      , data
   {/* 0  */ LTE_MIPI_PA_SEC, LTE_MIPI_PORT1   , LTE_REG_W   , LTE_MIPI_PA_SECTION_USID     , LTE_MIPI_PA_SECTION_ADDRESS  , LTE_MIPI_PA_SECTION_DATA0}, // PA On Band Select
   {/* 1  */ LTE_MIPI_PA_SEC, LTE_MIPI_PORT1   , LTE_REG_W   , LTE_MIPI_PA_SECTION_USID     , LTE_MIPI_PA_SECTION_ADDRESS  , LTE_MIPI_PA_SECTION_DATA1}, // Data ref. by PA Section table idx 0
...
LTE_MIPI_DATA_TABLE_T LTE_Band40_MIPI_BYPASS_TPC_DATA_SetDefault[] =
{
   //No.     elm type       , port_sel         , data_seq    , USID                         , address                      , data
   {/* 0  */ LTE_MIPI_PA_SEC, LTE_MIPI_PORT1   , LTE_REG_W   , LTE_MIPI_PA_SECTION_USID     , LTE_MIPI_PA_SECTION_ADDRESS  , LTE_MIPI_PA_SECTION_DATA0}, // PA On Band Select
   {/* 1  */ LTE_MIPI_PA_SEC, LTE_MIPI_PORT1   , LTE_REG_W   , LTE_MIPI_PA_SECTION_USID     , LTE_MIPI_PA_SECTION_ADDRESS  , LTE_MIPI_PA_SECTION_DATA1}, // Data ref. by PA Section table idx 0
...
LTE_MIPI_DATA_TABLE_T LTE_Band41_MIPI_BYPASS_TPC_DATA_SetDefault[] =
{
   //No.     elm type       , port_sel         , data_seq    , USID                         , address                      , data
   {/* 0  */ LTE_MIPI_PA_SEC, LTE_MIPI_PORT1   , LTE_REG_W   , LTE_MIPI_PA_SECTION_USID     , LTE_MIPI_PA_SECTION_ADDRESS  , LTE_MIPI_PA_SECTION_DATA0}, // PA On Band Select
   {/* 1  */ LTE_MIPI_PA_SEC, LTE_MIPI_PORT1   , LTE_REG_W   , LTE_MIPI_PA_SECTION_USID     , LTE_MIPI_PA_SECTION_ADDRESS  , LTE_MIPI_PA_SECTION_DATA1}, // Data ref. by PA Section table idx 0
...
kal_uint32  LTE_MIPI_BYPASS_TPC_DATA_SIZE_TABLE_SetDefault[] =
{
   sizeof(LTE_MIPI_BYPASS_TPC_DATA(BAND_BYPASS_INDICATOR0, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_TPC_DATA(BAND_BYPASS_INDICATOR1, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_TPC_DATA(BAND_BYPASS_INDICATOR2, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_TPC_DATA(BAND_BYPASS_INDICATOR3, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_TPC_DATA(BAND_BYPASS_INDICATOR4, SetDefault)),
};

LTE_MIPI_DATA_TABLE_T*  LTE_MIPI_BYPASS_TPC_DATA_TABLE_SetDefault[] =
{
   LTE_MIPI_BYPASS_TPC_DATA(BAND_BYPASS_INDICATOR0, SetDefault),
   LTE_MIPI_BYPASS_TPC_DATA(BAND_BYPASS_INDICATOR1, SetDefault),
   LTE_MIPI_BYPASS_TPC_DATA(BAND_BYPASS_INDICATOR2, SetDefault),
   LTE_MIPI_BYPASS_TPC_DATA(BAND_BYPASS_INDICATOR3, SetDefault),
   LTE_MIPI_BYPASS_TPC_DATA(BAND_BYPASS_INDICATOR4, SetDefault),
};

/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */

LTE_MIPI_TPC_SECTION_TABLE_T LTE_BandNone_MIPI_BYPASS_PA_SECTION_DATA_SetDefault[] =
{
   /*8714 KHz*/
   {
      0,/*100kHz*/
...
LTE_MIPI_TPC_SECTION_TABLE_T LTE_Band38_MIPI_BYPASS_PA_SECTION_DATA_SetDefault[] =
{
   /*8714 KHz*/
   {
      25700,/*100kHz*/
...
LTE_MIPI_TPC_SECTION_TABLE_T LTE_Band40_MIPI_BYPASS_PA_SECTION_DATA_SetDefault[] =
{
   /*8714 KHz*/
   {
      23000,/*100kHz*/
...
LTE_MIPI_TPC_SECTION_TABLE_T LTE_Band41_MIPI_BYPASS_PA_SECTION_DATA_SetDefault[] =
{
   /*8714 KHz*/
   {
      24960,/*100kHz*/
...
kal_uint32  LTE_MIPI_BYPASS_PA_TPC_SECTION_DATA_SIZE_SetDefault[] =
{
   sizeof(LTE_MIPI_BYPASS_PA_SECTION_DATA(BAND_BYPASS_INDICATOR0, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_PA_SECTION_DATA(BAND_BYPASS_INDICATOR1, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_PA_SECTION_DATA(BAND_BYPASS_INDICATOR2, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_PA_SECTION_DATA(BAND_BYPASS_INDICATOR3, SetDefault)),
   sizeof(LTE_MIPI_BYPASS_PA_SECTION_DATA(BAND_BYPASS_INDICATOR4, SetDefault)),
};

LTE_MIPI_TPC_SECTION_TABLE_T*  LTE_MIPI_BYPASS_PA_TPC_SECTION_DATA_SetDefault[] =
{
   LTE_MIPI_BYPASS_PA_SECTION_DATA(BAND_BYPASS_INDICATOR0, SetDefault),
   LTE_MIPI_BYPASS_PA_SECTION_DATA(BAND_BYPASS_INDICATOR1, SetDefault),
   LTE_MIPI_BYPASS_PA_SECTION_DATA(BAND_BYPASS_INDICATOR2, SetDefault),
   LTE_MIPI_BYPASS_PA_SECTION_DATA(BAND_BYPASS_INDICATOR3, SetDefault),
   LTE_MIPI_BYPASS_PA_SECTION_DATA(BAND_BYPASS_INDICATOR4, SetDefault),
};
