...
//DRDI todo, low P3 bring up risk. when DRDI is enable, make sure change these P2 USID MACRO to P2 setting.
#define MIPI_USID_INIT0           0x0000
#define MIPI_USID_ASM0            0x000E    //3P18T for Main
#define MIPI_USID_ASM1            0x000A    //DP12T for Div
#define MIPI_USID_ASM2            0x000F
#define MIPI_USID_ASM3            0x0009
#define MIPI_USID_PA0             0x000F    //MH PA
#define MIPI_USID_PA1             0x000C    //LPA
