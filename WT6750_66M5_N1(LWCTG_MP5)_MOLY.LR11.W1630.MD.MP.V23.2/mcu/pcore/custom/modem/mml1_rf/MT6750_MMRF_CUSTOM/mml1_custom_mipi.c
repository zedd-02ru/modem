...
const MML1_MIPI_INITIAL_CW_T ET_MML1_MIPI_INITIAL_CW_SetDefault[ ET_MML1_MIPI_MAX_INITIAL_CW_NUM ] =
{
...
// Please remember to FULLY fill in the "MML1_MIPI_END_PATTERN" in this table.
