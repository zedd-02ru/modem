...
kal_bool nwsel_custom_allow_rplmn_hplmn_combined_search(void)
{
    ...
    */
    ...
    {
        if( gmss_is_tdscdma_mode_activated() == KAL_TRUE) /*for TDD project, this compile option is open*/
        {
            return KAL_FALSE;
        }
        else
 ...
 *************************************************************************/
kal_uint32 NWSEL_BD_MCC_LIST[][NUM_OF_BD_MCC] = {{234,460}};
nwsel_custom_sim_operator_enum NWSEL_BD_SIM_LIST[] = {CUTSOM_SIM_VZW};
...
const char *CUSTOM_NWSEL_EHPLMN_LIST[][CUSTOM_NWSEL_EHPLMN_MAX_NUM] = {
                                        {"46011F","46003F","45507F","FFFFFF","FFFFFF"},  //CT
                                        {"46000F","46002F","46004F","46007F","46008F"},  //CMCC
                                        {"52005F","52018F","FFFFFF","FFFFFF","FFFFFF"},  //DTAC
...
const kal_uint32 NWSEL_UAS_SNIFF_GUARD_TIMER_PERIOD = 2 * KAL_TICKS_1_MIN;
