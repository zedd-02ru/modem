...
*
*****************************************************************************/
const char *CONFIGURE_SKIP_LU_AFTER_CSFB_FOR_EAFR_PLMN[] = {"25002F","71006F","71010F","71017F", CONFIGURE_SKIP_LU_AFTER_CSFB_FOR_EAFR_PLMN_END};
...
*
*****************************************************************************/
kal_uint8 mm_custom_get_customize_cause(kal_uint8 cause, mm_custom_proc_type proc, kal_bool is_on_hplmn, kal_bool is_test)
{
