...
const kal_uint16 GMSS_CUSTOM_SPRINT_MPSR_TIMER_VALUE_SECS = 1*60;   // default 1 mintues
...
/*************************************************************************
* Telescope MPSR default value 
*
*   Telescope MPSR default value if not setting in NVRAM.
*
*************************************************************************/
...
/*************************************************************************
* Duplex mode switch timer interval
*
...
const kal_uint16 CUSTOM_DUPLEX_MODE_SWITCH_TIMER_INTERVAL[CUSTOM_DUPLEX_MODE_SWITCH_TIMER_NUM] =
{
    /* The unit is second */
...
*************************************************************************/
const kal_uint16 GMSS_CUSTOM_DUPLEX_MODE_DELAY_TIMER_VALUE_SECS = 20;
...
*************************************************************************/
const kal_uint16 GMSS_CUSTOM_DUPLEX_MODE_CSFB_TIMER_VALUE_SECS = 5*60;

/*************************************************************************
* Duplex mode network status timer
*
*   If SBP_GEMINI_LG_WG_MODE is turned on and auto switch policy is applied.
*
*   To avoid changing duplex mode frequently while network status changes rapidly,
*   this timer is used to wait for network status becoming stable.
*
* Note: This value should NOT be 0, minimum value is 2 mins 
*************************************************************************/
const kal_uint16 GMSS_CUSTOM_DUPLEX_MODE_NW_STATUS_TIMER_VALUE_SECS = 5*60;

/*************************************************************************
* Duplex mode CU OOS timer
*
*   If SBP_GEMINI_LG_WG_MODE is turned on and auto switch policy is applied.
*
*   While CU OOS timer running, UE will not try to switch duplex mode to FDD mode. 
*
* Note: This value should NOT be 0, minimum value is 10 mins 
*************************************************************************/
const kal_uint16 GMSS_CUSTOM_DUPLEX_MODE_CU_OOS_TIMER_VALUE_MINS = 30;
...
const kal_uint16 CUSTOM_VZW_REDUCE_3G_IDLE_MPSR_TIMER_INTERVAL[CUSTOM_VZW_REDUCE_3G_IDLE_MPSR_TIMER_TIMER_NUM] =
{
    /* The unit is second */
...
*************************************************************************/
const char *CUSTOM_CT_HPLMN[] = {"46011F", "46003F", "45502F", "45507F", CUSTOM_PLMN_SET_END};
const char *CUSTOM_VZW_HPLMN[] = {"311480","310028", "311390", CUSTOM_PLMN_SET_END}; // 310028/311390 are added for NSN/Ericsson IOT
const char *CUSTOM_SPRINT_HPLMN[] = {"310120", "311490", CUSTOM_PLMN_SET_END};
...
const kal_uint16 CUSTOM_CT_SRLTE_MCC_LIST_4M[] = {460, 455, CUSTOM_MCC_SET_END};
const kal_uint16 CUSTOM_US_SRLTE_MCC_LIST[] = {310, 311, 312, 313, 314, 315, 316, CUSTOM_MCC_SET_END};
