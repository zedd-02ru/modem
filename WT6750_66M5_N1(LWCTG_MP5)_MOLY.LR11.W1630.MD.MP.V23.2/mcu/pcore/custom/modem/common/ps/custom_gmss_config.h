...
#define CUSTOM_MCC_SET_END 0xFFFF

extern const kal_uint16 CUSTOM_BORDER_MCC_PREFER_LIST_CHINA[];
extern const kal_uint16 CUSTOM_CT_SRLTE_MCC_LIST[];
extern const kal_uint16 CUSTOM_CT_SRLTE_MCC_LIST_4M[];
extern const kal_uint16 CUSTOM_US_SRLTE_MCC_LIST[];
extern const kal_uint16 CUSTOM_SMARTFREN_SRLTE_MCC_LIST[];

#define CUSTOM_DUPLEX_MODE_SWITCH_TIMER_NUM 10  /* shall be 1 ~ 255 */
extern const kal_uint16 CUSTOM_DUPLEX_MODE_SWITCH_TIMER_INTERVAL[];
#ifdef __GEMINI_WCDMA_WORLD_PHONE__
extern const kal_uint16 GMSS_CUSTOM_DUPLEX_MODE_DELAY_TIMER_VALUE_SECS;
extern const kal_uint16 GMSS_CUSTOM_DUPLEX_MODE_CSFB_TIMER_VALUE_SECS;
extern const kal_uint16 GMSS_CUSTOM_DUPLEX_MODE_NW_STATUS_TIMER_VALUE_SECS;
extern const kal_uint16 GMSS_CUSTOM_DUPLEX_MODE_CU_OOS_TIMER_VALUE_MINS;
#else
extern const kal_uint16 GMSS_CUSTOM_DUPLEX_MODE_DELAY_TIMER_VALUE_SECS;
#endif

#define CUSTOM_VZW_REDUCE_3G_IDLE_MPSR_TIMER_TIMER_NUM 10 
