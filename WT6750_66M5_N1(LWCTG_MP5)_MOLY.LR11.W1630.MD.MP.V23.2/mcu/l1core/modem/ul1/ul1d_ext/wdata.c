...
#if IS_3G_ET_SUPPORT
kal_bool is_3g_et_enable = KAL_FALSE;
kal_uint32 etCwValueDumpAllTable[UL1_MIPI_ET_CW_NUM];
kal_uint32 etCwAddrDump[UL1_MIPI_ET_CW_NUM] = {0x00, 0x6D, 0xFF, 0xFF, 0xFF};
...
/* TAS Table Declare in L1CORE */
#if IS_3G_FORCE_TX_ANT_SUPPORT
UMTS_TAS_Configuration_T UMTS_TAS_Configuration_Table = {0, 0, 0, 0, {0}, 0, 0};
#else
UMTS_TAS_Configuration_T UMTS_TAS_Configuration_Table = {0, 0, 0, 0, {0}};
#endif
U_sUl1dRfTasData UMTS_TAS_RF_TABLE = {0, {0}};
BPI_data_type    UMTS_TAS_PDATA_TABLE[UL1D_RF_CUSTOM_BAND][UL1_ANTENNA_NUM+1] = {{0}};
...
/*TAS RF parameter pointer*/
U_sUl1dRfTasData *UMTS_TAS_RF_TABLE_ptr;

/*TAS configuration parameter pointer*/
UMTS_TAS_Configuration_T *UMTS_TAS_Configuration_Table_ptr;
#endif/*IS_3G_TAS_NVRAM_SUPPORT*/

#if (IS_3G_TAS_ANTENNA_IDX_ON_TEST_SIM)
UMTS_TAS_ANT_IDX_T *UMTS_TAS_ANT_IDX_ptr;
#endif
...
#if IS_3G_ELNA_SUPPORT
U_sUl1DElnaSetting   *UMTS_ELNA_DATA_ptr;
#endif
