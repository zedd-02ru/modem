...
typedef enum
{
   ...
   MML1_RF_DUMP_RFCW_SYSPLL               = 0x00002000,
   MML1_BBREG_DUMP_CALLBACK_SYSPLL        = 0x00004000,
   MMRF_INIT_PHASE_SYSPLL                 = 0x00008000,
   MMRF_RF_BPI_CONFLICT_CLEAR_SYSPLL      = 0x00010000
...
#if IS_MML1_ABB_TXDAC_CAL_ONLY_IN_FIRST_BOOT
void MML1_RF_ABB_TXDAC_Abnormal_WorkAround(void);
#endif
