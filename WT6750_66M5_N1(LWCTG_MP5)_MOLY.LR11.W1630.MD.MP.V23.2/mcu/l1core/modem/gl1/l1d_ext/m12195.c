 ...
 *
 * 03 06 2017 yw.chen
 * [MOLY00233721] [L1D] Fix force ant index wrong in TAS TEST SIM mode
 * .
 *
 * 02 07 2017 yw.chen
 ...
 *
 * 04 21 2016 siyu.li
 * [MOLY00170445] META_MMRf_ForceTasSwitch_r ????TAS
 * .
 *
 * 12 09 2015 wiley.li
 ...
 *
 * 09 14 2015 yw.chen
 * [MOLY00141726] [L1D][Modify] META TAS modify TAS build warning
 * .
 *
 * 09 10 2015 yw.chen
 * [MOLY00141300] [L1D][Modify] TAS META feature
 * .
 *
 * 09 10 2015 wiley.li
 ...
 *
 * 08 17 2015 wiley.li
 * [MOLY00137520] [L1D][Modify] Turn on POC FIIQ gain/phase && Update RX CW399
 * 	.
 *
 * 07 21 2015 wiley.li
 * [MOLY00127251] [L1D][Modify] Update 2G Driver (Update RX CW322)
 * 	.
 *
 * 07 16 2015 sherman.chung
 * [MOLY00129324] [L1D] 2G TAS Feature improve
 * .
 *
 * 07 13 2015 wiley.li
 ...
 * 	.
 *
 * 06 16 2015 umesh.donta
 * [MOLY00121445] [L1D][modify]Check in Xl1Sim Build error fix related to GL1D.
 * 	.
 *
 * 05 29 2015 ola.lee
 * [MOLY00113751] [TK6291E1][Pre-Sanity][Blocking][4G][TDD] can't make MO and MT calls (CSFB)
 * Update 2G TX LO Subband.
 *
 ...
 *
 * 04 17 2014 yi-ying.lin
 * [MOLY00063005] [L1D][Modify] Fix NDCS band indicator trace as receiving RX burst
 * 	.
 *
 ...
 *
 * 11 15 2013 ola.lee
 * [MOLY00046579] [L1D] Enable NDCS BPI/LNA Setting for MT6165
 * 	.
 *
 * 10 07 2013 sean.yang
 * [MOLY00040358] [L1D][Modify] MT6169 E3 modification
 * 	.
 *
 * 10 03 2013 vend_paul.chen
 * [MOLY00039956] MT6290 E1 3G/2G call drop in high temperature test
 * 	[MT6290][2G RF driver] set 6169 E1/E1ECO CW114, SRX_VCO_I to "0".
 *
 * 10 02 2013 vend_paul.chen
 * [MOLY00037129] [MT6169 E3] majorly for 3G/2G E3 change
 ...
 * 	.
 *
 * 09 18 2013 vend_paul.chen
 * [MOLY00037129] [MT6169 E3] majorly for 3G/2G E3 change
 * 	[MT6290][2G RF driver] update CW114 SRX_VCO_I from 4 to 0.
 *
 * 09 10 2013 chunyen.wu
 * [MOLY00037209] [L1D][Modify] MT6169 E3 modify CW53 CW2
 * 	.
 *
...
#define  HWRITE_21_SDATA( ctrl1, data1, ctrl2, data2, ctrl3, data3, ctrl4, data4, ctrl5, data5, ctrl6, data6, ctrl7, data7, ctrl8, data8, ctrl9, data9, ctrl10, data10, ctrl11, data11, ctrl12, data12, ctrl13, data13, ctrl14, data14, ctrl15, data15, ctrl16, data16, ctrl17, data17, ctrl18, data18, ctrl19, data19, ctrl20, data20, ctrl21, data21 )  \
{  HW_WRITE_BSI_DATA_21( data_idx, ((ctrl1 )), (data1 ),                      \
                                   ((ctrl2 )), (data2 ),                      \
                                   ((ctrl3 )), (data3 ),                      \
                                   ((ctrl4 )), (data4 ),                      \
                                   ((ctrl5 )), (data5 ),                      \
...
#define  HWRITE_27_SDATA( ctrl1, data1, ctrl2, data2, ctrl3, data3, ctrl4, data4, ctrl5, data5, ctrl6, data6, ctrl7, data7, ctrl8, data8, ctrl9, data9, ctrl10, data10, ctrl11, data11, ctrl12, data12, ctrl13, data13, ctrl14, data14, ctrl15, data15, ctrl16, data16, ctrl17, data17, ctrl18, data18, ctrl19, data19, ctrl20, data20, ctrl21, data21, ctrl22, data22, ctrl23, data23, ctrl24, data24, ctrl25, data25, ctrl26, data26, ctrl27, data27 )  \
{  HW_WRITE_BSI_DATA_27( data_idx, ((ctrl1 )), (data1 ),                      \
                                   ((ctrl2 )), (data2 ),                      \
                                   ((ctrl3 )), (data3 ),                      \
                                   ((ctrl4 )), (data4 ),                      \
                                   ((ctrl5 )), (data5 ),                      \
...
#elif IS_RF_MT6176
   #if IS_2G_INCREASE_VS1_VOLTAGE_SUPPORT
   L1D_RF_SetSData_FSIWinOff_SR3( idx );
   #else
   HW_WRITE_BSI_DATA( FSWIN_STOP_BSI_REG_TABLE[idx], FSWIN_STOP_BSI_DATA_TABLE[0] );
   #endif
...
#define TAS_ANT_SEL (L1D_CheckIfMetaMode())?((L1_TAS_Custom_Params.FORCE_TX_ANTENNA_ENABLE) ? (L1_TAS_Custom_Params.FORCE_TX_ANTENNA_IDX): (l1d_rf.tas_ant_sel) ):(l1d_rf.tas_ant_sel)
      #if IS_BPI_DATA_48_BIT_CHIP
#define TAS_BPI_MASK       ((TAS_ANT_SEL>=1)?L1_TAS_Custom_PData.pdata_tas_mask:0x000000000000LL)
      #else
#define TAS_BPI_MASK       ((TAS_ANT_SEL>=1)?L1_TAS_Custom_PData.pdata_tas_mask:0x00000000)
      #endif
#define GET_TAS_BPI        ((TAS_ANT_SEL>=1)?L1_TAS_Custom_PData.pdata_band_tas[l1d_rf.band][(TAS_ANT_SEL-1)]:0)
#else
   #if IS_BPI_DATA_48_BIT_CHIP
#define TAS_BPI_MASK       (0x000000000000LL)
#define GET_TAS_BPI        (0x000000000000LL)
   #else
#define TAS_BPI_MASK       (0x00000000)
#define GET_TAS_BPI        (0x00000000)
   #endif
#endif
...
void  L1D_RF_SetPData_PR( void )
{
 ...
 #if (IS_2G_TAS_SUPPORT||IS_2G_TAS_FOR_C2K_ONOFF_SUPPORT)
   if(L1D_CheckIfMetaMode() && (L1_TAS_Custom_Params.FORCE_TX_ANTENNA_ENABLE))
   {
      tas_ant_sel = L1_TAS_Custom_Params.FORCE_TX_ANTENNA_IDX;

      #if IS_2G_ALTERNATIVE_RX_PATH_SUPPORT
      /* For TAS algorithm, TX/RX must stay on the same antenna. */
      /* If using DRX path, need to auto reverse TAS BPI setting (Just for 1 DPDT usage)*/
      if( L1D_RF_RXPath_Idx( l1d_rf.band )==1 )
      {  tas_ant_sel = (tas_ant_sel==1)? 0 : 1;  }   //"1 to 0", "0 to 1",  "other to 1 (auto reversing to primary antenna)".
      #endif
   }
   else
   {
      tas_ant_sel = l1d_rf.tas_ant_sel;
      #if (IS_2G_TAS_ANT_IDX_SET_ON_TEST_SIM && IS_2G_TAS_TEST_SIM_OPTIMIZE_SUPPORT)
      ...
      {
         tas_ant_sel = L1_TAS_Init_Ant_Params.TAS_INIT_ANT_IDX[l1d_rf.band];
      }
      #endif
   ...
   if(tas_ant_sel>=1)
   {
      tas_mask=L1_TAS_Custom_PData.pdata_tas_mask;
      tas_bpi=L1_TAS_Custom_PData.pdata_band_tas[l1d_rf.band][(tas_ant_sel-1)];
   ...
   _regL = PDATA_REG_TABLE[ l1d_rf.cwin_idx ];
   _regH = _regL + BPI_REG_HL;
   #if IS_DCS_NB_WB_SWITCH_SUPPORT
   if( L1D_RF_IS_DCS_Change_to_NB() )
   {  _d64p = PDATA_TABLE[ 0 ][ RF_RX ];            }
   else
   #endif
   {  _d64p = PDATA_TABLE[ l1d_rf.band ][ RF_RX ];  }

   HW_WRITE( _regL,  (((*_d64p)&(~tas_mask))|tas_bpi )     &0xFFFFFFFF );  /* PR1 */
   HW_WRITE( _regH, ((((*_d64p)&(~tas_mask))|tas_bpi )>>32)&0xFFFFFFFF );  _regL+=BPI_REG_IDX;  _regH=_regL+BPI_REG_HL;  _d64p++;
   HW_WRITE( _regL,  (((*_d64p)&(~tas_mask))|tas_bpi )     &0xFFFFFFFF );  /* PR2 */
   HW_WRITE( _regH, ((((*_d64p)&(~tas_mask))|tas_bpi )>>32)&0xFFFFFFFF );  _regL+=BPI_REG_IDX;  _regH=_regL+BPI_REG_HL;  _d64p++;
   HW_WRITE( _regL,  (((*_d64p)&(~tas_mask))|tas_bpi )     &0xFFFFFFFF );  /* PR2B */
   HW_WRITE( _regH, ((((*_d64p)&(~tas_mask))|tas_bpi )>>32)&0xFFFFFFFF );  _regL+=BPI_REG_IDX;  _regH=_regL+BPI_REG_HL;  _d64p++;
   HW_WRITE( _regL,  (*_d64p)     &0xFFFFFFFF );  /* PR3 */
   HW_WRITE( _regH, ((*_d64p)>>32)&0xFFFFFFFF );
   
   _regL = PDATA_REG_TABLE2[ l1d_rf.cwin_idx ];                        _regH=_regL+BPI_REG_HL;  _d64p++;
   HW_WRITE( _regL,  (*_d64p)     &0xFFFFFFFF );  /* PR3A */
   HW_WRITE( _regH, ((*_d64p)>>32)&0xFFFFFFFF );
}
...
void  L1D_RF_SetPData_PT( void )
{
   ...
   {  pdata_mod = pdata_8psk;  }
   else
   {  pdata_mod = pdata_gmsk;  }

   _regL = PDATA_REG_TABLE[ l1d_rf.cwin_idx ];
   _regH = _regL + BPI_REG_HL;
   _d64p = PDATA_TABLE[ l1d_rf.band ][ RF_TX ];  d64=(*_d64p)|pdata_mod;
   
   HW_WRITE( _regL,  (((d64)&(~tas_mask))|tas_bpi )     &0xFFFFFFFF );  /* PT1 */
   HW_WRITE( _regH, ((((d64)&(~tas_mask))|tas_bpi )>>32)&0xFFFFFFFF );  _regL+=BPI_REG_IDX;  _regH=_regL+BPI_REG_HL;  _d64p++;  d64=(*_d64p)|pdata_mod;
   HW_WRITE( _regL,  (((d64)&(~tas_mask))|tas_bpi )     &0xFFFFFFFF );  /* PT2 */
   HW_WRITE( _regH, ((((d64)&(~tas_mask))|tas_bpi )>>32)&0xFFFFFFFF );  _regL+=BPI_REG_IDX;  _regH=_regL+BPI_REG_HL;  _d64p++;  d64=(*_d64p)|pdata_mod;
   HW_WRITE( _regL,  (((d64)&(~tas_mask))|tas_bpi )     &0xFFFFFFFF );  /* PT2B */
   HW_WRITE( _regH, ((((d64)&(~tas_mask))|tas_bpi )>>32)&0xFFFFFFFF );  _regL+=BPI_REG_IDX;  _regH=_regL+BPI_REG_HL;  _d64p++;  d64=(*_d64p); //PT3 is end, doesn't need to | pdata_mod.
   HW_WRITE( _regL,  (d64)     &0xFFFFFFFF );  /* PT3 */
   HW_WRITE( _regH, ((d64)>>32)&0xFFFFFFFF );  

   #if IS_BPI_V2_PT3A_SUPPORT
   _regL = PDATA_REG_TABLE3[ pt3a_idx ];
   #else
   _regL = PDATA_REG_TABLE2[ l1d_rf.cwin_idx ];
   #endif
   _regH=_regL+BPI_REG_HL;  _d64p++;  d64=(*_d64p);
   HW_WRITE( _regL,  (d64)     &0xFFFFFFFF );  /* PT3A */
   HW_WRITE( _regH, ((d64)>>32)&0xFFFFFFFF );  
}
...
void  L1D_RF_SetPData_PR2M( void )
{
   ...
   /* PR2M is not supported on BPI v2.0. */
   #else
   #error "IS_BPI_DATA_48_BIT_CHIP but !IS_BPI_V2_SUPPORT is not supported yet."
   #endif
}

   #if IS_EPSK_TX_SUPPORT
/*EGPRS*/ void  L1D_RF_SetPData_PT2M( void )
/*EGPRS*/ {
/*EGPRS*/    APBADDRBPI  _regL, _regH;
/*EGPRS*/    uintBPI    *_d64p;
/*EGPRS*/    uintBPI     d64;
/*EGPRS*/    uintBPI     pdata_mod;
/*EGPRS*/    uintBPI     tas_mask = 0;
/*EGPRS*/    uintBPI     tas_bpi = 0;
/*EGPRS*/    uint		     tas_ant_sel=0;

/*EGPRS*/  #if (IS_2G_TAS_SUPPORT||IS_2G_TAS_FOR_C2K_ONOFF_SUPPORT)
/*EGPRS*/    if(L1D_CheckIfMetaMode() && (L1_TAS_Custom_Params.FORCE_TX_ANTENNA_ENABLE))
/*EGPRS*/    {
/*EGPRS*/       tas_ant_sel = L1_TAS_Custom_Params.FORCE_TX_ANTENNA_IDX;
/*EGPRS*/    }
/*EGPRS*/    else
/*EGPRS*/    {
/*EGPRS*/       tas_ant_sel = l1d_rf.tas_ant_sel;
/*EGPRS*/     #if (IS_2G_TAS_ANT_IDX_SET_ON_TEST_SIM && IS_2G_TAS_TEST_SIM_OPTIMIZE_SUPPORT)
/*EGPRS*/       if ( (L1_TAS_Custom_Params.FORCE_TX_ANTENNA_ENABLE == 0) && 
/*EGPRS*/            (L1_TAS_Lib_Params.FORCE_POWER_SCAN_ANT == 0) && 
/*EGPRS*/            (L1_TAS_Custom_Params.EN_TAS_WITH_TEST_SIM == 0 ) && ( l1d_rf.isTestSim == 1 ) )
/*EGPRS*/       {
/*EGPRS*/          tas_ant_sel = L1_TAS_Init_Ant_Params.TAS_INIT_ANT_IDX[l1d_rf.band];
/*EGPRS*/       }
/*EGPRS*/     #endif
/*EGPRS*/    }

/*EGPRS*/    if(tas_ant_sel>=1)
/*EGPRS*/    {
/*EGPRS*/       tas_mask=L1_TAS_Custom_PData.pdata_tas_mask;
/*EGPRS*/       tas_bpi=L1_TAS_Custom_PData.pdata_band_tas[l1d_rf.band][(tas_ant_sel-1)];
/*EGPRS*/    }
/*EGPRS*/    else
/*EGPRS*/    {
/*EGPRS*/       tas_mask=0;
...
/*EGPRS*/ #if IS_DSDA_DCS_TX_NOTCH_SWITCH_SUPPORT
/*EGPRS*/   if( L1D_RF_IS_DCS_Change_to_TX_Notch() ) 
/*EGPRS*/   {  PDATA_TABLE = PDATA_TABLE_DCS_TX_NOTCH;  }
/*EGPRS*/   else
/*EGPRS*/   {  PDATA_TABLE = PDATA_TABLE_DEFAULT;       }
/*EGPRS*/ #endif
/*EGPRS*/ 
/*EGPRS*/    _regL  = PDATA_PT2M_REG_TABLE[ l1d_rf.rtxwin_idx ];
/*EGPRS*/    _regH  = _regL + BPI_REG_HL;
/*EGPRS*/ 
/*EGPRS*/    if( (l1d_rf.tx_mod_type)&(1<<l1d_rf.rtxwin_idx) )
/*EGPRS*/    {  /* now 8PSK */
/*EGPRS*/       _d64p = PDATA_TABLE3[ l1d_rf.band ][ RF_TX ];  //TX_G8
/*EGPRS*/       pdata_mod = pdata_8psk;
/*EGPRS*/    }
/*EGPRS*/    else
/*EGPRS*/    {  /* now GMSK */
/*EGPRS*/       _d64p = PDATA_TABLE3[ l1d_rf.band ][RF_TX_8G]; //TX_8G
/*EGPRS*/       pdata_mod = pdata_gmsk;  
/*EGPRS*/    } 
/*EGPRS*/    d64 = PDATA_TABLE[l1d_rf.band][RF_TX][2]; //PDATA of PT2B, so PT2B must later than PT2
/*EGPRS*/    d64 = d64 | pdata_mod;
/*EGPRS*/ 
/*EGPRS*/    if( (l1d_rf.change)&(1<<l1d_rf.rtxwin_idx) )
/*EGPRS*/    {  /* change */
/*EGPRS*/       HW_WRITE( _regL, (((*_d64p)&(~tas_mask))|tas_bpi )     &0xFFFFFFFF );  /* PT2M1 */
/*EGPRS*/       HW_WRITE( _regH,((((*_d64p)&(~tas_mask))|tas_bpi )>>32)&0xFFFFFFFF );  _regL+=BPI_REG_IDX;  _regH=_regL+BPI_REG_HL;  _d64p++;
/*EGPRS*/       HW_WRITE( _regL, (((*_d64p)&(~tas_mask))|tas_bpi )     &0xFFFFFFFF );  /* PT2M2 */
/*EGPRS*/       HW_WRITE( _regH,((((*_d64p)&(~tas_mask))|tas_bpi )>>32)&0xFFFFFFFF );  _regL+=BPI_REG_IDX;  _regH=_regL+BPI_REG_HL;  _d64p++;
/*EGPRS*/       HW_WRITE( _regL, (((*_d64p)&(~tas_mask))|tas_bpi )     &0xFFFFFFFF );  /* PT2M3 */
/*EGPRS*/       HW_WRITE( _regH,((((*_d64p)&(~tas_mask))|tas_bpi )>>32)&0xFFFFFFFF );
/*EGPRS*/    }
/*EGPRS*/    else
/*EGPRS*/    {  /* no change */
/*EGPRS*/       HW_WRITE( _regL,  (((d64)&(~tas_mask))|tas_bpi )     &0xFFFFFFFF );  /* PT2M1 */
/*EGPRS*/       HW_WRITE( _regH, ((((d64)&(~tas_mask))|tas_bpi )>>32)&0xFFFFFFFF );  _regL+=BPI_REG_IDX;  _regH=_regL+BPI_REG_HL;
/*EGPRS*/       HW_WRITE( _regL,  (((d64)&(~tas_mask))|tas_bpi )     &0xFFFFFFFF );  /* PT2M2 */
/*EGPRS*/       HW_WRITE( _regH, ((((d64)&(~tas_mask))|tas_bpi )>>32)&0xFFFFFFFF );  _regL+=BPI_REG_IDX;  _regH=_regL+BPI_REG_HL;
/*EGPRS*/       HW_WRITE( _regL,  (((d64)&(~tas_mask))|tas_bpi )     &0xFFFFFFFF );  /* PT2M3 */
/*EGPRS*/       HW_WRITE( _regH, ((((d64)&(~tas_mask))|tas_bpi )>>32)&0xFFFFFFFF );
/*EGPRS*/    }
/*EGPRS*/ }
   #else  /* IS_EPSK_TX_SUPPORT */
          void  L1D_RF_SetPData_PT2M( void )
          {
          }
   #endif /* IS_EPSK_TX_SUPPORT */

#else /* IS_BPI_DATA_48_BIT_CHIP */
...
void  L1D_RF_SetPData_PR( void )
{
   ...
   HW_WRITE( _reg, ((*_d16p)&(~tas_mask))|tas_bpi );   _reg+=BPI_REG_IDX;   _d16p++;
   HW_WRITE( _reg, ((*_d16p)&(~tas_mask))|tas_bpi );   _reg+=BPI_REG_IDX;   _d16p++;
#if IS_EDGE_CHIP_MT6229_AND_LATTER_VERSION
   HW_WRITE( _reg, ((*_d16p)&(~tas_mask))|tas_bpi );
#else
   HW_WRITE( _reg, *_d16p );
#endif
   #if IS_EDGE_CHIP_MT6229_AND_LATTER_VERSION
...
void  L1D_RF_SetPData_PT( void )
{
   ...
   HW_WRITE( _reg, ((*_d16p)&(~tas_mask))|tas_bpi );   _reg+=2;   _d16p++;
   HW_WRITE( _reg, ((*_d16p)&(~tas_mask))|tas_bpi );   _reg+=2;   _d16p++;
   HW_WRITE( _reg, *_d16p );
...
/*MT6218~*/ }
   ...
   if ( (l1d_rf.tx_mod_type) & (1<<l1d_rf.modidx) )
   {
      HW_WRITE( _reg, (((*_d16p)&(~tas_mask))|(pdata_8psk)|tas_bpi) );   _reg+=BPI_REG_IDX;   _d16p++;
      HW_WRITE( _reg, (((*_d16p)&(~tas_mask))|(pdata_8psk)|tas_bpi) );   _reg+=BPI_REG_IDX;   _d16p++;
      HW_WRITE( _reg, (((*_d16p)&(~tas_mask))|(pdata_8psk)|tas_bpi) );   _reg+=BPI_REG_IDX;   _d16p++;
   ...
   {
      HW_WRITE( _reg, (((*_d16p)&(~tas_mask))|(pdata_gmsk)|tas_bpi) );   _reg+=BPI_REG_IDX;   _d16p++;
      HW_WRITE( _reg, (((*_d16p)&(~tas_mask))|(pdata_gmsk)|tas_bpi) );   _reg+=BPI_REG_IDX;   _d16p++;
      HW_WRITE( _reg, (((*_d16p)&(~tas_mask))|(pdata_gmsk)|tas_bpi) );   _reg+=BPI_REG_IDX;   _d16p++;
...
/*MT6218~*/ long        tas_mask = TAS_BPI_MASK;
...
/*MT6218~*/ HW_WRITE( _reg, ((*_d16p)&(~tas_mask))|tas_bpi);   _reg+=2;   _d16p++;
/*MT6218~*/ HW_WRITE( _reg, ((*_d16p)&(~tas_mask))|tas_bpi);
#elif IS_EDGE_CHIP_MT6229_AND_LATTER_VERSION
/*MT6229~*/ APBADDR      _reg;
/*MT6229~*/ const short *_d16p;
/*MT6229~*/ long        tas_mask = TAS_BPI_MASK;
...
/*MT6229~*/ HW_WRITE( _reg, ((*_d16p)&(~tas_mask))|tas_bpi);   _reg+=2;   _d16p++;
/*MT6229~*/ HW_WRITE( _reg, ((*_d16p)&(~tas_mask))|tas_bpi);
#endif
}
...
/*MT6229~*//*EGPRS*/    long         tas_mask = TAS_BPI_MASK;
...
/*MT6229~*//*EGPRS*/       {
/*MT6229~*//*EGPRS*/          /*Set M1*/ HW_WRITE( _reg, ((*_d16p)&(~tas_mask))|tas_bpi);   _reg+=BPI_REG_IDX;   _d16p++;
/*MT6229~*//*EGPRS*/          /*Set M2*/ HW_WRITE( _reg, ((*_d16p)&(~tas_mask))|tas_bpi);   _reg+=BPI_REG_IDX;   _d16p++;
/*MT6229~*//*EGPRS*/          /*Set M3*/ HW_WRITE( _reg, ((*_d16p)&(~tas_mask))|tas_bpi);
/*MT6229~*//*EGPRS*/       }
/*MT6229~*//*EGPRS*/       //no change
/*MT6229~*//*EGPRS*/       else
/*MT6229~*//*EGPRS*/       {  HW_WRITE( _reg, (((_d16p2)&(~tas_mask))|(pdata_8psk)|tas_bpi) );   _reg+=BPI_REG_IDX;
/*MT6229~*//*EGPRS*/          HW_WRITE( _reg, (((_d16p2)&(~tas_mask))|(pdata_8psk)|tas_bpi) );   _reg+=BPI_REG_IDX;
/*MT6229~*//*EGPRS*/          HW_WRITE( _reg, (((_d16p2)&(~tas_mask))|(pdata_8psk)|tas_bpi) );
/*MT6229~*//*EGPRS*/       }
/*MT6229~*//*EGPRS*/    }
...
/*MT6229~*//*EGPRS*/       //no change
/*MT6229~*//*EGPRS*/       else
/*MT6229~*//*EGPRS*/       {  HW_WRITE( _reg, (((_d16p2)&(~tas_mask))|(pdata_gmsk)|tas_bpi) );   _reg+=BPI_REG_IDX;
/*MT6229~*//*EGPRS*/          HW_WRITE( _reg, (((_d16p2)&(~tas_mask))|(pdata_gmsk)|tas_bpi) );   _reg+=BPI_REG_IDX;
/*MT6229~*//*EGPRS*/          HW_WRITE( _reg, (((_d16p2)&(~tas_mask))|(pdata_gmsk)|tas_bpi) );
/*MT6229~*//*EGPRS*/       }
/*MT6229~*//*EGPRS*/    }
/*MT6229~*//*EGPRS*/
/*MT6229~*//*EGPRS*/ }
...
/*MT6169*/ };
/*MT6169*/
/*MT6169*/ #if L1D_CUSTOM_PDATA_DRDI_SUPPORT
/*MT6169*/ unsigned long  SDATA_CW68[5] =
/*MT6169*/ #else 
...
/*MT6169*/ };
/*MT6169*/ #if L1D_CUSTOM_PDATA_DRDI_SUPPORT
/*MT6169*/ unsigned long  SDATA_CW68_E3[5] =
/*MT6169*/ #else 
...
/*MT6176*/
/*MT6176*/ /*..........................................................*/
/*MT6176*/ /*  Define Alias and Table                                  */
/*MT6176*/ /*..........................................................*/
/*MT6176*/
/*MT6176*/ #define  SCTRL_RXWARMUP_MODE           SCTRL_WORD(0,0)  //BSI Length should be 32bits for MT6176, and length setting move to TOPBSI, so set 0 here.
/*MT6176*/ #define  SCTRL_RXBURST_MODE            SCTRL_WORD(0,0)  //BSI Length should be 32bits for MT6176, and length setting move to TOPBSI, so set 0 here.
/*MT6176*/ #define  SCTRL_TXWARMUP_MODE           SCTRL_WORD(0,0)  //BSI Length should be 32bits for MT6176, and length setting move to TOPBSI, so set 0 here.
/*MT6176*/ #define  SCTRL_TXBURST_MODE            SCTRL_WORD(0,0)  //BSI Length should be 32bits for MT6176, and length setting move to TOPBSI, so set 0 here.
/*MT6176*/ #define  SDATA_RXWARMUP_MODE           BSI_CW(0x001, 0x40200)  /* MODE=0100|RAT=0000|TRX=001|STD=Variable */
/*MT6176*/ #define  SDATA_RXBURST_MODE            BSI_CW(0x001, 0x80200)  /* MODE=1000|RAT=0000|TRX=001|STD=Variable */
/*MT6176*/ #define  SDATA_TXWARMUP_MODE           BSI_CW(0x001, 0x40400)  /* MODE=0100|RAT=0000|TRX=010|STD=Variable */
/*MT6176*/ #define  SDATA_TXBURST_MODE            BSI_CW(0x001, 0x80400)  /* MODE=1000|RAT=0000|TRX=010|STD=Variable */
/*MT6176*/ #define  SDATA_RX2SLEEP                BSI_CW(0x001, 0x10220)  /* MODE=0001|RAT=0000|TRX=001|STD=Variable */
/*MT6176*/ #define  SDATA_TX2SLEEP                BSI_CW(0x001, 0x10400)  /* MODE=0001|RAT=0000|TRX=010|STD=Variable */
/*MT6176*/ /*..........................................................*/
/*MT6176*/ #define  SDATA_FPM_DIV                 BSI_CW(0x025, 0x61D40)  /* CW37     :FPM Dividor */
/*MT6176*/ /*..........................................................*/
/*MT6176*/ #define  SCTRL_AFCDAC                  SCTRL_WORD(0,0)  //BSI Length should be 32bits for MT6176, and length setting move to TOPBSI, so set 0 here.
/*MT6176*/ #define  SCTRL_FPMDIV                  SCTRL_WORD(0,0)  //BSI Length should be 32bits for MT6176, and length setting move to TOPBSI, so set 0 here.
/*MT6176*/ #define  SCTRL_SRX_CFG                 SCTRL_WORD(0,0)  //BSI Length should be 32bits for MT6176, and length setting move to TOPBSI, so set 0 here.
/*MT6176*/ #define  SCTRL_RX_CFG                  SCTRL_WORD(0,0)  //BSI Length should be 32bits for MT6176, and length setting move to TOPBSI, so set 0 here.
/*MT6176*/ #define  SCTRL_AGC                     SCTRL_WORD(0,0)  //BSI Length should be 32bits for MT6176, and length setting move to TOPBSI, so set 0 here.
/*MT6176*/ #define  SCTRL_RXDCOC                  SCTRL_WORD(0,0)  //BSI Length should be 32bits for MT6176, and length setting move to TOPBSI, so set 0 here.
/*MT6176*/ #define  SCTRL_PLL                     SCTRL_WORD(0,0)  //BSI Length should be 32bits for MT6176, and length setting move to TOPBSI, so set 0 here.
/*MT6176*/ #define  SCTRL_PMIC_VS1                SCTRL_WORD_PMIC(0,0)  //BSI Length should be 32bits for MT6176, and length setting move to TOPBSI, so set 0 here.
/*MT6176*/ #define  SDATA_RX_POFF                 BSI_CW(0x140, 0x01CFF)  /* CW320/321:RX/RXD Partial Off */
/*MT6176*/ #define  SDATA_RX_ON                   BSI_CW(0x140, 0x00000)  /* CW320/321:RX/RXD ON */
/*MT6176*/ #define  SDATA_LNA_SEL                 BSI_CW(0x142, 0x08000)  /* CW322/324:LNA/MIXER/BAND Selectin, 2G_IRRC_ON=0, LNA_CUR_CTL=0x3, NCCA_EN=0x0 */
/*MT6176*/ #define  SDATA_RX_BW_SET               BSI_CW(0x146, 0x00000)  /* CW326    :Gain Sync & RXRXD Path BW Setting */
/*MT6176*/ #define  SDATA_RX_PWR_MODE             BSI_CW(0x19D, 0x007F8)  /* CW413/414:RX Power Mode Setting */
/*MT6176*/ #define  SDATA_RX_LO_SET               BSI_CW(0x1EF, 0x00000)  /* CW495    :RX LO Divider Value   */
/*MT6176*/ #define  SDATA_RX_MIXER_BIAS           BSI_CW(0x18F, 0x02142)  /* CW399    :RX Mixer Bias         */
/*MT6176*/ #define  SDATA_RX_MIXER_BIAS_HB        BSI_CW(0x18F, 0x0217A)  /* CW399    :RX Mixer Bias for HB (E3) */
/*MT6176*/ /*..........................................................*/
/*MT6176*/ #define  SCTRL_STX_CFG                 SCTRL_WORD(0,0)  //BSI Length should be 32bits for MT6176, and length setting move to TOPBSI, so set 0 here.
/*MT6176*/ #define  SCTRL_TX_CFG                  SCTRL_WORD(0,0)  //BSI Length should be 32bits for MT6176, and length setting move to TOPBSI, so set 0 here.
/*MT6176*/ #define  SCTRL_TX_GAIN                 SCTRL_WORD(0,0)  //BSI Length should be 32bits for MT6176, and length setting move to TOPBSI, so set 0 here.
/*MT6176*/ #define  SDATA_STX_BAND                BSI_CW(0x1FF, 0x00000)  /* CW511:STX Band */
/*MT6176*/ #define  SDATA_TX_PORT                 BSI_CW(0x2C3, 0x00000)  /* CW707:TX Port */
/*MT6176*/ #define  SDATA_TX_CW786                BSI_CW(0x312, 0x28000)  /* CW786:LO FE Compensation */
/*MT6176*/ #define  SDATA_TX_CW735                BSI_CW(0x2DF, 0x00010)  /* CW735:Trigger TX CMOS LO LDO o/p enable */
/*MT6176*/ /*..........................................................*/
/*MT6176*/ #define  SCTRL_TEMP_MEAS               SCTRL_WORD(0,0)  //BSI Length should be 32bits for MT6176, and length setting move to TOPBSI, so set 0 here.
/*MT6176*/ #define  SDATA_TEMP_MEAS               BSI_CW(0x044, 0x00000)  /* CW68: THADC_EXT = 0(internal THADC sensor)/1(external THADC sensor) */
/*MT6176*/ /*..........................................................*/
/*MT6176*/
/*MT6176*/ const unsigned long  SDATA_BAND_SEL[5] =
/*MT6176*/ {  /* CW128:SRX Band ; CW511:STX Band */
/*MT6176*/    0x0,  /* GSM  450 no support */
/*MT6176*/    0x5,  /* GSM  850            */
/*MT6176*/    0x8,  /* GSM  900            */
/*MT6176*/    0x3,  /* DCS 1800            */
/*MT6176*/    0x2,  /* PCS 1900            */
/*MT6176*/ };
/*MT6176*/
/*MT6176*/ CONST unsigned long  SDATA_RX_LNA_SEL[5] =
/*MT6176*/ {  /* CW322/324 : RX LNA Selection */
/*MT6176*/ #if IS_CC_NVRAM_CUSTOM_DATA_SUPPORT
/*MT6176*/    0,
/*MT6176*/ #else
/*MT6176*/    #if IS_DCS_NB_WB_SWITCH_SUPPORT
/*MT6176*/    DCS_NB_PATH_SEL,  /* use this field to store the DCS NB path */
/*MT6176*/    #else
/*MT6176*/    0,                /* GSM  450 no support                     */
/*MT6176*/    #endif
/*MT6176*/    GSM850_PATH_SEL,  /* GSM  850 (bit[20]=PRX/DRX select)       */
/*MT6176*/       GSM_PATH_SEL,  /* GSM  900 (bit[20]=PRX/DRX select)       */
/*MT6176*/       DCS_PATH_SEL,  /* DCS 1800 (bit[20]=PRX/DRX select)       */
/*MT6176*/       PCS_PATH_SEL,  /* PCS 1900 (bit[20]=PRX/DRX select)       */
/*MT6176*/ #endif
/*MT6176*/ };
/*MT6176*/
/*MT6176*/ const unsigned long  SDATA_CW322_CW324[5] =
/*MT6176*/ { /* SDATA_LNA_SEL | LNA_CUR_CTL | MIXER_BAND */
/*MT6176*/    0x0,                                           /* GSM  450 no support */
/*MT6176*/    ( SDATA_LNA_SEL |  (0x1<<16)  |  (0x2<<11) ),  /* GSM  850            */
/*MT6176*/    ( SDATA_LNA_SEL |  (0x1<<16)  |  (0x2<<11) ),  /* GSM  900            */
/*MT6176*/    ( SDATA_LNA_SEL |  (0x2<<16)  |  (0x1<<11) ),  /* DCS 1800            */
/*MT6176*/    ( SDATA_LNA_SEL |  (0x2<<16)  |  (0x1<<11) ),  /* PCS 1900            */
/*MT6176*/ };
/*MT6176*/ const unsigned long  SDATA_CW322_CW324_E3[5] =
/*MT6176*/ { /* SDATA_LNA_SEL | LNA_CUR_CTL | MIXER_BAND */
/*MT6176*/    0x0,                                           /* GSM  450 no support */
/*MT6176*/    ( SDATA_LNA_SEL |  (0x0<<16)  |  (0x2<<11) ),  /* GSM  850            */
/*MT6176*/    ( SDATA_LNA_SEL |  (0x0<<16)  |  (0x2<<11) ),  /* GSM  900            */
/*MT6176*/    ( SDATA_LNA_SEL |  (0x0<<16)  |  (0x1<<11) ),  /* DCS 1800            */
/*MT6176*/    ( SDATA_LNA_SEL |  (0x0<<16)  |  (0x1<<11) ),  /* PCS 1900            */
/*MT6176*/ };
/*MT6176*/
/*MT6176*/ const unsigned long  SDATA_CW326_CW333[4] =
/*MT6176*/ { /* SDATA_RX_BW_SET | RX(D)IF1_STG2_BS | RX(D)IF1_MODE | RX(D)_PATH1_TIA_BW */
/*MT6176*/    ( SDATA_RX_BW_SET |     (0x0<<14)    |    (0x0<< 6)  |     (0x0<<0) ),  /* Primaray  RX Path 1 */
/*MT6176*/    ( SDATA_RX_BW_SET |     (0x0<<15)    |    (0x0<<10)  |     (0x0<<3) ),  /* Diversity RX Path 1 */
/*MT6176*/    0,                                                                      /* Primaray  RX Path 2 */
/*MT6176*/    0,                                                                      /* Diversity RX Path 2 */
/*MT6176*/ };
/*MT6176*/ const unsigned long  SDATA_CW128_E3[5] =
/*MT6176*/ { /* SRX1_RSV0 | SRX1_LO_VSP_HI | SRX1_BAND_SUBHI*/
/*MT6176*/    0x0,                                  /* GSM  450 no support */
/*MT6176*/    ( (0x157<<9) | (0x0<<8) | (0x0<<7) ),  /* GSM  850            */
/*MT6176*/    ( (0x1D7<<9) | (0x0<<8) | (0x0<<7) ),  /* GSM  900            */
/*MT6176*/    ( (0x157<<9) | (0x0<<8) | (0x0<<7) ),  /* DCS 1800            */
/*MT6176*/    ( (0x257<<9) | (0x0<<8) | (0x0<<7) ),  /* PCS 1900            */
/*MT6176*/ };
/*MT6176*/
/*MT6176*/ const unsigned long  SDATA_CW495[5] =
/*MT6176*/ { /* RXLO1_EN | RXLO1_DIV  */
/*MT6176*/    0x0,                                           /* GSM  450 no support */
/*MT6176*/    ( SDATA_RX_LO_SET | (0x1<<15)  | (0x10<<6) ),  /* GSM  850            */
/*MT6176*/    ( SDATA_RX_LO_SET | (0x1<<15)  | (0x10<<6) ),  /* GSM  900            */
/*MT6176*/    ( SDATA_RX_LO_SET | (0x2<<15)  | (0x20<<6) ),  /* DCS 1800            */
/*MT6176*/    ( SDATA_RX_LO_SET | (0x2<<15)  | (0x20<<6) ),  /* PCS 1900            */
/*MT6176*/ };
/*MT6176*/
/*MT6176*/ const unsigned long  SDATA_CW1[4] =
/*MT6176*/ {  /* SRX_ON | SRX_PCC_EN */
/*MT6176*/    ( (0x1<<5)|  (0x1<<3) ),  /* Primaray  RX Path 1 */
/*MT6176*/    ( (0x1<<5)|  (0x1<<3) ),  /* Diversity RX Path 1 */
/*MT6176*/    0,                        /* Primaray  RX Path 2 */
/*MT6176*/    0,                        /* Diversity RX Path 2 */
/*MT6176*/ };
/*MT6176*/
/*MT6176*/ const unsigned long  SDATA_CW511[5] =
/*MT6176*/ {  /*                STX_DCO_CFG | DBL_EN_3_4G | FEB_DIV_EN | DCO_CLKSDM_DIV | TX_RELOCK_LPM | STX_CORNER_DET_EN */
/*MT6176*/    0x0,                                                                                                           /* GSM  450 no support */
/*MT6176*/    (  SDATA_STX_BAND | (0x1<<9)  |   (0x0<<8)  |  (0x1<<7)  |    (0x1<<5)    |    (0x0<<1)   |      (0x1<<0)  ),  /* GSM  850            */
/*MT6176*/    (  SDATA_STX_BAND | (0x1<<9)  |   (0x0<<8)  |  (0x1<<7)  |    (0x1<<5)    |    (0x0<<1)   |      (0x1<<0)  ),  /* GSM  900            */
/*MT6176*/    (  SDATA_STX_BAND | (0x0<<9)  |   (0x0<<8)  |  (0x1<<7)  |    (0x1<<5)    |    (0x0<<1)   |      (0x1<<0)  ),  /* DCS 1800            */
/*MT6176*/    (  SDATA_STX_BAND | (0x0<<9)  |   (0x0<<8)  |  (0x1<<7)  |    (0x1<<5)    |    (0x0<<1)   |      (0x1<<0)  ),  /* PCS 1900            */
/*MT6176*/ };
/*MT6176*/
/*MT6176*/ const unsigned long  SDATA_CW786_E3[5] =
/*MT6176*/ {  /* CAP_CAL_INBIAS_MODE | BIAS_CAL_INBIAS_MODE | TX_LO_FE_ISOCASC_BIAS | RG_TXLO_RANGE_INDSW_MODE | RG_TXLO_RANGE_VS */
/*MT6176*/    0x0,                                                        /* GSM  450 no support */
/*MT6176*/    (0x0<<19) | (0x1<<18) | (0x5<<15) | (0x0<<12) | (0x2<<10),  /* GSM  850            */
/*MT6176*/    (0x0<<19) | (0x1<<18) | (0x5<<15) | (0x0<<12) | (0x1<<10),  /* GSM  900            */
/*MT6176*/    (0x0<<19) | (0x1<<18) | (0x5<<15) | (0x1<<12) | (0x1<<10),  /* DCS 1800            */
/*MT6176*/    (0x0<<19) | (0x1<<18) | (0x5<<15) | (0x0<<12) | (0x1<<10),  /* PCS 1900            */
/*MT6176*/ };
/*MT6176*/ const unsigned long  SDATA_CW797[5] =
/*MT6176*/ {  /* Set TX DRV bias for LIN */
/*MT6176*/    0x0,      /* GSM  450 no support */
/*MT6176*/    0x2CFE4,  /* GSM  850            */
/*MT6176*/    0x2BFE4,  /* GSM  900            */
/*MT6176*/    0x3053B,  /* DCS 1800            */
/*MT6176*/    0x3053A,  /* PCS 1900            */
/*MT6176*/ };
/*MT6176*/
/*MT6176*/ #if IS_2G_ALTERNATIVE_RX_PATH_SUPPORT
/*MT6176*/ /*To check if using DRX on each band, the 20th bit of RX port setting*/
/*MT6176*/ unsigned short  L1D_RF_RXPath_Idx( int rf_band )
/*MT6176*/ {
/*MT6176*/    return ((SDATA_RX_LNA_SEL[rf_band]>>20) & 0x1);
/*MT6176*/ }
/*MT6176*/ #endif
/*MT6176*/
/*MT6176*/ #if IS_2G_EXTERNAL_LNA_SUPPORT
/*MT6176*/ /*To check if using eLNA on each band, the 24th bit of RX port setting*/
/*MT6176*/ unsigned short L1D_RF_Check_If_ExternalLNA( int rf_band )
/*MT6176*/ {
/*MT6176*/    return ((SDATA_RX_LNA_SEL[rf_band]>>24) & 0x1);
/*MT6176*/ }
/*MT6176*/ #endif 
/*MT6176*/ 
/*MT6176*/ /*..........................................................*/
/*MT6176*/ /* Serial Interface Implement                               */
/*MT6176*/ /*..........................................................*/
/*MT6176*/
/*MT6176*/ void  L1D_RF_SetSData_SR0( void )
/*MT6176*/ {
/*MT6176*/ }
/*MT6176*/
/*MT6176*/ void  L1D_RF_SetSData_SR1( void )
/*MT6176*/ {
/*MT6176*/    unsigned short rx_path      = ((SDATA_RX_LNA_SEL[l1d_rf.band]>>20) & 0x3);
/*MT6176*/    unsigned long  ctrl_dcxo    = SCTRL_AFCDAC; 
/*MT6176*/    unsigned long  ctrl_fpm_div = SCTRL_RESERVED, fpm_div=SDATA_FPM_DIV;
/*MT6176*/    unsigned long  ctrl_pmic_vs1, cw_pmic_vs1;
/*MT6176*/    unsigned long  rx_lna_sel, rx_bw_set, rx_mixer_bias, srx_lo_set, srx_band;
/*MT6176*/    unsigned long  afc_value_part;
/*MT6176*/    unsigned short cw_rx_on, cw_rx_off, cw_rx_lna_sel, cw_srx_band, cw_rx_pwr_mode;
/*MT6176*/    unsigned short afc_data;
/*MT6176*/
/*MT6176*/    SETUP_SR1();
/*MT6176*/
/*MT6176*/    switch( rx_path )
/*MT6176*/    {
/*MT6176*/       case 0:  /* PRX1 */
/*MT6176*/          cw_rx_on=320; cw_rx_off=321; cw_rx_lna_sel=322; cw_srx_band=128, cw_rx_pwr_mode=413;
/*MT6176*/          break;
/*MT6176*/       case 1:  /* DRX1 */
/*MT6176*/          cw_rx_on=321; cw_rx_off=320; cw_rx_lna_sel=324; cw_srx_band=128, cw_rx_pwr_mode=414;
/*MT6176*/          break;
/*MT6176*/       default: /* PRX1 */
/*MT6176*/          cw_rx_on=320; cw_rx_off=321; cw_rx_lna_sel=322; cw_srx_band=128, cw_rx_pwr_mode=413;
/*MT6176*/    }
/*MT6176*/
/*MT6176*/    afc_data     = (L1D_RF_Check_DCXO_LPM()&0x1FFF);
/*MT6176*/
/*MT6176*/    if ( ( L1D_RF_QUERY_CHIP_VERSION() >= MML1_RF_IS_E3 ) )
/*MT6176*/    {
/*MT6176*/       rx_lna_sel    = (SDATA_CW322_CW324_E3[l1d_rf.band]&0xFF800)|(SDATA_RX_LNA_SEL[l1d_rf.band]&0x007EF);
/*MT6176*/       rx_mixer_bias = (l1d_rf.band<FrequencyBand1800) ? SDATA_RX_MIXER_BIAS : SDATA_RX_MIXER_BIAS_HB;
/*MT6176*/       srx_band      = (SDATA_CW128_E3[l1d_rf.band]&0xFFF80) | SDATA_BAND_SEL[l1d_rf.band];
/*MT6176*/    }
/*MT6176*/    else
/*MT6176*/    {
/*MT6176*/       rx_lna_sel    = (SDATA_CW322_CW324[l1d_rf.band]&0xFF800)|(SDATA_RX_LNA_SEL[l1d_rf.band]&0x007EF);
/*MT6176*/       rx_mixer_bias = SDATA_RX_MIXER_BIAS;
/*MT6176*/       srx_band     = (0x2F7<<9) | (0x0<<8) | (0x0<<7) | SDATA_BAND_SEL[l1d_rf.band];
/*MT6176*/    }
/*MT6176*/
/*MT6176*/    rx_bw_set    = SDATA_CW326_CW333[rx_path];
/*MT6176*/    srx_lo_set   = SDATA_CW495[l1d_rf.band];
/*MT6176*/
/*MT6176*/ #if IS_BSI_AFC_ACTIVE_SWITCH
/*MT6176*/    if( l1d_rf.is_crystal_on_pmic )
/*MT6176*/       ctrl_dcxo = SCTRL_RESERVED;
/*MT6176*/    else
/*MT6176*/       ctrl_dcxo = l1d_rf2.is_bsi_afc_active ? (SCTRL_AFCDAC|event_idx) : SCTRL_RESERVED;
/*MT6176*/ #else
/*MT6176*/    ctrl_dcxo = (SCTRL_AFCDAC|event_idx);
/*MT6176*/ #endif
/*MT6176*/ #if IS_DUAL_LOOP_AFC_CONTROL_SUPPORT && IS_32K_CRYSTAL_REMOVAL_SUPPORT
/*MT6176*/    ctrl_fpm_div = SCTRL_RESERVED;  //FPM divider moves to PMIC on MT6176 platform
/*MT6176*/    fpm_div     = (SDATA_FPM_DIV & (~0x00003FFF)) | (l1d_rf.dcxo_frac_fpm & 0x3FFF);
/*MT6176*/ #endif
/*MT6176*/
/*MT6176*/    if( l1d_rf.is_crystal_vcxo )
/*MT6176*/       afc_value_part = AFC_VALUE_PART_VCXO;
/*MT6176*/    else
/*MT6176*/       afc_value_part = AFC_VALUE_PART_VCTCXO;
/*MT6176*/
/*MT6176*/ #if IS_2G_INCREASE_VS1_VOLTAGE_SUPPORT
/*MT6176*/    ctrl_pmic_vs1 = (SCTRL_PMIC_VS1|event_idx);
/*MT6176*/    cw_pmic_vs1 = L1D_RF_VS1_CWGen(MML1_RF_2G, WIN_RX1, WIN_ON);
/*MT6176*/ #else
/*MT6176*/    ctrl_pmic_vs1 = SCTRL_RESERVED;
/*MT6176*/    cw_pmic_vs1 = 0;
/*MT6176*/ #endif
/*MT6176*/
/*MT6176*/
/*MT6176*/    HWRITE_27_SDATA( ctrl_dcxo,                      ((afc_data<<AFC_SHIFT_PART)&AFC_MASK_PART)|(afc_value_part),  /* CW34/CW42  : AFC DAC                     */
/*MT6176*/                     SCTRL_RX_CFG|event_idx,         BSI_CW(cw_rx_on      , SDATA_RX_ON),                          /* CW320/CW321: Turn off RX Path for unused */
/*MT6176*/                     SCTRL_RX_CFG|event_idx,         BSI_CW(cw_rx_off     , SDATA_RX_POFF),                        /* CW320/CW321: Turn off RX Path for unused */
/*MT6176*/                     SCTRL_RX_CFG|event_idx,         BSI_CW(cw_rx_lna_sel , rx_lna_sel),                           /* CW322/CW324: RX BAND/LNA/MIXER SEL       */
/*MT6176*/                     SCTRL_RX_CFG|event_idx,         rx_bw_set,                                                    /* CW326      : RX TIA/IF BW Setting        */
/*MT6176*/                     SCTRL_RX_CFG|event_idx,         rx_mixer_bias,                                                /* CW399      : RX Mixer Bias               */
/*MT6176*/                     SCTRL_RX_CFG|event_idx,         srx_lo_set,                                                   /* CW495      : RX LO Setting               */
/*MT6176*/                     SCTRL_SRX_CFG|event_idx,        BSI_CW(cw_srx_band   , srx_band),                             /* CW128      : SRX Setting                 */
/*MT6176*/                     SCTRL_PLL|event_idx,            l1d_rf.RFN_data,                                              /* CW130      : SRX Setting                 */
/*MT6176*/                     SCTRL_PLL|event_idx,            l1d_rf.IFN_data,                                              /* CW131      : SRX Setting                 */
/*MT6176*/                     SCTRL_RX_CFG|event_idx,         BSI_CW(cw_rx_pwr_mode, SDATA_RX_PWR_MODE),                    /* CW413/CW414: RX Power mode setting       */
/*MT6176*/                     SCTRL_RXWARMUP_MODE|event_idx,  (SDATA_RXWARMUP_MODE | SDATA_CW1[rx_path]),                   /* CW1        : RX WARMUP Mode              */
/*MT6176*/                     ctrl_fpm_div,                   fpm_div,                                                      /* CW37       : 32K FPM Divider             */
/*MT6176*/                     ctrl_pmic_vs1,                  cw_pmic_vs1,                                                  /* PMIC VS1 Control : change VS1 from 2.0V to 2.2V and switch to PWM mode   */
/*MT6176*/                     SCTRL_RESERVED,                 0,                                                            /* Reserved                                 */
/*MT6176*/                     SCTRL_RESERVED,                 0,                                                            /* Reserved                                 */
/*MT6176*/                     SCTRL_RESERVED,                 0,                                                            /* Reserved                                 */
/*MT6176*/                     SCTRL_RESERVED,                 0,                                                            /* Reserved                                 */
/*MT6176*/                     SCTRL_RESERVED,                 0,                                                            /* Reserved                                 */
...
/*MT6176*/ }
/*MT6176*/
/*MT6176*/ void  L1D_RF_SetSData_SR2( void )
/*MT6176*/ {
/*MT6176*/    unsigned short rx_path      = ((SDATA_RX_LNA_SEL[l1d_rf.band]>>20) & 0x3);
/*MT6176*/    unsigned short thadc_sensor=0; /* 0:internal THADC sensor ; 1: external THADC sensor */
/*MT6176*/    unsigned short cw_rx_agc;
/*MT6176*/
/*MT6176*/    SETUP_SR2();
/*MT6176*/
/*MT6176*/    switch( rx_path )
/*MT6176*/    {
/*MT6176*/       case 0:  /* PRX1 */
/*MT6176*/          cw_rx_agc=334;
/*MT6176*/          break;
/*MT6176*/       case 1:  /* DRX1 */
/*MT6176*/          cw_rx_agc=336;
/*MT6176*/          break;
/*MT6176*/       default: /* PRX1 */
/*MT6176*/          cw_rx_agc=334;
/*MT6176*/    }
/*MT6176*/
/*MT6176*/    thadc_sensor = 0; //MML1_RF_GetMultiRatRfThermalSensorDefaultType(); /* Use internal THADC since ET don't need external THADC sensor eventually */
/*MT6176*/
/*MT6176*/    if(IS_CONTINUOUS_RX_SLOT())
/*MT6176*/    {
/*MT6176*/       HWRITE_5_SDATA( SCTRL_AGC|event_idx   ,        BSI_CW(cw_rx_agc, l1d_rf.AGC_data),  /* CW334/CW336 : RX Gain */
/*MT6176*/                       SCTRL_RESERVED,                0,                                   /* reserved              */
/*MT6176*/                       SCTRL_RESERVED,                0,                                   /* reserved              */
/*MT6176*/                       SCTRL_RESERVED,                0,                                   /* reserved              */
/*MT6176*/                       SCTRL_RESERVED,                0                                );  /* reserved              */
...
/*MT6176*/    {
/*MT6176*/       HWRITE_5_SDATA( SCTRL_AGC|event_idx   ,        BSI_CW(cw_rx_agc, l1d_rf.AGC_data),            /* CW334/CW336 : RX Gain */
/*MT6176*/                       SCTRL_RXBURST_MODE|event_idx,  (SDATA_RXBURST_MODE | SDATA_CW1[rx_path]),     /* CW1  : 2GRX Burst Mode | Band */
/*MT6176*/                       SCTRL_TEMP_MEAS|event_idx,     (((thadc_sensor&0x1)<<19) | SDATA_TEMP_MEAS),  /* CW68 : trigger RF to measure temperature */
/*MT6176*/                       SCTRL_RESERVED,                0,                                              /* reserved              */
/*MT6176*/                       SCTRL_RESERVED,                0                                          );  /* reserved              */
/*MT6176*/    }
/*MT6176*/ }
/*MT6176*/
/*MT6176*/ void  L1D_RF_SetSData_SR3( void )
/*MT6176*/ {
/*MT6176*/    unsigned long  ctrl_pmic_vs1, cw_pmic_vs1;
/*MT6176*/
/*MT6176*/    SETUP_SR3();
...
/*MT6176*/ #if IS_2G_INCREASE_VS1_VOLTAGE_SUPPORT
/*MT6176*/    ctrl_pmic_vs1 = (SCTRL_PMIC_VS1|event_idx);
/*MT6176*/    cw_pmic_vs1 = L1D_RF_VS1_CWGen(MML1_RF_2G, WIN_RX1, WIN_OFF);
/*MT6176*/ #else
/*MT6176*/    ctrl_pmic_vs1 = SCTRL_RESERVED;
/*MT6176*/    cw_pmic_vs1 = 0;
/*MT6176*/ #endif
/*MT6176*/
/*MT6176*/    HWRITE_5_SDATA( SCTRL_IDLE|event_idx,  SDATA_RX2SLEEP,                              /* CW1: Sleep Mode */
/*MT6176*/                    ctrl_pmic_vs1,         cw_pmic_vs1,                                 /* PMIC VS1 Control : change VS1 from 2.2V to 2.0V and switch to PFM mode   */
/*MT6176*/                    SCTRL_RESERVED,        0,                                           /* reserved */
/*MT6176*/                    SCTRL_RESERVED,        0,                                           /* reserved */
/*MT6176*/                    SCTRL_RESERVED,        0                                        );  /* reserved              */
/*MT6176*/ }
/*MT6176*/
/*MT6176*/ void  L1D_RF_SetSData_FSIWinOff_SR3( int idx )
/*MT6176*/ {
/*MT6176*/    unsigned long  ctrl_pmic_vs1, cw_pmic_vs1;
/*MT6176*/    int event_idx = AGCIDX( FS_RXWIN_IDX+idx );
/*MT6176*/    int data_idx  = AGCDTIDX( FS_RXWIN_IDX+idx );
/*MT6176*/
/*MT6176*/ #if IS_2G_INCREASE_VS1_VOLTAGE_SUPPORT
/*MT6176*/    ctrl_pmic_vs1 = (SCTRL_PMIC_VS1|event_idx);
/*MT6176*/    cw_pmic_vs1 = L1D_RF_VS1_CWGen(MML1_RF_2G, WIN_RX1, WIN_OFF);
...
/*MT6176*/ }
/*MT6176*/
/*MT6176*/ void  L1D_RF_SetSData_ST0( void )
/*MT6176*/ {
/*MT6176*/ }
/*MT6176*/
/*MT6176*/ void  L1D_RF_SetSData_ST1( void )
/*MT6176*/ {
/*MT6176*/    unsigned short codetype     = 0;
/*MT6176*/    unsigned short poc_band     = l1d_rf.band-FrequencyBand850;
/*MT6176*/    unsigned short Nint         = 0;
/*MT6176*/    unsigned long  Nfrac        = 0;
/*MT6176*/    unsigned long  ctrl_dcxo    = SCTRL_AFCDAC;
/*MT6176*/    unsigned long  ctrl_pmic_vs1, cw_pmic_vs1;
/*MT6176*/    unsigned long  cw511,cw521,cw529,cw707,cw786,cw794,cw795,cw796,cw797,cw806,cw807,cw808,cw714,cw787,cw793,cw710,cw1_std,cw722,cw723,cw712;
/*MT6176*/             long  cw551,cw552;
/*MT6176*/    unsigned long  afc_value_part;
/*MT6176*/
/*MT6176*/    SETUP_ST1();
/*MT6176*/
/*MT6176*/    L1D_RF_GetTxKDCOCAL2ndSetting( l1d_rf.band, (l1d_rf2.arfcn&0x3FF), &cw551, &cw552);
/*MT6176*/
/*MT6176*/    if( (l1d_rf.tx_mod_type) & (1<<l1d_rf.modidx) )
/*MT6176*/    {  /* EDGE */
/*MT6176*/       cw1_std = (0x1<<6);
/*MT6176*/       cw707   = (l1d_rf.band<FrequencyBand1800)?0x4:(0x4<<5);
/*MT6176*/    }
/*MT6176*/    else
/*MT6176*/    {  /* GMSK */
/*MT6176*/       cw1_std = (0x0<<6);
/*MT6176*/       cw707   = (l1d_rf.band<FrequencyBand1800)?0x1:(0x1<<5);
/*MT6176*/    }
/*MT6176*/
/*MT6176*/    Nint         = (l1d_rf.RFN_data&(0xFF<<12))>>12;
/*MT6176*/    Nfrac        = ( (l1d_rf.RFN_data&0xFFF)<<11 ) | ( (l1d_rf.IFN_data&(0x7FF<<9))>>9 );
/*MT6176*/
/*MT6176*/    codetype     = L1D_RF_GetTxDCOSCACodeTypeSetting( Nint, Nfrac );
/*MT6176*/    cw511        = SDATA_CW511[l1d_rf.band]|(SDATA_BAND_SEL[l1d_rf.band]<<14);
/*MT6176*/
/*MT6176*/    if ( ( L1D_RF_QUERY_CHIP_VERSION() >= MML1_RF_IS_E3 ) )
/*MT6176*/    {
/*MT6176*/       cw521     = 0x82060|((l1d_rf2.rfc_data.lf_fine[poc_band]&0xF)<<9);   // This value should update from NVRAM for 26MHz Channel Performance concern.
/*MT6176*/       cw710     = 0x06411;
/*MT6176*/       cw786     = SDATA_CW786_E3[l1d_rf.band];
/*MT6176*/    }
/*MT6176*/    else
/*MT6176*/    {
/*MT6176*/       cw521     = 0x02060|((l1d_rf2.rfc_data.lf_fine[poc_band]&0xF)<<9);   // This value should update from NVRAM for 26MHz Channel Performance concern.
/*MT6176*/       cw710     = (l1d_rf.band<FrequencyBand1800)?0x06541:0x065C1;
/*MT6176*/       cw786     = SDATA_TX_CW786;
/*MT6176*/    }
/*MT6176*/
/*MT6176*/    cw529        = ((codetype&0xFFF)<<8)|(0x1<<4);  // LDO_DCO_RFILTER_SEL=1
/*MT6176*/
/*MT6176*/    cw707       |= SDATA_TX_PORT;
/*MT6176*/    cw794        = (l1d_rf.band<FrequencyBand1800)?0x01080:0x00000;
/*MT6176*/    cw795        = ((l1d_rf2.rfc_data.g_result[poc_band].cap_tuning_pga_a&0x3F)<<6)|0x20000;
/*MT6176*/    cw796        = ((l1d_rf2.rfc_data.g_result[poc_band].cap_tuning_pga_b&0x3F)<<0)|0x20000;
/*MT6176*/    cw797        = SDATA_CW797[l1d_rf.band];
/*MT6176*/    cw806        = 0x0800C;  
/*MT6176*/    cw807        = 0x00000;  // 2G doesn't use DET path in normal mode. set 0x00000
/*MT6176*/    cw808        = 0x00000;  // 2G doesn't use DET path in normal mode. set 0x00000
/*MT6176*/    cw714        = L1D_RF_Get_TXLO_Data(poc_band,(l1d_rf2.arfcn&0x3FF),l1d_rf2.rfc_data.g_result[poc_band].tx_lo);
/*MT6176*/    cw787        = (l1d_rf2.rfc_data.g_result[poc_band].tx_rc_lpf&0xFF)<<12;
/*MT6176*/    cw793        = (0x1F)<<4;  // 2G Mode always use 0x1F for tx_rc_rcf
/*MT6176*/    cw793       |= 0x00001;  // RCF RSEL from CBW
/*MT6176*/    cw712        = 0x00004;
/*MT6176*/
/*MT6176*/    cw722        = 0x20000;  // 2G TX Workaround
/*MT6176*/    cw723        = (l1d_rf.band<FrequencyBand1800)?0x40000:0x20000;  // 2G TX Workaround
/*MT6176*/
/*MT6176*/ #if IS_BSI_AFC_ACTIVE_SWITCH
/*MT6176*/    if( l1d_rf.is_crystal_on_pmic )
/*MT6176*/       ctrl_dcxo = SCTRL_RESERVED;
...
/*MT6176*/ #if IS_2G_INCREASE_VS1_VOLTAGE_SUPPORT
/*MT6176*/    ctrl_pmic_vs1 = (SCTRL_PMIC_VS1|event_idx);
/*MT6176*/    cw_pmic_vs1 = L1D_RF_VS1_CWGen(MML1_RF_2G, WIN_TX, WIN_ON);
/*MT6176*/ #else
/*MT6176*/    ctrl_pmic_vs1 = SCTRL_RESERVED;
/*MT6176*/    cw_pmic_vs1 = 0;
/*MT6176*/ #endif
...
/*MT6176*/    if ( ( L1D_RF_QUERY_CHIP_VERSION() >= MML1_RF_IS_E3 ) )
/*MT6176*/    {
/*MT6176*/       HWRITE_27_SDATA( ctrl_dcxo,                       ((l1d_rf.AFC_data<<AFC_SHIFT_PART)&AFC_MASK_PART)|(afc_value_part),  /* CW34/CW42  : AFC DAC                   */
/*MT6176*/                        SCTRL_STX_CFG|event_idx,         cw511,                                                               /* CW511: STX Band                        */
/*MT6176*/                        SCTRL_STX_CFG|event_idx,         BSI_CW(0x209, cw521),                                                /* CW521: Set LF_FINE[3:0]                */
/*MT6176*/                        SCTRL_PLL|event_idx,             BSI_CW(0x211, cw529),                                                /* CW529: STX Codetype                    */
/*MT6176*/                        SCTRL_PLL|event_idx,             l1d_rf.RFN_data,                                                     /* CW549: STX_NMMD                        */
/*MT6176*/                        SCTRL_PLL|event_idx,             l1d_rf.IFN_data,                                                     /* CW550: STX_NMMD                        */
/*MT6176*/                        SCTRL_PLL|event_idx,             cw551,                                                               /* CW551: STX_NMMD1                       */
/*MT6176*/                        SCTRL_PLL|event_idx,             cw552,                                                               /* CW552: STX_NMMD1                       */
/*MT6176*/                        SCTRL_TX_CFG|event_idx,          cw707,                                                               /* CW707: TX Port                         */
/*MT6176*/                        SCTRL_TX_CFG|event_idx,          BSI_CW(0x312, cw786),                                                /* CW786: Set TX LO FE Comp.              */
/*MT6176*/                        SCTRL_TX_CFG|event_idx,          BSI_CW(0x31A, cw794),                                                /* CW794: Set TX Balun Result, from PGA Cap Tuning */
/*MT6176*/                        SCTRL_TX_CFG|event_idx,          BSI_CW(0x31B, cw795),                                                /* CW795: Set TX Balun Cap 1, from PGA Cap Tuning */
/*MT6176*/                        SCTRL_TX_CFG|event_idx,          BSI_CW(0x31C, cw796),                                                /* CW796: Set TX Balun Cap 2, from PGA Cap Tuning */
/*MT6176*/                        SCTRL_TX_CFG|event_idx,          BSI_CW(0x31D, cw797),                                                /* CW797: Set TX Drv bias for Linear Mode */
/*MT6176*/                        SCTRL_TX_CFG|event_idx,          BSI_CW(0x327, cw807),                                                /* CW807: Set TX Coarse DCOC value, from POC & this should move to POR */
/*MT6176*/                        SCTRL_TX_CFG|event_idx,          BSI_CW(0x328, cw808),                                                /* CW808: Set TX Coarse DCOC value, from POC & this should move to POR */
/*MT6176*/                        SCTRL_TX_CFG|event_idx,          BSI_CW(0x326, cw806),                                                /* CW806: Enalbe TX Coarse DCOC, from POC & this should move to POR */
/*MT6176*/                        SCTRL_TX_CFG|event_idx,          BSI_CW(0x2CA, cw714),                                                /* CW714: Write LO  Cal result, from POC  */
/*MT6176*/                        SCTRL_TX_CFG|event_idx,          BSI_CW(0x2C8, cw712),                                                /* CW712: TX_2G_ATTN                      */
/*MT6176*/                        SCTRL_TX_CFG|event_idx,          BSI_CW(0x313, cw787),                                                /* CW787: Write LPF CSEL value from POC   */
/*MT6176*/                        SCTRL_TX_CFG|event_idx,          BSI_CW(0x319, cw793),                                                /* CW793: Write RCF CSEL from POC         */
/*MT6176*/                        SCTRL_TX_CFG|event_idx,          BSI_CW(0x2C6, cw710),                                                /* CW710: Set BW3_EN & LPF RSEL           */
/*MT6176*/                        SCTRL_TXWARMUP_MODE|event_idx,   (SDATA_TXWARMUP_MODE|cw1_std),                                       /* CW1  : Enter 2G TX WARM mode           */
/*MT6176*/                        ctrl_pmic_vs1,                   cw_pmic_vs1,                                                         /* PMIC VS1 Control : change VS1 from 2.0V to 2.2V and switch to PWM mode   */
/*MT6176*/                        SCTRL_RESERVED,                  0,                                                                   /* Reserved */
/*MT6176*/                        SCTRL_RESERVED,                  0,                                                                   /* Reserved */
/*MT6176*/                        SCTRL_RESERVED,                  0                                                                  );/* Reserved */
...
/*MT6176*/                        SCTRL_TX_CFG|event_idx,          BSI_CW(0x319, cw793),                                                /* CW793: Write RCF CSEL from POC         */
/*MT6176*/                        SCTRL_TX_CFG|event_idx,          BSI_CW(0x2C6, cw710),                                                /* CW710: Set BW3_EN & LPF RSEL           */
/*MT6176*/                        SCTRL_PLL|event_idx,             BSI_CW(0x2D2, cw722),                                                /* CW722: TX Workaround(WARM Mode)        */
/*MT6176*/                        SCTRL_PLL|event_idx,             BSI_CW(0x2D3, cw723),                                                /* CW723: TX Workaround(WARM Mode)        */
/*MT6176*/                        SCTRL_TX_CFG|event_idx,          BSI_CW(0x2DF,SDATA_TX_CW735),                                        /* CW735: Trigger TX CMOS LO LDO o/p enable */
/*MT6176*/                        SCTRL_TXWARMUP_MODE|event_idx,   (SDATA_TXWARMUP_MODE|cw1_std),                                       /* CW1  : Enter 2G TX WARM mode           */
/*MT6176*/                        ctrl_pmic_vs1,                   cw_pmic_vs1                                                        );/* PMIC VS1 Control : change VS1 from 2.0V to 2.2V and switch to PWM mode   */
/*MT6176*/    }
/*MT6176*/ }
/*MT6176*/
/*MT6176*/ void  L1D_RF_SetSData_ST2( void )
/*MT6176*/ {
/*MT6176*/    SETUP_ST2();
/*MT6176*/    (void) event_idx;
/*MT6176*/
/*MT6176*/    HWRITE_5_SDATA( SCTRL_RESERVED, 0,   /* reserved */
/*MT6176*/                    SCTRL_RESERVED, 0,   /* reserved */
/*MT6176*/                    SCTRL_RESERVED, 0,   /* reserved */
/*MT6176*/                    SCTRL_RESERVED, 0,   /* reserved */
/*MT6176*/                    SCTRL_RESERVED, 0  );/* reserved */
/*MT6176*/ }
/*MT6176*/
/*MT6176*/ void  L1D_RF_SetSData_ST3( void )
/*MT6176*/ {
/*MT6176*/    unsigned long  cw521;  // This value should update from NVRAM for 26MHz Channel Performance concern.
/*MT6176*/    unsigned long  ctrl_pmic_vs1, cw_pmic_vs1;
/*MT6176*/
/*MT6176*/    SETUP_ST3();
/*MT6176*/
/*MT6176*/    cw521 = ( L1D_RF_QUERY_CHIP_VERSION() >= MML1_RF_IS_E3 ) ? 0x82060 : 0x02060;   /* E3 : Others */
/*MT6176*/
/*MT6176*/ #if IS_2G_INCREASE_VS1_VOLTAGE_SUPPORT
/*MT6176*/    ctrl_pmic_vs1 = (SCTRL_PMIC_VS1|event_idx);
/*MT6176*/    cw_pmic_vs1 = L1D_RF_VS1_CWGen(MML1_RF_2G, WIN_TX, WIN_OFF);
/*MT6176*/ #else
/*MT6176*/    ctrl_pmic_vs1 = SCTRL_RESERVED;
/*MT6176*/    cw_pmic_vs1 = 0;
/*MT6176*/ #endif
...
/*MT6176*/    if ( ( L1D_RF_QUERY_CHIP_VERSION() >= MML1_RF_IS_E3 ) )
/*MT6176*/    {
/*MT6176*/       HWRITE_5_SDATA( SCTRL_IDLE|event_idx,            SDATA_TX2SLEEP,                             /* CW1  : Sleep Mode 			   */
/*MT6176*/                       SCTRL_PLL|event_idx,             BSI_CW(0x209, cw521),                       /* CW521: TX Workaround(Sleep Mode) */
/*MT6176*/                       ctrl_pmic_vs1,                   cw_pmic_vs1,                                /* PMIC VS1 Control : change VS1 from 2.2V to 2.0V and switch to PFM mode   */
/*MT6176*/                       SCTRL_RESERVED,                  0,                                          /* reserved */
/*MT6176*/                       SCTRL_RESERVED,                  0                                         );/* reserved */
/*MT6176*/    }
...
/*MT6176*/       HWRITE_5_SDATA( SCTRL_IDLE|event_idx,            SDATA_TX2SLEEP,                             /* CW1  : Sleep Mode                */
/*MT6176*/                       SCTRL_PLL|event_idx,             BSI_CW(0x209, cw521),                       /* CW521: TX Workaround(Sleep Mode) */
/*MT6176*/                       SCTRL_PLL|event_idx,             BSI_CW(0x2D2, 0x00000),                     /* CW722: TX Workaround(Sleep Mode) */
/*MT6176*/                       SCTRL_PLL|event_idx,             BSI_CW(0x2D3, 0x00000),                     /* CW723: TX Workaround(Sleep Mode) */
/*MT6176*/                       ctrl_pmic_vs1,                   cw_pmic_vs1                               );/* PMIC VS1 Control : change VS1 from 2.2V to 2.0V and switch to PFM mode   */
/*MT6176*/    }
/*MT6176*/ }
/*MT6176*/
/*MT6176*/ void  L1D_RF_SetSData_ST2B( void )
/*MT6176*/ {
/*MT6176*/    unsigned long cw1_std,cw705,cw706;
/*MT6176*/
/*MT6176*/    SETUP_ST2B_ST2M();
/*MT6176*/
/*MT6176*/    L1D_RF_TxGainSetting( l1d_rf.tx_mod_type2, l1d_rf.cur_slot, l1d_rf2.tx_power[l1d_rf.cur_slot], (FrequencyBand)l1d_rf.band, &cw705, &cw706 );
/*MT6176*/
/*MT6176*/    if( (l1d_rf.tx_mod_type2>>l1d_rf.cur_slot)&0x1 )
/*MT6176*/    {  /* EDGE */
/*MT6176*/       cw1_std = (0x1<<6);
/*MT6176*/    }
/*MT6176*/    else
...
/*MT6176*/    }
/*MT6176*/
/*MT6176*/    HWRITE_5_SDATA( SCTRL_TXBURST_MODE|event_idx, (SDATA_TXBURST_MODE|cw1_std), /* CW1 : Enter 2G TX Burst Mode */
/*MT6176*/                    SCTRL_TX_GAIN|event_idx,      BSI_CW(0x2C0, 0x00000),       /* CW704 : TXPF=0               */
/*MT6176*/                    SCTRL_TX_GAIN|event_idx,      BSI_CW(0x2C2, cw706),         /* CW706 : TX Gain              */
/*MT6176*/                    SCTRL_RESERVED,               0,                            /* reserved                     */
/*MT6176*/                    SCTRL_RESERVED,               0                           );/* reserved                     */
/*MT6176*/ }
/*MT6176*/
/*MT6176*/ void  L1D_RF_SetSData_ST2M( void )
/*MT6176*/ {
/*MT6176*/    unsigned long cw1_std, cw705, cw706, cw707;
/*MT6176*/
/*MT6176*/    SETUP_ST2B_ST2M();
/*MT6176*/
/*MT6176*/    L1D_RF_TxGainSetting( l1d_rf.tx_mod_type2, l1d_rf.cur_slot, l1d_rf2.tx_power[l1d_rf.cur_slot], (FrequencyBand)l1d_rf.band, &cw705, &cw706 );
...
/*MT6176*/    cw707     |= SDATA_TX_PORT;
/*MT6176*/
/*MT6176*/    if( (l1d_rf.change)&(1<<l1d_rf.cur_slot) )
/*MT6176*/    {  /* modulation type changes */
/*MT6176*/       HWRITE_5_SDATA( SCTRL_TXBURST_MODE|event_idx, (SDATA_TXBURST_MODE|cw1_std), /* CW1 : Enter 2G TX Burst Mode */
/*MT6176*/                       SCTRL_TX_CFG|event_idx,       BSI_CW(0x2C3,cw707),          /* CW707: TX Port               */
/*MT6176*/                       SCTRL_TX_GAIN|event_idx,      BSI_CW(0x2C2, cw706),         /* CW706: TX Gain               */
/*MT6176*/                       SCTRL_RESERVED,               0,                            /* reserved                     */
/*MT6176*/                       SCTRL_RESERVED,               0                           );/* reserved                     */
/*MT6176*/    }
/*MT6176*/    else
/*MT6176*/    {
/*MT6176*/       HWRITE_5_SDATA( SCTRL_TX_GAIN|event_idx,      BSI_CW(0x2C2, cw706),         /* CW706 : TX Gain              */
/*MT6176*/                       SCTRL_RESERVED,               0,                            /* reserved                     */
/*MT6176*/                       SCTRL_RESERVED,               0,                            /* reserved                     */
/*MT6176*/                       SCTRL_RESERVED,               0,                            /* reserved                     */
/*MT6176*/                       SCTRL_RESERVED,               0                           );/* reserved                     */
