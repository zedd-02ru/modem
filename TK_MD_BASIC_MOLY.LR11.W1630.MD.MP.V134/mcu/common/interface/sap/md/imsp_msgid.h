...
MODULE_MSG_BEGIN( MSG_ID_IMSP_CODE_BEGIN )
  ...
  MSG_ID_IMSP_IMCSMS_RANGE_BEGIN = MSG_ID_IMSP_CODE_BEGIN,
    ...
    MSG_ID_IMSP_IMCSMS_SEND_MSG_URC_IND,
    MSG_ID_IMSP_IMCSMS_RECV_MSG_CNF,
  ...
  MSG_ID_SDM_IMSP_RANGE_BEGIN,
    ...
    MSG_ID_SDM_IMSP_CMSS_CS_REQ,
    MSG_ID_SDM_IMSP_UPDATE_MSG_BOX_REQ,
    MSG_ID_SDM_IMSP_SEND_C2K_MSG_URC_IND,
    MSG_ID_SDM_IMSP_IMS_SMS_SMART_CONGESTION_URC_IND,
    MSG_ID_SDM_IMSP_IMS_SMS_SMART_CONGESTION_REQ,
  ...
  MSG_ID_VDM_IMSP_RANGE_BEGIN,
    ...
    MSG_ID_VDM_IMSP_GMSS_SET_HVOLTE_MODE_REQ,
    MSG_ID_VDM_IMSP_ECBM_MODE_START_REQ,
    MSG_ID_VDM_IMSP_ECBM_MODE_STOP_REQ,
    MSG_ID_VDM_IMSP_EMC_SERVICE_SCAN_REQ,

    MSG_ID_VDM_IMSP_IMS_CALL_SCM_REQ,
    MSG_ID_VDM_IMSP_ECBM_MODE_START_TO_AP_REQ,
    MSG_ID_VDM_IMSP_ECBM_MODE_STOP_TO_AP_REQ,
    MSG_ID_VDM_IMSP_CMD_RTT_CAPABILITY_RSP,
    MSG_ID_VDM_IMSP_SND_ECPI_RTT_REDIAL_REQ,
    MSG_ID_VDM_IMSP_SND_ADS_SWITCH_TO_EMERGENCY_REQ,
  ...
  MSG_ID_IMSP_IMC_RANGE_BEGIN,
    ...
    MSG_ID_IMSP_IMC_EPVS_SET_CNF, 
    MSG_ID_IMSP_IMC_EPVS_GET_CNF,     
    MSG_ID_IMSP_IMC_FDN_ECC_CHECK_REQ,
    MSG_ID_IMSP_IMC_IMS_EXIT_ECBM_IND,
    ...
    MSG_ID_IMSP_IMC_SET_EMERGENCY_AID_CNF,
    ...
    /* AT+EWFCP */
    MSG_ID_IMSP_IMC_WFC_PROFILE_CNF,

    /* AT+EIMSRCS */
    MSG_ID_IMSP_IMC_RCS_FEATURE_CNF,
    MSG_ID_IMSP_IMC_SWITCH_PREFER_RAT_CNF,
    /* AT+ECT */
    MSG_ID_IMSP_IMC_SS_ECT_CNF,

    /* AT+ESIPHEADER */
    MSG_ID_IMSP_IMC_SIP_HEADER_CNF,

    /* AT+CTMCALL */
    MSG_ID_IMSP_IMC_SET_TEXT_CAPABILITY_CNF, // IMC --> AP
    MSG_ID_IMSP_IMC_CTMCALL_IND,             // IMC --> CS CC

    /* +EIMSTCAP */
    MSG_ID_IMSP_IMC_TTY_CAPABILITY_IND,
    
    /* +EIMSREGCON */
    MSG_ID_IMSP_IMC_REG_CONDITION_CNF,
    
    /* RTT */
    MSG_ID_IMSP_IMC_RTT_CAPABILITY_CNF,
    MSG_ID_IMSP_IMC_CC_RTT_OP_CNF,
  ...
  MSG_ID_LTECSR_IMSP_RANGE_BEGIN,
    ...
    MSG_ID_LTECSR_IMSP_RTP_NOTIFY_URC,  // the meaning depends on case_id
