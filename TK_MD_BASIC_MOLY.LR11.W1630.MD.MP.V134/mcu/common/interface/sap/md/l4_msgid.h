...
#ifdef __SGLTE__
        MSG_ID_ESMREG_PS_SWITCH_COMPLETE_IND
        MSG_ID_EVAL_ESM_PS_SWITCH_COMPLETE_IND = MSG_ID_ESMREG_PS_SWITCH_COMPLETE_IND,
#endif /* __SGLTE__ */  
...
//SSAGPS
 ...
 //   MSG_ID_L4CSMSAL_UPDATE_SMS_OVER_SGS_CFG_REQ,
    ...
    MSG_ID_L4CSMSAL_UPDATE_SMS_OVER_SGS_CFG_REQ,
    MSG_ID_L4CSMSAL_REG_STATE_IND,
    MSG_ID_SMSAL_CB_FSM_STATE_CHANGE_IND,
	MSG_ID_SMSAL_CODE_END = MSG_ID_SMSAL_CB_FSM_STATE_CHANGE_IND,
	/*------------------ SMSAL_MSG_CODE_END --------------------*/
...
MODULE_MSG_BEGIN( MSG_ID_RAC_CODE_BEGIN )
   ...
   MSG_ID_L4CRAC_UE_OPLMN_UPDATE_REQ, //NOT use
   MSG_ID_L4CRAC_GET_UE_OPLMN_REQ,    //NOT use
   ...
   MSG_ID_RAC_GMSS_GET_UE_OPLMN_CNF,
...
//#endif
   ...
   MSG_ID_L4CRAC_SMU_PIN_VERIFY_STATUS_REQ,
   ...
   MSG_ID_L4CRAC_ECC_CALL_SESSION_REQ,
...
MODULE_MSG_BEGIN( MSG_ID_PS_CODE_BEGIN )	    
...
#endif
   MSG_ID_L4C_EVAL_RSIM_AUTH_ABORT_CNF,
   MSG_ID_L4C_EVAL_RSIM_AUTH_FINISH_IND,
   ...
   MSG_ID_L4CAS_RR_APC_STATUS_IND,
#ifdef __REMOTE_SIM__
   MSG_ID_L4C_AKA_RESOURCE_RELEASE_REQ,
   MSG_ID_PS_CODE_END = MSG_ID_L4C_AKA_RESOURCE_RELEASE_REQ,
#else
   MSG_ID_PS_CODE_END = MSG_ID_L4CAS_RR_APC_STATUS_IND,
#endif
  /*----------AS_MSG_CODE_END -----------------*/
