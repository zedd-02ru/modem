...
extern kal_uint8 l4c_ps_get_eimsroam_config_value(void);
#endif
...
extern kal_uint16 l4c_ps_get_sim_sbp_id();
extern kal_uint16 l4c_ps_get_nw_sbp_id();
...
extern kal_bool l4c_ps_check_attach_cid_with_same_config(pdp_addr_type_enum pdp_type, kal_uint8 *apn, kal_uint8 apn_len);
...
extern void l4c_ps_bip_preempt_other_pdn_process_from_sim();
...
#endif
extern kal_uint8 l4c_read_vsim_profileid(void);
extern kal_uint8 l4c_read_vsim_type(kal_uint8 profile_id);
extern kal_uint8 l4c_read_vsim_auth_algo(kal_uint8 profile_id);
extern void l4c_read_vsim_auth_res(kal_uint8 profile_id, kal_uint16 *auth_len, kal_uint8 *auth_res);
extern vsim_ver_type_enum l4c_read_vsim_ver(void);
...
extern kal_uint8 l4c_get_cfun_state_by_idx (protocol_id_enum ps_id);
...
extern kal_bool l4c_is_procedure_not_allowed_when_call_exists(l4c_action_enum action);
...
extern void l4c_nw_cell_power_level_ind_start_timer_hdlr(l4c_timer_id_enum timer, kal_uint16 time);

extern void l4c_nw_cell_power_level_stop_timer_hdlr(l4c_timer_id_enum timer);

extern void l4c_nw_cell_power_level_ind_timerout_hdlr(void);
#endif
...
extern kal_bool ecsra_conflict_check();
