...
typedef struct {
    kal_uint8   config_value;
} l4c_eimsroam_config_value_struct;
#endif
...
//evshed_create, mtk02285, 20110328: remove base timer
    ...
    kal_uint8 ims_serving_band;
    plmn_id_struct ims_serving_plmn_id;
    kal_uint8 ims_serving_band_l4_self_reported;           // the serving band when L4 reports +EMCSS directly
    plmn_id_struct ims_serving_plmn_id_l4_self_reported;    // the serving plmn when L4 reports +EMCSS directly
    kal_bool hvolte_enable;
    kal_bool hvolte_enable_for_roaming;
    ...
    kal_bool need_wait_imc_for_exit_ecbm;  // default true
#endif
	/* holds SMU PIN verify start indication sent status */
	kal_bool is_smu_pin_verify_start_sent;
...
#ifdef __OP12_CDMA_LESS__
    l4c_eimsroam_config_value_struct eimsroam_config;
#endif
	...
	kal_uint8 egdcont_not_set_cause_attach_fail_count;
...
#endif
    kal_bool is_world_mode_change_started;
