...
#define MAX_NUM_CONFIG_OPTION_PACKETS 20 /* See tcm_pco_api.h for PCO number counting. */
#else  /* __IMS_SUPPORT__ */
#define MAX_NUM_CONFIG_OPTION_PACKETS 13  /* See tcm_pco_api.h for PCO number counting. */
...
#define MAX_SMS_PDU_LEN             (255) /* 3GPP/3GPP2 SMS */
...
typedef enum
{
    ...
    L4C_CAP_MAX = (L4C_CAP_GPRS | L4C_CAP_EDGE | L4C_CAP_UMTS | L4C_CAP_HSPA | L4C_CAP_HSPAP | L4C_CAP_LTE | L4C_CAP_LTE_CA)
...
typedef enum
{
    ...
    RMMI_TIME_ZONE_DST_TIME_REPORT   = 2
...
/* 24.008 CR# 1791 End*/
 ...
 #endif
   CM_MM_NO_RETRY,
   CM_MM_STATE_GLOBAL_MODE_CHANGE, /*Do not insert new enum value before this entry*/
...
/* under construction !*/
    ...
    TCM_ESM_FAIL_CAUSE_T3346_RUNNING,
...
/* ============================== L4C cause ============================== */
    ...
    L4C_INIT_ATTACH_INVALID_APN,
    L4C_AT_CMD_IN_WRONG_STATE, 
    L4C_OMADM_CHECKING_FAIL, 
    L4C_CONTEXT_CONFLICT_DUAL_DATA_TYPE,
...
/* ============================== PAM VZW cause ============================== */
  	...
  	PAM_VZW_PDN_ACCESS_REJECT_THROTTLE_FOREVER_CANDIDATE        = 0x08 + PAM_VZW_CAUSE_START,
  	PAM_VZW_PDN_ACCESS_REJECT_THROTTLE_NO_RSP                   = 0x09 + PAM_VZW_CAUSE_START,
  	PAM_VZW_PDN_ACCESS_REJECT_NOT_IN_ACL                        = 0x0A + PAM_VZW_CAUSE_START,
  	PAM_VZW_PDN_ACCESS_REJECT_STOP_ATTACH_FOR_CLASS1_AND_CLASS2_NOT_ENABLED = 0x0B + PAM_VZW_CAUSE_START,
  	PAM_VZW_PDN_ACCESS_REJECT_WAIT_TIME_NOT_EXPIRED             = 0x0C + PAM_VZW_CAUSE_START,
  	PAM_VZW_PDN_ACCESS_REJECT_EXCEED_MAX_PDN_CONN_TRIES         = 0x0D + PAM_VZW_CAUSE_START,
  	PAM_VZW_PDN_ACCESS_REJECT_THROTTLE_BY_MAX_PDN_CONN_TRIES    = 0x0E + PAM_VZW_CAUSE_START,
  	PAM_VZW_PDN_ACCESS_REJECT_NO_AVAILABLE_CLASS_CAN_BE_USED    = 0x0F + PAM_VZW_CAUSE_START,
    PAM_VZW_PDN_ACCESS_REJECT_APN_IN_USE                        = 0x10 + PAM_VZW_CAUSE_START, // __PAM_CHECK_APN_UNIQUENESS__
    PAM_VZW_PDN_ACCESS_REJECT_VZ_REQ_LTEDATA_39683_FEB_2016     = 0x11 + PAM_VZW_CAUSE_START,
    PAM_VZW_PDN_ACCESS_REJECT_VZ_REQ_LTEDATA_39684_FEB_2016     = 0x12 + PAM_VZW_CAUSE_START,
...
typedef enum{
    SMU_PIN_VERIFY_START = 0,
    SMU_PIN_VERIFY_END
} smu_pin_verify_status_enum;
/*****************************************************************************
* DESCRIPTION
*   This enum is defined apc feature mode.
*****************************************************************************/

typedef enum
{
   L4C_DISABLE_APC_FEATURE = 0,
   L4C_ENABLE_APC_FEATURE_MODE_1  = 1,
   L4C_ENABLE_APC_FEATURE_MODE_2 = 2,
} l4c_apc_feature_mode_enum;

/*****************************************************************************
* DESCRIPTION
*   This enum is defined cell type of apc feature .
*****************************************************************************/
typedef enum
{
   L4C_APC_SUSPECTED_PSEUDO_CELL = 0,
   L4C_APC_CONFIRMED_PSEUDO_CELL = 1,
   L4C_APC_IN_PSEUDO_CELL  = 2,
   L4C_APC_OUT_PSEUDO_CELL = 3,
} l4c_apc_cell_type_enum;

#ifdef __SIMME_LOCK_RELATIONSHIP__
typedef enum{
    SMU_DUAL_SIM_CONTROL_LOCK_INDEPENDENT = 0, // SIM1 and SIM2 SIM-ME locks are independent
    SMU_DUAL_SIM_CONTROL_ONE_SIM_LOCK,         // SIM1 and SIM2 SIM-ME locks are dependent on each other
    SMU_DUAL_SIM_CONTROL_SLOT1_ONLY            // SIM2 dependent on SIM1 SIM-ME lock status
} smu_dual_sim_lock_enum;
#endif
