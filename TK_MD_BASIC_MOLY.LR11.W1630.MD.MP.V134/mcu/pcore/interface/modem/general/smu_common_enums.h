...
typedef enum
{
   ...
   ID_SIM_PIN_DEFER, /* This is added for __SIMME_LOCK_RELATIONSHIP__, defer till PIN/PUK check on other SIM */
   ID_UNKNOWN //link_SML
...
extern kal_bool l4csmu_get_dual_sim_lock_control_one_sim_lock_feature_supported(void);
extern kal_bool l4csmu_get_dual_sim_lock_control_slot1_only_feature_supported(void);
