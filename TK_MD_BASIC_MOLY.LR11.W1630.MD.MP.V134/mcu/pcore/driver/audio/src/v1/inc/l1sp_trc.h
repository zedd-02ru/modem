...
BEGIN_TRACE_MAP(MOD_L1SP)
   ...
   TRC_MSG(L1CTM_UL_DOWNSAMPLING,  "[CTM] UL down sampling ret = %d")
   TRC_MSG(L1CTM_DL_DOWNSAMPLING,  "[CTM] DL down sampling ret = %d")
   TRC_MSG(L1CTM_UL_UPSAMPLING,    "[CTM] UL up sampling ret = %d")
   TRC_MSG(L1CTM_DL_UPSAMPLING,    "[CTM] DL up sampling ret = %d")
   ...
   TRC_MSG(SP4G_DEBUG_SP4G_SPEECH_INIT                                                                                         ,"[SP4G][DEBUG]sp4g_speech_init = %x")
   TRC_MSG(SP4G_DEBUG_SP4G_UL_SETFRAMETYPE1                                                                                    ,"[SP4G][DEBUG]SP4G_UL_SetFrameType1 %d %d ftype=%d, ul_intrarat=%d")
   TRC_MSG(SP4G_DEBUG_SP4G_UL_SETFRAMETYPE2                                                                                    ,"[SP4G][DEBUG]SP4G_UL_SetFrameType2 %d %d ftype=%d, ul_intrarat=%d")
   TRC_MSG(SP4G_DEBUG_SP4G_UL_SETFRAMETYPE3                                                                                    ,"[SP4G][DEBUG]SP4G_UL_SetFrameType3 %d %d ftype=%d, ul_intrarat=%d")
   ...
   TRC_MSG(SP4G_DL_EVENT_CODEC                                                                                                 ,"[SP4G]DL_Event codec=%d len=%d hdr.len=%d")
   ...
   TRC_MSG(SP4G_PSR_PUTFRAME_MISMATCH                                                                                          ,"[SP4G]PSR_PutFrame mismatch codec=%d %d")
   TRC_MSG(SP4G_P_HISR_SP4G_RESET_FLAG_INFO                                                                                    ,"[SP4G][P_HISR] sp4g_reset_flag=%d dl_count=%d %d %d size=%d")
   TRC_MSG(SP4G_SP4GSETCODEC_IS_EQUAL                                                                                          ,"[SP4G][SP4G]SetCodec is equal %x")
   ...
   TRC_MSG(SP4G_SP4G_PSR_DL_AMR_PUTSPEECHFRAME                                                                                 ,"[SP4G]SP4G_PSR_DL_AMR_PutSpeechFrame codec=%d frame_type=%d ul_codec_mode=%d")
   ...
   TRC_MSG(SP4G_SP4G_PSR_DL_GSERIES_PUTSPEECHFRAME_INFO                                                                        ,"[SP4G]SP4G_PSR_DL_GSeries_PutSpeechFrame: codec=%x, encodebits=%02x%02x%02x%02x, bitlen=%x")
   ...
   TRC_MSG(SP4G_SP4G_PSR_UL_GSERIES_GETSPEECHFRAME_INFO                                                                        ,"[SP4G]SP4G_PSR_UL_GSeries_GetSpeechFrame: codec=%x, encodebits=%02x%02x%02x%02x, bitlen=%x")
   TRC_MSG(SP4G_SP4G_RAB_EST                                                                                                   ,"[SP4G]SP4G_Rab_Est: in_codec_mode=%d, real_codec_mode=%d")
   TRC_MSG(SP4G_SP4G_SETCODEC                                                                                                  ,"[SP4G]SP4G_SetCodec: in_codec_mode=%d, real_codec_mode=%d")
   ...
   TRC_MSG(SP4G_UL_SYNC_SP4G_EMAC_TIMING_UPDATE_INFO                                                                           ,"[SP4G][UL_Sync]SP4G_emac_timing_update drx_period=%x sr_period=%x")
   ...
   TRC_MSG(SP4G_UL_SYNC_SP4G_HISR_UL_AMR_1_INFO                                                                                ,"[UL_Sync]sp4g_hisr_ul_amr.1 ctime = %d time[0] = %d time_emac_2_ulhisr = %d")
   ...
   TRC_MSG(SP4G_UL_SYNC_SUB_SP4G_EMAC_TIMING_UPDATE_INFO3                                                                      ,"[UL_Sync]sub_SP4G_emac_timing_update: codec=%d, u32SoftwareCodecDelay=%d")
   ...
   TRC_MSG(SP4G_EVS_ENCODER_PREPARE_PARAMETER2                                                                                 ,"EVS_encoder_prepare_parameter2: codec=%x, DTX=%d, EVS_CA_Par.enable=%d")
   ...
   TRC_MSG(SP4G_HISR_UL_EVS                                                                                                    ,"UL_Event_EVS duration EVS_HISR_start_time: %x")
   ...
   TRC_MSG(SP4G_HISR_UL_EVS_ASSERT_ID                                                                                          ,"sp4g_hisr_ul_EVS encoder EVS codec ID is wrong:%x")
   ...
   TRC_MSG(SP4G_HISR_UL_EVS_AWB_INVALID_CODEC_RATE                                                                             ,"sp4g_hisr_ul_EVS AWB invalid codec rate: %x")
   ...
   TRC_MSG(SP4G_HISR_UL_EVS_END_TIME                                                                                           ,"UL_Event_EVS duration EVS_HISR_end_time:   %x")
   ...
   TRC_MSG(SP4G_UL_EVS_GETSPEECHFRAME_HEADER_INFO                                                                              ,"SP4G_UL_EVS_GetSpeechFrame header ID=%x codec=%x byte_len=%d bit_len=%d")
   TRC_MSG(SP4G_UL_EVS_GETSPEECHFRAME_EVS_HB_UL_RB_BUF_EMPTY                                                                   ,"SP4G_UL_EVS_GetSpeechFrame EVS_HB_ul_rb_buf is empty")
   TRC_MSG(SP4G_UL_EVS_GETSPEECHFRAME_INFO                                                                                     ,"SP4G_UL_EVS_GetSpeechFrame codec=%x bit_len=%d")
   ...
   TRC_MSG(SP4G_PSR_DL_EVS_PUTSPEECHFRAME_DATA                                                                                 ,"SP4G_PSR_DL_EVS_PutSpeechFrame: codec=%x, encodebits=%02x %02x %02x %02x")
   ...
   TRC_MSG(SPC_SPE_CHK_HEADER                                ,"[SPC][SPE]Check Format Header,header=%x,type=%x,length=%x")
   ...
   TRC_MSG(L1SP_SKIP_FIRST_SPHMODE_CHECK, "L1SP skip first sph mode check, %d")
   ...
   TRC_MSG(L1SP_2MIC_EXIT_BYPASS, "L1SP 2Mic Exit Bypass Mode(Enter Sleep mode)")
	...
	TRC_MSG(SPC_ILLEGAL_SPC_APP_BEHAVIOR, "[SPC] Illegle app control with (%d)%MMSG_SPC_APP_T, at pos=%d")
	TRC_MSG(SPC_ILLEGAL_SPC_APP_ON_OFF_BEHAVIOR, "[SPC] Illegle app control with (%d)%MMSG_SPC_APP_T, to On/Off=%d %MMSG_SPC_APP_T")
	...
	TRC_MSG(SPC_CODEC_NOTIFY_UNKNOW, "[SPC][Codec] Unknow codec = %x")
...
// 4G speech
   ...
   TRC_MSG(SP4G_DL_BIT_TRUE, "SP4G_HISR DL Type %x, Frm %x %x %x %x %x")
   ...
   TRC_MSG(SPCIO_A2M_HISR_NOT_INITIALED, "SPCIO A2M HISR, task is not initialed, just return internal msg ack 0x%08X.")
   ...
   TRC_MSG(SIDETONE_WRITE_TO_HW, "[sidetone] write AFE_SIDETONE_GAIN with 0x%04X")
	 TRC_MSG(SIDETONE_GAIN_INFO, "[sidetone] pre_gain=0x%04X gain=0x%04X")
