...
ECHO := perl ${COMMON_ROOT}/tools/init/echo.pl -n
...
ifeq ($(strip $(OS_VERSION)),MSWin32)
    ...
    MV := perl ${COMMON_ROOT}/tools/init/move.pl -f
...
NVM_INC = -I "${CORE_ROOT}/tools/NVRAMStatistic/include" -I "${CORE_ROOT}/service/nvram/include"
...
nvram_factory_config.o: ${CORE_ROOT}/service/nvram/src/nvram_factory_config.c
	@${ECHO} "Compile ${CORE_ROOT}/service/nvram/src/nvram_factory_config.c..."
	@${GCC} $(CUSTOM_OPTION) $(NVM_OPTION) ${CUSTOM_INC} $(NVM_INC) -w -c $< -MMD -MF $(output_path)/$(basename $(@F)).d -o $(output_path)/$@
